...
import { AdminDebateServiceForIssue } from '../data-service';

/**
 * Relation Service Implementation for AdminDebate.issue
 */
export class AdminDebateServiceForIssueImpl extends JudoAxiosService implements AdminDebateServiceForIssue {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getIssue(owner: JudoIdentifiable<AdminDebate>, mask?: string): Promise<AdminIssueStored> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetOwner(owner: JudoIdentifiable<AdminDebate>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetIssueType(owner: JudoIdentifiable<AdminDebate>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetCounty(owner: JudoIdentifiable<AdminDebate>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetCity(owner: JudoIdentifiable<AdminDebate>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetDistrict(owner: JudoIdentifiable<AdminDebate>, target: JudoIdentifiable<AdminIssue>): Promise<void> {
