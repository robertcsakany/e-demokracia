...
import { AdminCommentServiceForCreatedBy } from '../data-service';

/**
 * Relation Service Implementation for AdminComment.createdBy
 */
export class AdminCommentServiceForCreatedByImpl extends JudoAxiosService implements AdminCommentServiceForCreatedBy {
  /**
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 401, 403.
   */
  async getCreatedBy(owner: JudoIdentifiable<AdminComment>, mask?: string): Promise<AdminUserStored> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetResidentCounty(owner: JudoIdentifiable<AdminComment>, target: JudoIdentifiable<AdminUser>): Promise<void> {
   ...
   * @throws {AxiosError} With data containing {@link Array<FeedbackItem>} for status codes: 400, 401, 403.
   */
  async unsetResidentCity(owner: JudoIdentifiable<AdminComment>, target: JudoIdentifiable<AdminUser>): Promise<void> {
