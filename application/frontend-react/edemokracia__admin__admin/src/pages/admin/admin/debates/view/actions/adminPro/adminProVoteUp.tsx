...
import { AdminProStored, AdminDebateStored } from '../../../../../../../generated/data-api';
...
export const useAdminProVoteUpAction: AdminProVoteUpAction = () => {
  ...
  const title: string = t('edemokracia.admin.Admin.debates.View.edemokracia.admin.Pro.voteUp', { defaultValue: '' });
