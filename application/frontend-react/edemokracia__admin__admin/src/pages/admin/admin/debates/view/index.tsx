...
export default function AdminAdminDebatesView() {
  ...
  const pageBackDebatesAction = usePageBackDebatesAction();
  ...
  const title: string = t('edemokracia.admin.Admin.debates.Debate.View', { defaultValue: 'View / Edit Debate' });
              ...
              <Card>
                <Grid container item alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography variant="h6" component="h1">
                    {t('edemokracia.admin.Admin.debates.Debate.View.debate.debate.Label', { defaultValue: 'Debate' })}
                  </Typography>
                </Grid>
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={8.0}>
                    <TextField
                      name="title"
                      id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/title"
                      label={
                  ...
                  <Grid item xs={12} sm={2.0}>
                    <TextField
                      name="status"
                      id="EnumerationCombo@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/status"
                      label={
                  ...
                  <Grid item xs={12} sm={8.0}>
                    <AggregationInput
                      name="issue"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/issue"
                      label={
                  ...
                  <Grid item xs={12} sm={4.0}>
                    <AggregationInput
                      name="createdBy"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/createdBy"
                      label={
                  ...
                  <Grid item xs={12}>
                    <TextField
                      name="description"
                      id="TextArea@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/description"
                      label={
                  ...
                  <Grid item xs={12}>
                    <AggregationInput
                      name="voteDefinition"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Admin.debates/View/default/Debate_View/debate/LabelWrapper/debate/voteDefinition"
                      label={
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  ...
                  >
                    <Grid container item alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography variant="h6" component="h1">
                        {t('edemokracia.admin.Admin.debates.Debate.View.tabBar.arguments.arguments.pros.pros.Label', {
                          defaultValue: 'Pro',
                        })}
                      </Typography>
                    </Grid>
                  ...
                  >
                    <Grid container item alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography variant="h6" component="h1">
                        {t('edemokracia.admin.Admin.debates.Debate.View.tabBar.arguments.arguments.cons.cons.Label', {
                          defaultValue: 'Contra',
                        })}
                      </Typography>
                    </Grid>
