...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Debate::cons#RowEdit
...
export const useRowEditConsAction = () => {
  return async function rowEditConsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Debate::cons#RowEdit not supported yet!');
  };
};
