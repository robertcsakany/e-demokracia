...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::debates#PageBack
...
export const usePageBackDebatesAction = () => {
  return async function pageBackDebatesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::debates#PageBack not supported yet!');
  };
};
