...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::categories#PageEdit
...
export const usePageEditCategoriesAction = () => {
  return async function pageEditCategoriesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::categories#PageEdit not supported yet!');
  };
};
