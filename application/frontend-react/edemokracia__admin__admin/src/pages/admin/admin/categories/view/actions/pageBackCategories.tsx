...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::categories#PageBack
...
export const usePageBackCategoriesAction = () => {
  return async function pageBackCategoriesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::categories#PageBack not supported yet!');
  };
};
