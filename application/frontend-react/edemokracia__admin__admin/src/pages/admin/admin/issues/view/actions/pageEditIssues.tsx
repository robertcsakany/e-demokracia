...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::issues#PageEdit
...
export const usePageEditIssuesAction = () => {
  return async function pageEditIssuesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::issues#PageEdit not supported yet!');
  };
};
