...
export default function AdminAdminIssuesView() {
  ...
  const pageBackIssuesAction = usePageBackIssuesAction();
  ...
  const title: string = t('edemokracia.admin.Admin.issues.Issue.View', { defaultValue: 'View / Edit Issue' });
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      ...
                      >
                        ...
                        {t('edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.createComment', {
