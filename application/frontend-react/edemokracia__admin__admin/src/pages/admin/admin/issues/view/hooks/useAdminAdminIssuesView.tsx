...
export const useAdminAdminIssuesView = () => {
  ...
  const attachmentsColumns: GridColDef<AdminIssueAttachmentStored>[] = [
    {
      ...
      field: 'link',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.attachments.attachments.attachments.attachments.link',
        { defaultValue: 'Link' },
      ) as string,
      width: 230,
      type: 'string',
    },
    {
      ...
      field: 'file',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.attachments.attachments.attachments.attachments.file',
        { defaultValue: 'File' },
      ) as string,
      width: 230,
      type: 'string',
    ...
    },
    {
      ...
      field: 'type',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.attachments.attachments.attachments.attachments.type',
        { defaultValue: 'Type' },
      ) as string,
      width: 170,
      type: 'string',
  ...
  const categoriesColumns: GridColDef<AdminIssueCategoryStored>[] = [
    {
      ...
      field: 'title',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.categories.categories.categories.categories.title',
        { defaultValue: 'Title' },
      ) as string,
      width: 230,
      type: 'string',
    },
    {
      ...
      field: 'description',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.categories.categories.categories.categories.description',
  ...
  const commentsColumns: GridColDef<AdminCommentStored>[] = [
    {
      ...
      field: 'comment',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.comments.comments.comment',
    ...
    },
    {
      ...
      field: 'created',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.comments.comments.created',
    ...
    },
    {
      ...
      field: 'createdByName',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.comments.comments.createdByName',
    ...
    },
    {
      ...
      field: 'upVotes',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.comments.comments.upVotes',
        { defaultValue: 'up' },
      ) as string,
      width: 100,
      type: 'number',
    ...
    },
    {
      ...
      field: 'downVotes',
      headerName: t(
        'edemokracia.admin.Admin.issues.Issue.View.other.comments.comments.actions.comments.comments.downVotes',
        { defaultValue: 'down' },
      ) as string,
      width: 100,
      type: 'number',
  ...
  const debatesColumns: GridColDef<AdminIssueDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.debates.debates.debates.debates.status', {
        defaultValue: 'Status',
      }) as string,
      width: 170,
      type: 'string',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.debates.debates.debates.debates.title', {
        defaultValue: 'Title',
      }) as string,
      width: 230,
      type: 'string',
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.debates.debates.debates.debates.closeAt', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'description',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.debates.debates.debates.debates.description', {
        defaultValue: 'Description',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const issueTypeColumns: GridColDef<AdminIssueTypeStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.issue.issue.issueType.title', {
        defaultValue: 'Title',
      }) as string,
      width: 230,
      type: 'string',
    },
    {
      ...baseColumnConfig,
      field: 'description',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.issue.issue.issueType.description', {
        defaultValue: 'Description',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'title',
      label: t('edemokracia.admin.Admin.issues.Issue.View.issue.issue.issueType.title.Filter', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    {
      ...
      attributeName: 'description',
      label: t('edemokracia.admin.Admin.issues.Issue.View.issue.issue.issueType.description.Filter', {
        defaultValue: 'Description',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const ownerColumns: GridColDef<AdminUserStored>[] = [
    {
      ...
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.issue.issue.owner.representation', {
  ...
  const cityColumns: GridColDef<AdminCityStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.city.representation', {
        defaultValue: 'Representation',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'representation',
      label: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.city.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const countyColumns: GridColDef<AdminCountyStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.county.representation', {
        defaultValue: 'Representation',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const countyRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminIssuesViewDefaultIssueViewOtherAreaAreaCountyRepresentationFilter',
      attributeName: 'representation',
      label: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.county.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const districtColumns: GridColDef<AdminDistrictStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.district.representation', {
        defaultValue: 'Representation',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'representation',
      label: t('edemokracia.admin.Admin.issues.Issue.View.other.area.area.district.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
