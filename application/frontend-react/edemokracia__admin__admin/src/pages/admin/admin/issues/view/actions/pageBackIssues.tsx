...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::issues#PageBack
...
export const usePageBackIssuesAction = () => {
  return async function pageBackIssuesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::issues#PageBack not supported yet!');
  };
};
