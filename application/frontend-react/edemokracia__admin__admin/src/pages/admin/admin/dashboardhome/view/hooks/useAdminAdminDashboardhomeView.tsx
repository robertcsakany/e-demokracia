...
export const useAdminAdminDashboardhomeView = () => {
  ...
  const debatesColumns: GridColDef<AdminDebateStored>[] = [
    ...
    },
    {
      ...
      field: 'issueTitle',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.mydebates.mydebates.debates.debates.issueTitle',
        { defaultValue: 'Issue' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const debatesRangeFilterOptions: FilterOption[] = [
    ...
    },
    {
      ...
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.mydebates.mydebates.debates.debates.issueTitle.Filter',
        { defaultValue: 'Issue' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const issuesColumns: GridColDef<AdminIssueStored>[] = [
    ...
    },
    {
      ...
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myissues.myissues.issues.issues.numberOfDebates',
  ...
  const issuesRangeFilterOptions: FilterOption[] = [
    ...
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyissuesMyissuesIssuesLabelWrapperIssuesNumberOfDebatesFilter',
      attributeName: 'numberOfDebates',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myissues.myissues.issues.issues.numberOfDebates.Filter',
        { defaultValue: 'Debates' },
      ) as string,
  ...
  const voteEntriesColumns: GridColDef<AdminVoteEntryStored>[] = [
    {
      ...
      field: 'created',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.created',
        { defaultValue: 'Created' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 170,
    ...
    },
    {
      ...
      field: 'issueTitle',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.issueTitle',
    ...
    },
    {
      ...
      field: 'debateTitle',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.debateTitle',
    ...
    },
    {
      ...
      field: 'voteTitle',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.voteTitle',
    ...
    },
    {
      ...
      field: 'voteStatus',
      headerName: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.voteStatus',
  ...
  const voteEntriesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyvotesMyvotesVoteEntriesLabelWrapperVoteEntriesCreatedFilter',
      attributeName: 'created',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.created.Filter',
        { defaultValue: 'Created' },
      ) as string,
      filterType: FilterType.dateTime,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyvotesMyvotesVoteEntriesLabelWrapperVoteEntriesIssueTitleFilter',
      attributeName: 'issueTitle',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.issueTitle.Filter',
        { defaultValue: 'Issue Title' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyvotesMyvotesVoteEntriesLabelWrapperVoteEntriesDebateTitleFilter',
      attributeName: 'debateTitle',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.debateTitle.Filter',
        { defaultValue: 'Debate Title' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyvotesMyvotesVoteEntriesLabelWrapperVoteEntriesVoteTitleFilter',
      attributeName: 'voteTitle',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.voteTitle.Filter',
        { defaultValue: 'Vote Title' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeViewDefaultDashboardViewTabBarMyvotesMyvotesVoteEntriesLabelWrapperVoteEntriesVoteStatusFilter',
      attributeName: 'voteStatus',
      label: t(
        'edemokracia.admin.Admin.dashboardhome.Dashboard.View.tabBar.myvotes.myvotes.voteEntries.voteEntries.voteStatus.Filter',
        { defaultValue: 'Vote Status' },
      ) as string,
      filterType: FilterType.enumeration,
      enumValues: ['CREATED', 'PENDING', 'ACTIVE', 'CLOSED'],
