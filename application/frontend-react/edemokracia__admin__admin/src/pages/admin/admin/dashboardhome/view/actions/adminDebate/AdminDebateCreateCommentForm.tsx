            ...
            <Card>
              ...
              <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                <Grid item xs={12}>
                  <TextField
                    name="comment"
                    id="TextArea@edemokracia/admin/Admin/edemokracia/admin/Debate.createComment/Input/default/CreateCommentInput_Form/comment/LabelWrapper/comment/comment"
                    label={
                      t('edemokracia.admin.Debate.createComment.CreateCommentInput.Form.comment.comment.comment', {
