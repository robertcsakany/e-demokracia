...
export function AdminDashboardCreateIssueForm({ successCallback, cancel }: AdminDashboardCreateIssueFormProps) {
  ...
  const title: string = t('edemokracia.admin.Dashboard.createIssue.CreateIssueInput.Form', {
            ...
            <Card>
              ...
              <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                <Grid item xs={12} sm={4.0}>
                  <TextField
                    name="title"
                    id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Dashboard.createIssue/Input/default/CreateIssueInput_Form/issue/LabelWrapper/issue/title"
                    label={
                ...
                <Grid item xs={12}>
                  <TextField
                    name="description"
                    id="TextArea@edemokracia/admin/Admin/edemokracia/admin/Dashboard.createIssue/Input/default/CreateIssueInput_Form/issue/LabelWrapper/issue/description"
                    label={
