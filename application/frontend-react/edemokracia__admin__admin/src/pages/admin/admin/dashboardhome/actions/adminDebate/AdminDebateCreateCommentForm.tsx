...
export function AdminDebateCreateCommentForm({ successCallback, cancel, owner }: AdminDebateCreateCommentFormProps) {
  ...
  const title: string = t('edemokracia.admin.Debate.createComment.Input', { defaultValue: 'Add comment' });
  ...
  const submit = async () => {
    ...
    try {
      await adminDebateServiceImpl.createComment(owner, data);
  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDebateCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
                  ...
                  <Grid item xs={12} sm={12}>
                    <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                      ...
                      <Typography
                        ...
                        component="h1"
                      >
                        {t('edemokracia.admin.Debate.createComment.CreateCommentInput.Form.comment.comment.Label', {
                    ...
                    >
                      <Grid item xs={12} sm={12}>
                        <TextField
                          ...
                          label={
                            t(
                              'edemokracia.admin.Debate.createComment.CreateCommentInput.Form.comment.comment.comment',
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDebateCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminAdminDashboardhomeDashboardEdemokraciaAdminAdminEdemokraciaAdminDebateCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
          disabled={isLoading}
        >
          {
            t(
              'edemokracia.admin.Debate.createComment.Input.edemokracia.admin.Debate.createComment.input.ButtonSaveInput',
              { defaultValue: 'Ok' },
            ) as string
          }
        </Button>
