...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::counties#PageEdit
...
export const usePageEditCountiesAction = () => {
  return async function pageEditCountiesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::counties#PageEdit not supported yet!');
  };
};
