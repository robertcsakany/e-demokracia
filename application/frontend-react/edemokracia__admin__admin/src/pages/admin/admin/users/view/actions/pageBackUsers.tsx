...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Admin::users#PageBack
...
export const usePageBackUsersAction = () => {
  return async function pageBackUsersAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Admin::users#PageBack not supported yet!');
  };
};
