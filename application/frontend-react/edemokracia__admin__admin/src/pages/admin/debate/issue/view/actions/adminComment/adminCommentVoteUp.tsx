...
import { AdminIssueStored, AdminCommentStored } from '../../../../../../../generated/data-api';
...
export const useAdminCommentVoteUpAction: AdminCommentVoteUpAction = () => {
  ...
  const title: string = t('edemokracia.admin.Debate.issue.View.edemokracia.admin.Comment.voteUp', { defaultValue: '' });
