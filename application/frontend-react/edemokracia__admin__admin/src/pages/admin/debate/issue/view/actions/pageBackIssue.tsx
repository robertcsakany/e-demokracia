...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Debate::issue#PageBack
...
export const usePageBackIssueAction = () => {
  return async function pageBackIssueAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Debate::issue#PageBack not supported yet!');
  };
};
