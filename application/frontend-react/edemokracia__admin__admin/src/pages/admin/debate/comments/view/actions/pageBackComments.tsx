...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Debate::comments#PageBack
...
export const usePageBackCommentsAction = () => {
  return async function pageBackCommentsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Debate::comments#PageBack not supported yet!');
  };
};
