...
export default function AdminDebateConsView() {
  ...
  const title: string = t('edemokracia.admin.Debate.cons.Con.View', { defaultValue: 'View / Edit Con' });
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={6.0}>
                    <TextField
                      ...
                      label={
                        t('edemokracia.admin.Debate.cons.Con.View.con.con.title', { defaultValue: 'Title' }) as string
                      }
                      value={data.title}
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      ...
                      label={
                        t('edemokracia.admin.Debate.cons.Con.View.con.con.upVotes', { defaultValue: '' }) as string
                      }
                      type="number"
                      value={data.upVotes}
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      ...
                      label={
                        t('edemokracia.admin.Debate.cons.Con.View.con.con.downVotes', { defaultValue: '' }) as string
                      }
                      type="number"
                  ...
                  <Grid container item xs={12} sm={4.0} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12}>
                      ...
                      >
                        ...
                        {t('edemokracia.admin.Debate.cons.Con.View.tabBar.comments.comments.actions.createComment', {
                          defaultValue: 'Add comment',
                        })}
                      </Button>
                    </Grid>
