...
import { AdminConStored, AdminCommentStored } from '../../../../../../../generated/data-api';
...
export const useAdminCommentVoteUpAction: AdminCommentVoteUpAction = () => {
  ...
  const title: string = t('edemokracia.admin.Debate.cons.View.edemokracia.admin.Comment.voteUp', { defaultValue: '' });
