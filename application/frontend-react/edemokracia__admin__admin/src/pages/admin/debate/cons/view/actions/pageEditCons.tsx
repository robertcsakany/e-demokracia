...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Debate::cons#PageEdit
...
export const usePageEditConsAction = () => {
  return async function pageEditConsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Debate::cons#PageEdit not supported yet!');
  };
};
