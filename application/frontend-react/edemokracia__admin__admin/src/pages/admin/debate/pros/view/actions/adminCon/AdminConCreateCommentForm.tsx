  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDebateProsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDebateProsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <Button
          id="CallOperationActionedemokraciaAdminAdminEdemokraciaAdminDebateProsViewEdemokraciaAdminAdminEdemokraciaAdminConCreateCommentButtonCallOperation-action-form-action-submit"
          variant="contained"
          onClick={() => submit()}
          disabled={isLoading}
        >
