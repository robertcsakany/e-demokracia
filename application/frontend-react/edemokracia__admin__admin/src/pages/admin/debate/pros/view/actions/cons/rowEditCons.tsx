...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Pro::cons#RowEdit
...
export const useRowEditConsAction = () => {
  return async function rowEditConsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Pro::cons#RowEdit not supported yet!');
  };
};
