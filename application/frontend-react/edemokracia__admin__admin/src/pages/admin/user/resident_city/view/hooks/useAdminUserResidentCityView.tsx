...
export const useAdminUserResidentCityView = () => {
  ...
  const districtsColumns: GridColDef<AdminDistrictStored>[] = [
    {
      ...baseColumnConfig,
      field: 'name',
      headerName: t('edemokracia.admin.User.residentCity.City.View.districts.districts.name', {
        defaultValue: 'Name',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const districtsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminUserResidentCityViewDefaultCityViewDistrictsLabelWrapperDistrictsNameFilter',
      attributeName: 'name',
      label: t('edemokracia.admin.User.residentCity.City.View.districts.districts.name.Filter', {
        defaultValue: 'Name',
      }) as string,
