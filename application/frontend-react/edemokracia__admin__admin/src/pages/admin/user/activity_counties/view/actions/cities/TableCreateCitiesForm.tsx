  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserActivityCountiesViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserActivityCountiesViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminUserActivityCountiesViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-action-form-action-create"
          variant="contained"
          onClick={() => saveData()}
          disabled={isLoading}
        >
