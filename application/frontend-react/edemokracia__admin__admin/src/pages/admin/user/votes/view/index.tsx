...
export default function AdminUserVotesView() {
  ...
  const title: string = t('edemokracia.admin.User.votes.Vote', { defaultValue: 'Create / View Vote' });
          ...
          <Grid container xs={12} sm={12} spacing={2} direction="column" alignItems="stretch">
            <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
              ...
              <Grid item xs={12} sm={4.0}>
                <TextField
                  name="type"
                  id="EnumerationCombo@edemokracia/admin/Admin/edemokracia/admin/User.votes/View/default/Vote/group/type"
