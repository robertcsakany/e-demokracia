...
import {
  usePageEditActivityDistrictsAction,
  usePageRefreshActivityDistrictsAction,
  usePageBackActivityDistrictsAction,
} from './actions';
 ...
 **/
export default function AdminUserActivityDistrictsView() {
        ...
        <Box sx={mainContainerPadding}>
          <Grid container xs={12} sm={12} spacing={2} direction="column" alignItems="stretch">
            <Grid item>
              <TextField
                name="name"
                id="TextInput@edemokracia/admin/Admin/edemokracia/admin/User.activityDistricts/View/default/District_View/name"
                label={
