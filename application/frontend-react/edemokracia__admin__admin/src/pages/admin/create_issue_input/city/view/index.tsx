...
import { adminCreateIssueInputServiceImpl, adminCityServiceImpl } from '../../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../../theme';
import { useAdminCreateIssueInputCityView } from './hooks/useAdminCreateIssueInputCityView';
import {
...
export default function AdminCreateIssueInputCityView() {
  ...
  const { queryCustomizer, districtsColumns, districtsRangeFilterOptions, districtsInitialQueryCustomizer } =
    useAdminCreateIssueInputCityView();
  ...
  const districtsRowActions: TableRowAction<AdminDistrictStored>[] = [
    {
      id: 'DeleteActionedemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsRowDelete',
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required
                name="name"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewDefaultCityViewName"
                label={
                  t('edemokracia.admin.CreateIssueInput.city.City.View.name', { defaultValue: 'City name' }) as string
                }
                value={data.name}
            ...
            <Grid item xs={12} sm={12}>
              <Grid
                id="FlexedemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewDefaultCityViewDistrictsLabelWrapper"
                container
                direction="column"
                alignItems="stretch"
                justifyContent="flex-start"
              ...
              >
                <Grid item xs={12} sm={12}>
                  <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                    ...
                    <Typography
                      id="LabeledemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewDefaultCityViewDistrictsLabelWrapperDistrictsLabel"
                      variant="h6"
                      component="h1"
                    >
                      {t('edemokracia.admin.CreateIssueInput.city.City.View.districts.districts.Label', {
                ...
                <Grid item xs={12} sm={12}>
                  <Grid
                    id="TableedemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewDefaultCityViewDistrictsLabelWrapperDistricts"
                    container
                    direction="column"
                    alignItems="stretch"
                    justifyContent="flex-start"
                    ...
                    <DataGrid
                      ...
                      components={{
                        Toolbar: () => (
                          <GridToolbarContainer>
                            <Button
                              id="CreateActionedemokraciaAdminAdminEdemokraciaAdminCreateIssueInputCityViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate"
                              variant="text"
