...
import { AdminConStored } from '../../../../../../generated/data-api';
import { adminConServiceImpl } from '../../../../../../generated/data-axios';

export type VoteDownAction = () => (owner: AdminConStored, successCallback: () => void) => Promise<void>;
...
export const useVoteDownAction: VoteDownAction = () => {
  ...
  const title: string = t('edemokracia.admin.Con.cons.View.edemokracia.admin.Con.voteDown', { defaultValue: '' });
