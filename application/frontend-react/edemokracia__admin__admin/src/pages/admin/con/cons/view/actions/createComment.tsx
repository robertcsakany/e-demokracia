...
export type CreateCommentActionPostHandlerHook = () => CreateCommentActionPostHandler;

export type CreateCommentAction = () => (owner: AdminConStored, successCallback: () => void) => Promise<void>;
...
export const useCreateCommentAction: CreateCommentAction = () => {
  ...
  const title: string = t('edemokracia.admin.Con.cons.View.edemokracia.admin.Con.createComment', {
  ...
  const postHandler: CreateCommentActionPostHandler | undefined = customPostHandler && customPostHandler();

  return async function createCommentAction(owner: AdminConStored, successCallback: () => void) {
    createDialog({
      fullWidth: true,
      maxWidth: 'lg',
