...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Con::cons#RowEdit
...
export const useRowEditConsAction = () => {
  return async function rowEditConsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Con::cons#RowEdit not supported yet!');
  };
};
