              ...
              <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                ...
                <Grid item xs={12} sm={4.0}>
                  <TextField
                    ...
                    onChange={(event) => storeDiff('type', event.target.value as EdemokraciaCreateArgumentInputType)}
                    className={false || !editMode ? 'Mui-readOnly' : undefined}
                    InputLabelProps={{ shrink: true }}
                    InputProps={{
                      readOnly: false || !editMode,
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    label={
                      t('edemokracia.admin.Con.createSubArgument.CreateArgumentInput.Form.group.group.description', {
