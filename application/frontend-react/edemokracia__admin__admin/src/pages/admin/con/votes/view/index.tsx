...
import { usePageBackVotesAction, usePageRefreshVotesAction } from './actions';
...
export default function AdminConVotesView() {
  ...
  const title: string = t('edemokracia.admin.Con.votes.Vote', { defaultValue: 'Create / View Vote' });
