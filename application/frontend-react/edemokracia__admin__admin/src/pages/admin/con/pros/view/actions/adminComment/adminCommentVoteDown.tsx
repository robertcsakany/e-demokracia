...
import { AdminProStored, AdminCommentStored } from '../../../../../../../generated/data-api';
...
export const useAdminCommentVoteDownAction: AdminCommentVoteDownAction = () => {
  ...
  const title: string = t('edemokracia.admin.Con.pros.View.edemokracia.admin.Comment.voteDown', { defaultValue: '' });
