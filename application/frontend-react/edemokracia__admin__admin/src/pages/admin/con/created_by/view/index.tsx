...
export default function AdminConCreatedByView() {
  ...
  const title: string = t('edemokracia.admin.Con.createdBy.User.View', { defaultValue: 'View / Edit User' });
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        name="phone"
                        id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Con.createdBy/View/default/User_View/personal/LabelWrapper/personal/contact/phone"
                        label={
                ...
                <Grid container item xs={12} alignItems="center" justifyContent="center" spacing={2}>
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        name="residentCounty"
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Con.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentCounty"
                        label={
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        name="residentCity"
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Con.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentCity"
                        label={
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Con.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentDistrict"
                        label={
                          t('edemokracia.admin.Con.createdBy.User.View.Areas.Areas.Residency.residentDistrict', {
