...
export default function AdminConCommentsView() {
  ...
  const title: string = t('edemokracia.admin.Con.comments.Comment.View', { defaultValue: 'View / Edit Comment' });
              ...
              <Card>
                <Grid container item alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography variant="h6" component="h1">
                    {t('edemokracia.admin.Con.comments.Comment.View.group.group.Label', { defaultValue: 'Comment' })}
                  </Typography>
                </Grid>
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  ...
                  <Grid item xs={12} sm={4.0}>
                    <AggregationInput
                      name="createdBy"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Con.comments/View/default/Comment_View/group/LabelWrapper/group/createdBy"
                      label={
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="upVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Con.comments/View/default/Comment_View/group/LabelWrapper/group/upVotes"
                      label={
                  ...
                  <Grid item xs={12} sm={1.0}>
                    ...
                    >
                      ...
                      {t('edemokracia.admin.Con.comments.Comment.View.group.group.voteDown', { defaultValue: '' })}
                    </Button>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="downVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Con.comments/View/default/Comment_View/group/LabelWrapper/group/downVotes"
                      label={
                  ...
                  <Grid item xs={12} sm={2.0}>
                    <Button onClick={() => buttonNavigateVotesAction(data)} disabled={isLoading || editMode}>
                      ...
                      {t('edemokracia.admin.Con.comments.Comment.View.group.group.votes', { defaultValue: 'Votes' })}
                    </Button>
                  </Grid>
                </Grid>
              </Card>
