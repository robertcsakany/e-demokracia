...
// Action name: edemokracia::admin::Admin::edemokracia::admin::City::districts#PageEdit
...
export const usePageEditDistrictsAction = () => {
  return async function pageEditDistrictsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::City::districts#PageEdit not supported yet!');
  };
};
