  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <Button
            id="CreateActionedemokraciaAdminAdminEdemokraciaAdminCountyCitiesViewEdemokraciaAdminAdminEdemokraciaAdminCityDistrictsTableCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
                  ...
                  <MenuList id="split-button-menu" autoFocusItem>
                    <MenuItem
                      ...
                      onClick={async (event: any) => {
                        ...
                        if (result) {
                          successCallback();
                          navigate(`admin/city/districts/view/${result.__signedIdentifier}`);
                        }
                      }}
                      disabled={isLoading}
                    >
