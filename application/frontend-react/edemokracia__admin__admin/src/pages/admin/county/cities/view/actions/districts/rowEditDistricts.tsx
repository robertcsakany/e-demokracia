...
// Action name: edemokracia::admin::Admin::edemokracia::admin::City::districts#RowEdit
...
export const useRowEditDistrictsAction = () => {
  return async function rowEditDistrictsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::City::districts#RowEdit not supported yet!');
  };
};
