...
export const useAdminIssueCreatedByView = () => {
  ...
  const activityCitiesColumns: GridColDef<AdminCityStored>[] = [
    {
      ...
      headerName: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.activity.cities.activity.cities.activityCities.activityCities.representation',
        { defaultValue: 'City' },
      ) as string,
      width: 230,
      type: 'string',
  ...
  const activityCitiesRangeFilterOptions: FilterOption[] = [
    {
      ...
      label: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.activity.cities.activity.cities.activityCities.activityCities.representation.Filter',
        { defaultValue: 'City' },
      ) as string,
  ...
  const activityDistrictsColumns: GridColDef<AdminDistrictStored>[] = [
    {
      ...
      field: 'representation',
      headerName: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.activity.districts.activity.districts.activityDistricts.activityDistricts.representation',
  ...
  const activityDistrictsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewAreasLabelWrapperAreasActivityActivityDistrictsActivityDistrictsActivityDistrictsLabelWrapperActivityDistrictsRepresentationFilter',
      attributeName: 'representation',
      label: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.activity.districts.activity.districts.activityDistricts.activityDistricts.representation.Filter',
        { defaultValue: 'District' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const activityCountiesColumns: GridColDef<AdminCountyStored>[] = [
    {
      ...
      field: 'representation',
      headerName: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.tab.activity.counties.tab.activity.counties.activityCounties.activityCounties.representation',
        { defaultValue: 'County' },
      ) as string,
      width: 230,
      type: 'string',
  ...
  const activityCountiesRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewAreasLabelWrapperAreasActivityTabActivityCountiesTabActivityCountiesActivityCountiesLabelWrapperActivityCountiesRepresentationFilter',
      attributeName: 'representation',
      label: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.activity.tab.activity.counties.tab.activity.counties.activityCounties.activityCounties.representation.Filter',
        { defaultValue: 'County' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const residentCityColumns: GridColDef<AdminCityStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentCity.representation', {
        defaultValue: 'City',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const residentCityRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewAreasLabelWrapperAreasResidencyResidentCityRepresentationFilter',
      attributeName: 'representation',
      label: t('edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentCity.representation.Filter', {
        defaultValue: 'City',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const residentCountyColumns: GridColDef<AdminCountyStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentCounty.representation', {
        defaultValue: 'County',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const residentCountyRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'representation',
      label: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentCounty.representation.Filter',
        { defaultValue: 'County' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const residentDistrictColumns: GridColDef<AdminDistrictStored>[] = [
    {
      ...
      field: 'representation',
      headerName: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentDistrict.representation',
        { defaultValue: 'District' },
      ) as string,
      width: 230,
      type: 'string',
  ...
  const residentDistrictRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminIssueCreatedByViewDefaultUserViewAreasLabelWrapperAreasResidencyResidentDistrictRepresentationFilter',
      attributeName: 'representation',
      label: t(
        'edemokracia.admin.Issue.createdBy.User.View.Areas.Areas.Residency.residentDistrict.representation.Filter',
        { defaultValue: 'District' },
      ) as string,
      filterType: FilterType.string,
    },
