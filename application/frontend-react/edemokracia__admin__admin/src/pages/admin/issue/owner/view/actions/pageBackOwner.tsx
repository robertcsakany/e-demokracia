...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Issue::owner#PageBack
...
export const usePageBackOwnerAction = () => {
  return async function pageBackOwnerAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Issue::owner#PageBack not supported yet!');
  };
};
