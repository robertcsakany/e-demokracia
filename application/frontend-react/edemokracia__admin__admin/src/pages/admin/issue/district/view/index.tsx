...
import { useAdminIssueDistrictView } from './hooks/useAdminIssueDistrictView';
...
export default function AdminIssueDistrictView() {
  ...
  const { queryCustomizer } = useAdminIssueDistrictView();
          ...
          >
            <Grid item xs={12} sm={12}>
              <TextField
                required
                name="name"
                id="TextInputedemokraciaAdminAdminEdemokraciaAdminIssueDistrictViewDefaultDistrictViewName"
                label={
                  t('edemokracia.admin.Issue.district.District.View.name', { defaultValue: 'District name' }) as string
                }
                value={data.name}
