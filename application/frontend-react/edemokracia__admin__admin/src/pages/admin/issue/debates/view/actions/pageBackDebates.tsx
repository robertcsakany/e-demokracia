...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Issue::debates#PageBack
...
export const usePageBackDebatesAction = () => {
  return async function pageBackDebatesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Issue::debates#PageBack not supported yet!');
  };
};
