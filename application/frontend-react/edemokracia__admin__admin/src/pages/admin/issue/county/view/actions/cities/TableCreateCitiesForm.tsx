  ...
  return (
    <>
      <DialogTitle>
        {title}
        <IconButton
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminIssueCountyViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-dialog-close"
          aria-label="close"
          onClick={() => cancel()}
          sx={{
            position: 'absolute',
      ...
      <DialogActions>
        <Button
          id="CreateActionedemokraciaAdminAdminEdemokraciaAdminIssueCountyViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-action-form-action-cancel"
          variant="text"
          onClick={() => cancel()}
          disabled={isLoading}
        >
        ...
        <ButtonGroup size="small" ref={anchorRef} aria-label="split button" disabled={isLoading}>
          <Button
            id="CreateActionedemokraciaAdminAdminEdemokraciaAdminIssueCountyViewEdemokraciaAdminAdminEdemokraciaAdminCountyCitiesTableCreate-action-form-action-create"
            variant="contained"
            onClick={async () => {
