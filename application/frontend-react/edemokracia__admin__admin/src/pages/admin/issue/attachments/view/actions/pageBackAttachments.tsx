...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Issue::attachments#PageBack
...
export const usePageBackAttachmentsAction = () => {
  return async function pageBackAttachmentsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Issue::attachments#PageBack not supported yet!');
  };
};
