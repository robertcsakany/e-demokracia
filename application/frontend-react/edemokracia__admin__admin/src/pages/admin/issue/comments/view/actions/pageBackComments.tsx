...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Issue::comments#PageBack
...
export const usePageBackCommentsAction = () => {
  return async function pageBackCommentsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Issue::comments#PageBack not supported yet!');
  };
};
