...
import { AdminDebateStored, AdminCommentStored } from '../../../../../../../generated/data-api';
...
export const useAdminCommentVoteDownAction: AdminCommentVoteDownAction = () => {
  ...
  const title: string = t('edemokracia.admin.VoteDefinition.debate.View.edemokracia.admin.Comment.voteDown', {
    defaultValue: '',
  });
