...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Comment::votes#PageBack
...
export const usePageBackVotesAction = () => {
  return async function pageBackVotesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Comment::votes#PageBack not supported yet!');
  };
};
