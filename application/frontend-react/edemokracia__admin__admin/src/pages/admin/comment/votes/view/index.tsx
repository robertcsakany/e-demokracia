...
import {
  usePageDeleteVotesAction,
  usePageEditVotesAction,
  usePageRefreshVotesAction,
  usePageBackVotesAction,
} from './actions';
...
export default function AdminCommentVotesView() {
  ...
  const title: string = t('edemokracia.admin.Comment.votes.Vote', { defaultValue: 'Create / View Vote' });
