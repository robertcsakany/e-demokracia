...
export default function AdminCommentCreatedByView() {
  ...
  const pageBackCreatedByAction = usePageBackCreatedByAction();
  ...
  const [residentCitySortModel, setResidentCitySortModel] = useState<GridSortModel>([
    { field: 'representation', sort: 'asc' },
  ]);
  const [residentCountySortModel, setResidentCountySortModel] = useState<GridSortModel>([
    { field: 'representation', sort: 'asc' },
  ]);
  const [residentDistrictSortModel, setResidentDistrictSortModel] = useState<GridSortModel>([
    { field: 'representation', sort: 'asc' },
  ]);
  ...
  const title: string = t('edemokracia.admin.Comment.createdBy.User.View', { defaultValue: 'View / Edit User' });
              ...
              <Card>
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={4.0}>
                    <TextField
                      name="userName"
                      id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/Security/LabelWrapper/Security/userName"
                      label={
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        name="firstName"
                        id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/personal/LabelWrapper/personal/name/firstName"
                        label={
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        name="lastName"
                        id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/personal/LabelWrapper/personal/name/lastName"
                        label={
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        name="email"
                        id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/personal/LabelWrapper/personal/contact/email"
                        label={
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        name="phone"
                        id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/personal/LabelWrapper/personal/contact/phone"
                        label={
            ...
            <Grid container item xs={12} sm={12.0} direction="column" alignItems="stretch" justifyContent="flex-start">
              <Card>
                <Grid container item alignItems="center" justifyContent="flex-start">
                  <MdiIcon path="map" />
                  <Typography variant="h6" component="h1">
                    {t('edemokracia.admin.Comment.createdBy.User.View.Areas.Areas.Label', { defaultValue: 'Areas' })}
                  </Typography>
                </Grid>
                ...
                <Grid container item xs={12} alignItems="center" justifyContent="center" spacing={2}>
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        name="residentCounty"
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentCounty"
                        label={
                          t('edemokracia.admin.Comment.createdBy.User.View.Areas.Areas.Residency.residentCounty', {
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        name="residentCity"
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentCity"
                        label={
                          t('edemokracia.admin.Comment.createdBy.User.View.Areas.Areas.Residency.residentCity', {
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        id="Link@edemokracia/admin/Admin/edemokracia/admin/Comment.createdBy/View/default/User_View/Areas/LabelWrapper/Areas/Residency/residentDistrict"
                        label={
                          t('edemokracia.admin.Comment.createdBy.User.View.Areas.Areas.Residency.residentDistrict', {
                        ...
                        >
                          <Grid item>
                            <DataGrid
                              ...
                              columns={[
                                ...activityDistrictsColumns,
                                ...columnsActionCalculator(activityDistrictsRowActions, { shownActions: 2 }),
                              ]}
                              disableSelectionOnClick
