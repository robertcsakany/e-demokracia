...
export const useAdminDashboardCreateissueOutput = () => {
  ...
  const attachmentsColumns: GridColDef<AdminIssueAttachmentStored>[] = [
    {
      ...
      field: 'link',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.attachments.attachments.attachments.attachments.link',
        { defaultValue: 'Link' },
      ) as string,
    ...
    },
    {
      ...
      field: 'file',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.attachments.attachments.attachments.attachments.file',
        { defaultValue: 'File' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
    ...
    },
    {
      ...
      field: 'type',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.attachments.attachments.attachments.attachments.type',
        { defaultValue: 'Type' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 170,
  ...
  const attachmentsRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardCreateIssueOutputDefaultIssueViewOtherAttachmentsAttachmentsAttachmentsLabelWrapperAttachmentsLinkFilter',
      attributeName: 'link',
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.attachments.attachments.attachments.attachments.link.Filter',
        { defaultValue: 'Link' },
      ) as string,
    ...
    },
    {
      ...
      attributeName: 'type',
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.attachments.attachments.attachments.attachments.type.Filter',
        { defaultValue: 'Type' },
      ) as string,
  ...
  const categoriesColumns: GridColDef<AdminIssueCategoryStored>[] = [
    {
      ...
      field: 'title',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.categories.categories.categories.categories.title',
        { defaultValue: 'Title' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
    ...
    },
    {
      ...
      field: 'description',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.categories.categories.categories.categories.description',
  ...
  const categoriesRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'title',
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.categories.categories.categories.categories.title.Filter',
        { defaultValue: 'Title' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.categories.categories.categories.categories.description.Filter',
        { defaultValue: 'Description' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const commentsColumns: GridColDef<AdminCommentStored>[] = [
    {
      ...
      field: 'comment',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.comment',
    ...
    },
    {
      ...
      field: 'created',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.created',
    ...
    },
    {
      ...
      field: 'createdByName',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.createdByName',
    ...
    },
    {
      ...
      field: 'upVotes',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.upVotes',
        { defaultValue: 'up' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 100,
    ...
    },
    {
      ...
      field: 'downVotes',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.downVotes',
        { defaultValue: 'down' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 100,
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.comment.Filter',
        { defaultValue: 'Comment' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.created.Filter',
        { defaultValue: 'Created' },
      ) as string,
    ...
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.createdByName.Filter',
        { defaultValue: 'CreatedByName' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.upVotes.Filter',
        { defaultValue: 'up' },
      ) as string,
    ...
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.comments.comments.actions.comments.comments.downVotes.Filter',
        { defaultValue: 'down' },
      ) as string,
      filterType: FilterType.numeric,
    },
  ...
  const debatesColumns: GridColDef<AdminIssueDebateStored>[] = [
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.status', {
        defaultValue: 'Status',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 170,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.title', {
        defaultValue: 'Title',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
    ...
    },
    {
      ...
      field: 'closeAt',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.closeAt',
    ...
    },
    {
      ...
      field: 'description',
      headerName: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.description',
        { defaultValue: 'Description' },
      ) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const debatesRangeFilterOptions: FilterOption[] = [
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.status.Filter',
        { defaultValue: 'Status' },
      ) as string,
      filterType: FilterType.enumeration,
    ...
    },
    {
      ...
      attributeName: 'title',
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.title.Filter',
        { defaultValue: 'Title' },
      ) as string,
      filterType: FilterType.string,
    },
    {
      ...
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.closeAt.Filter',
        { defaultValue: 'CloseAt' },
      ) as string,
      filterType: FilterType.dateTime,
    },
    {
      ...
      attributeName: 'description',
      label: t(
        'edemokracia.admin.Dashboard.createIssue.Issue.View.other.debates.debates.debates.debates.description.Filter',
        { defaultValue: 'Description' },
      ) as string,
      filterType: FilterType.string,
    },
  ...
  const issueTypeColumns: GridColDef<AdminIssueTypeStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.issueType.title', {
        defaultValue: 'Title',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
    ...
    },
    {
      ...baseColumnConfig,
      field: 'description',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.issueType.description', {
        defaultValue: 'Description',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const issueTypeRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardCreateIssueOutputDefaultIssueViewIssueLabelWrapperIssueIssueTypeTitleFilter',
      attributeName: 'title',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.issueType.title.Filter', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    {
      ...
      attributeName: 'description',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.issueType.description.Filter', {
        defaultValue: 'Description',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const ownerColumns: GridColDef<AdminUserStored>[] = [
    {
      ...
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.owner.representation', {
  ...
  const ownerRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardCreateIssueOutputDefaultIssueViewIssueLabelWrapperIssueOwnerRepresentationFilter',
      attributeName: 'representation',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.issue.issue.owner.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const cityColumns: GridColDef<AdminCityStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.city.representation', {
        defaultValue: 'Representation',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const cityRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'representation',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.city.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const countyColumns: GridColDef<AdminCountyStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.county.representation', {
        defaultValue: 'Representation',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const countyRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'representation',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.county.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
  ...
  const districtColumns: GridColDef<AdminDistrictStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.district.representation', {
        defaultValue: 'Representation',
      }) as string,
      headerClassName: 'data-grid-column-header',
      width: 230,
  ...
  const districtRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminDashboardCreateIssueOutputDefaultIssueViewOtherAreaAreaDistrictRepresentationFilter',
      attributeName: 'representation',
      label: t('edemokracia.admin.Dashboard.createIssue.Issue.View.other.area.area.district.representation.Filter', {
        defaultValue: 'Representation',
      }) as string,
      filterType: FilterType.string,
    },
