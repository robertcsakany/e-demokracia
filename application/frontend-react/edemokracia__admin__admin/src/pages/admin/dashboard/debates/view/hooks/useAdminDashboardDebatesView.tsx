  ...
  const createdByColumns: GridColDef<AdminUserStored>[] = [
    {
      ...
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.createdBy.representation', {
  ...
  const issueColumns: GridColDef<AdminIssueStored>[] = [
    {
      ...baseColumnConfig,
      field: 'representation',
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.issue.representation', {
        defaultValue: 'Representation',
      }) as string,
      width: 230,
      type: 'string',
  ...
  const voteDefinitionColumns: GridColDef<AdminVoteDefinitionStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.voteDefinition.title', {
        defaultValue: 'Title',
      }) as string,
      width: 230,
      type: 'string',
    },
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.voteDefinition.created', {
        defaultValue: 'Created',
      }) as string,
      width: 170,
      type: 'dateTime',
    },
    {
      ...baseColumnConfig,
      field: 'status',
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.voteDefinition.status', {
        defaultValue: 'Status',
      }) as string,
      width: 170,
      type: 'string',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'closeAt',
      headerName: t('edemokracia.admin.Dashboard.debates.Debate.View.debate.debate.voteDefinition.closeAt', {
