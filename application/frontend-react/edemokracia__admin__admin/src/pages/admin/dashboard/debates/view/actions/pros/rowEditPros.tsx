...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Debate::pros#RowEdit
...
export const useRowEditProsAction = () => {
  return async function rowEditProsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Debate::pros#RowEdit not supported yet!');
  };
};
