...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Dashboard::debates#PageBack
...
export const usePageBackDebatesAction = () => {
  return async function pageBackDebatesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Dashboard::debates#PageBack not supported yet!');
  };
};
