...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Issue::attachments#RowEdit
...
export const useRowEditAttachmentsAction = () => {
  return async function rowEditAttachmentsAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Issue::attachments#RowEdit not supported yet!');
  };
};
