...
export type CreateSubArgumentAction = () => (owner: AdminProStored, successCallback: () => void) => Promise<void>;
...
export const useCreateSubArgumentAction: CreateSubArgumentAction = () => {
  ...
  const title: string = t('edemokracia.admin.Pro.pros.View.edemokracia.admin.Pro.createSubArgument', {
  ...
  return async function createSubArgumentAction(owner: AdminProStored, successCallback: () => void) {
    createDialog({
      fullWidth: true,
      maxWidth: 'lg',
