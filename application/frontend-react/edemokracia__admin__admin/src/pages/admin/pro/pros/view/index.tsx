...
export default function AdminProProsView() {
  ...
  const title: string = t('edemokracia.admin.Pro.pros.Pro.View', { defaultValue: 'View / Edit Pro' });
              ...
              <Card>
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={6.0}>
                    <TextField
                      name="title"
                      id="TextInput@edemokracia/admin/Admin/edemokracia/admin/Pro.pros/View/default/Pro_View/pro/LabelWrapper/pro/title"
                      label={
                        t('edemokracia.admin.Pro.pros.Pro.View.pro.pro.title', { defaultValue: 'Title' }) as string
                      }
                      value={data.title}
                  ...
                  <Grid item xs={12} sm={3.0}>
                    <DateTimePicker
                      ...
                      label={
                        t('edemokracia.admin.Pro.pros.Pro.View.pro.pro.created', { defaultValue: 'Created' }) as string
                      }
                  ...
                  <Grid item xs={12} sm={3.0}>
                    <AggregationInput
                      name="createdBy"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Pro.pros/View/default/Pro_View/pro/LabelWrapper/pro/createdBy"
                      label={
                  ...
                  <Grid item xs={12}>
                    <TextField
                      name="description"
                      id="TextArea@edemokracia/admin/Admin/edemokracia/admin/Pro.pros/View/default/Pro_View/pro/LabelWrapper/pro/description"
                      label={
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="upVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Pro.pros/View/default/Pro_View/pro/LabelWrapper/pro/upVotes"
                      label={t('edemokracia.admin.Pro.pros.Pro.View.pro.pro.upVotes', { defaultValue: '' }) as string}
                      type="number"
                      value={data.upVotes}
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="downVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Pro.pros/View/default/Pro_View/pro/LabelWrapper/pro/downVotes"
                      label={t('edemokracia.admin.Pro.pros.Pro.View.pro.pro.downVotes', { defaultValue: '' }) as string}
                      type="number"
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      ...
                      >
                        ...
                        {t('edemokracia.admin.Pro.pros.Pro.View.tabBar.arguments.arguments.actions.createSubArgument', {
                          defaultValue: 'Add argument',
                        })}
                      </Button>
                    </Grid>
