...
// Action name: edemokracia::admin::Admin::edemokracia::admin::Pro::votes#PageBack
...
export const usePageBackVotesAction = () => {
  return async function pageBackVotesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::Pro::votes#PageBack not supported yet!');
  };
};
