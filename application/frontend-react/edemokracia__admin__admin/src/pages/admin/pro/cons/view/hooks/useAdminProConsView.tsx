...
export const useAdminProConsView = () => {
  ...
  const consColumns: GridColDef<AdminConStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.title', {
        defaultValue: 'Title',
      }) as string,
      width: 230,
      type: 'string',
    },
    {
      ...baseColumnConfig,
      field: 'upVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.upVotes', {
        defaultValue: 'up',
      }) as string,
      width: 100,
      type: 'number',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'downVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.downVotes', {
        defaultValue: 'down',
      }) as string,
      width: 100,
      type: 'number',
  ...
  const consRangeFilterOptions: FilterOption[] = [
    {
      ...
      attributeName: 'title',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.title.Filter', {
        defaultValue: 'Title',
      }) as string,
    ...
    },
    {
      ...
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.upVotes.Filter', {
        defaultValue: 'up',
      }) as string,
    ...
    },
    {
      ...
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.cons.cons.downVotes.Filter', {
        defaultValue: 'down',
      }) as string,
      filterType: FilterType.numeric,
    },
  ...
  const prosColumns: GridColDef<AdminProStored>[] = [
    {
      ...baseColumnConfig,
      field: 'title',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.title', {
        defaultValue: 'Title',
      }) as string,
      width: 230,
      type: 'string',
    },
    {
      ...baseColumnConfig,
      field: 'upVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.upVotes', {
        defaultValue: 'up',
      }) as string,
      width: 100,
      type: 'number',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'downVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.downVotes', {
        defaultValue: 'down',
      }) as string,
      width: 100,
      type: 'number',
  ...
  const prosRangeFilterOptions: FilterOption[] = [
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminProConsViewDefaultConViewTabBarArgumentsArgumentsProsLabelWrapperProsTitleFilter',
      attributeName: 'title',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.title.Filter', {
        defaultValue: 'Title',
      }) as string,
      filterType: FilterType.string,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminProConsViewDefaultConViewTabBarArgumentsArgumentsProsLabelWrapperProsUpVotesFilter',
      attributeName: 'upVotes',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.upVotes.Filter', {
        defaultValue: 'up',
      }) as string,
      filterType: FilterType.numeric,
    },
    {
      id: 'FilteredemokraciaAdminAdminEdemokraciaAdminProConsViewDefaultConViewTabBarArgumentsArgumentsProsLabelWrapperProsDownVotesFilter',
      attributeName: 'downVotes',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.pros.pros.downVotes.Filter', {
        defaultValue: 'down',
      }) as string,
      filterType: FilterType.numeric,
    },
  ...
  const commentsColumns: GridColDef<AdminCommentStored>[] = [
    {
      ...baseColumnConfig,
      field: 'created',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.created', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'comment',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.comment', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'createdByName',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.createdByName', {
    ...
    },
    {
      ...baseColumnConfig,
      field: 'upVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.upVotes', {
        defaultValue: 'up',
      }) as string,
      width: 100,
      type: 'number',
    ...
    },
    {
      ...baseColumnConfig,
      field: 'downVotes',
      headerName: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.downVotes', {
        defaultValue: 'down',
      }) as string,
      width: 100,
      type: 'number',
  ...
  const commentsRangeFilterOptions: FilterOption[] = [
    {
      ...
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.created.Filter', {
        defaultValue: 'Created',
      }) as string,
    ...
    },
    {
      ...
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.comment.Filter', {
        defaultValue: 'Comment',
      }) as string,
      filterType: FilterType.string,
    },
    {
      ...
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.createdByName.Filter', {
        defaultValue: 'Created by',
      }) as string,
      filterType: FilterType.string,
    },
    {
      ...
      attributeName: 'upVotes',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.upVotes.Filter', {
        defaultValue: 'up',
      }) as string,
      filterType: FilterType.numeric,
    },
    {
      ...
      attributeName: 'downVotes',
      label: t('edemokracia.admin.Pro.cons.Con.View.tabBar.comments.comments.comments.comments.downVotes.Filter', {
        defaultValue: 'down',
      }) as string,
      filterType: FilterType.numeric,
    },
