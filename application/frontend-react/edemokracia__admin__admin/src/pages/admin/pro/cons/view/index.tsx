...
export default function AdminProConsView() {
  ...
  const pageBackConsAction = usePageBackConsAction();
  ...
  const title: string = t('edemokracia.admin.Pro.cons.Con.View', { defaultValue: 'View / Edit Con' });
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  <Grid item xs={12} sm={6.0}>
                    <TextField
                      ...
                      label={
                        t('edemokracia.admin.Pro.cons.Con.View.con.con.title', { defaultValue: 'Title' }) as string
                      }
                      value={data.title}
                  ...
                  <Grid item xs={12} sm={3.0}>
                    <DateTimePicker
                      ...
                      label={
                        t('edemokracia.admin.Pro.cons.Con.View.con.con.created', { defaultValue: 'Created' }) as string
                      }
                  ...
                  <Grid item xs={12} sm={3.0}>
                    <AggregationInput
                      name="createdBy"
                      id="Link@edemokracia/admin/Admin/edemokracia/admin/Pro.cons/View/default/Con_View/con/LabelWrapper/con/createdBy"
                      label={
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="upVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Pro.cons/View/default/Con_View/con/LabelWrapper/con/upVotes"
                      label={t('edemokracia.admin.Pro.cons.Con.View.con.con.upVotes', { defaultValue: '' }) as string}
                      type="number"
                      value={data.upVotes}
                  ...
                  <Grid item xs={12} sm={1.0}>
                    <TextField
                      name="downVotes"
                      id="NumericInput@edemokracia/admin/Admin/edemokracia/admin/Pro.cons/View/default/Con_View/con/LabelWrapper/con/downVotes"
                      label={t('edemokracia.admin.Pro.cons.Con.View.con.con.downVotes', { defaultValue: '' }) as string}
                      type="number"
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      ...
                      >
                        ...
                        {t('edemokracia.admin.Pro.cons.Con.View.tabBar.arguments.arguments.actions.createSubArgument', {
                          defaultValue: 'Add argument',
                        })}
                      </Button>
                    </Grid>
