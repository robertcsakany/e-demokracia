                    ...
                    <Grid item xs={12} sm={12}>
                      ...
                      >
                        ...
                        <Grid item xs={12} sm={12} md={4.0}>
                          <AggregationInput
                            name="createdBy"
                            id="LinkedemokraciaAdminAdminEdemokraciaAdminProCommentsViewDefaultCommentViewGroupLabelWrapperGroupCreatedBy"
                            label={
                        ...
                        <Grid item xs={12} sm={12} md={1.0}>
                          ...
                          >
                            <span>
                              {t('edemokracia.admin.Pro.comments.Comment.View.group.group.voteUp', {
                                defaultValue: '',
                              })}
                            </span>
                          </LoadingButton>
