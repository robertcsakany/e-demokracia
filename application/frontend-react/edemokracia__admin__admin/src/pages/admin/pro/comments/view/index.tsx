...
export default function AdminProCommentsView() {
  ...
  const title: string = t('edemokracia.admin.Pro.comments.Comment.View', { defaultValue: 'View / Edit Comment' });
              ...
              <Card>
                <Grid container item alignItems="center" justifyContent="flex-start">
                  ...
                  <Typography variant="h6" component="h1">
                    {t('edemokracia.admin.Pro.comments.Comment.View.group.group.Label', { defaultValue: 'Comment' })}
                  </Typography>
                </Grid>
                ...
                <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                  ...
                  <Grid item xs={12} sm={1.0}>
                    ...
                    >
                      ...
                      {t('edemokracia.admin.Pro.comments.Comment.View.group.group.voteDown', { defaultValue: '' })}
                    </Button>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={2.0}>
                    <Button onClick={() => buttonNavigateVotesAction(data)} disabled={isLoading || editMode}>
                      ...
                      {t('edemokracia.admin.Pro.comments.Comment.View.group.group.votes', { defaultValue: 'Votes' })}
                    </Button>
                  </Grid>
                </Grid>
              </Card>
