...
export default function AdminProCreatedByView() {
  ...
  const title: string = t('edemokracia.admin.Pro.createdBy.User.View', { defaultValue: 'View / Edit User' });
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        label={
                          t('edemokracia.admin.Pro.createdBy.User.View.Areas.Areas.Residency.residentDistrict', {
