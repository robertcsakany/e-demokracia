...
// Action name: edemokracia::admin::Admin::edemokracia::admin::IssueCategory::subcategories#PageEdit
...
export const usePageEditSubcategoriesAction = () => {
  return async function pageEditSubcategoriesAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::IssueCategory::subcategories#PageEdit not supported yet!');
  };
};
