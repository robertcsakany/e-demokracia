...
export default function AdminIssueCategoryOwnerView() {
  ...
  const title: string = t('edemokracia.admin.IssueCategory.owner.User.View', { defaultValue: 'View / Edit User' });
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <TextField
                        ...
                        label={
                          t('edemokracia.admin.IssueCategory.owner.User.View.personal.personal.name.firstName', {
            ...
            <Grid container item xs={12} sm={12.0} direction="column" alignItems="stretch" justifyContent="flex-start">
              <Card>
                <Grid container item alignItems="center" justifyContent="flex-start">
                  <MdiIcon path="map" />
                  <Typography variant="h6" component="h1">
                    {t('edemokracia.admin.IssueCategory.owner.User.View.Areas.Areas.Label', { defaultValue: 'Areas' })}
                  </Typography>
                </Grid>
                  ...
                  <Grid container item xs={12} alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        label={
                          t('edemokracia.admin.IssueCategory.owner.User.View.Areas.Areas.Residency.residentCounty', {
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        label={
                          t('edemokracia.admin.IssueCategory.owner.User.View.Areas.Areas.Residency.residentCity', {
                    ...
                    <Grid item xs={12} sm={4.0}>
                      <AggregationInput
                        ...
                        label={
                          t('edemokracia.admin.IssueCategory.owner.User.View.Areas.Areas.Residency.residentDistrict', {
