...
// Action name: edemokracia::admin::Admin::edemokracia::admin::IssueCategory::owner#PageBack
...
export const usePageBackOwnerAction = () => {
  return async function pageBackOwnerAction() {
    alert('edemokracia::admin::Admin::edemokracia::admin::IssueCategory::owner#PageBack not supported yet!');
  };
};
