...
// Page name: edemokracia::Debate.comments#View
...
import { Comment, CommentStored, CommentQueryCustomizer, Debate, DebateStored } from '../../../../generated/data-api';
import { debateServiceImpl, commentServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useDebateCommentsView } from './hooks/useDebateCommentsView';
import { usePageRefreshCommentsAction } from './actions';

/**
 * Name: edemokracia::Debate.comments#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function DebateCommentsView() {
  ...
  const { queryCustomizer } = useDebateCommentsView();
  ...
  const [validation, setValidation] = useState<Map<keyof Comment, string>>(new Map());

  const title: string = t('edemokracia.Debate.comments.View', { defaultValue: 'Entity View' });
  ...
  useEffect(() => {
    setValidation(new Map<keyof Comment, string>());
  }, [editMode]);
