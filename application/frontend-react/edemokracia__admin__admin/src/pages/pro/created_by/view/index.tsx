...
import { usePageRefreshCreatedByAction, usePageBackCreatedByAction } from './actions';
...
export default function ProCreatedByView() {
  ...
  const title: string = t('edemokracia.Pro.createdBy.Entity.View', { defaultValue: 'Entity View' });
