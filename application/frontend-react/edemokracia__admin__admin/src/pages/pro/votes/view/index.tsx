...
// Page name: edemokracia::Pro.votes#View
...
import { proServiceImpl, simpleVoteServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useProVotesView } from './hooks/useProVotesView';
import { usePageRefreshVotesAction } from './actions';

/**
 * Name: edemokracia::Pro.votes#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ProVotesView() {
  ...
  const { queryCustomizer } = useProVotesView();
  ...
  const [payloadDiff, setPayloadDiff] = useState<Record<keyof SimpleVoteStored, any>>(
    {} as unknown as Record<keyof SimpleVoteStored, any>,
  );
  ...
  const title: string = t('edemokracia.Pro.votes.View', { defaultValue: 'Entity View' });
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      } as Record<keyof SimpleVoteStored, any>);
    } catch (error) {
