...
import { usePageRefreshCommentsAction, usePageBackCommentsAction } from './actions';
...
export default function ProCommentsView() {
  ...
  const title: string = t('edemokracia.Pro.comments.Entity.View', { defaultValue: 'Entity View' });
