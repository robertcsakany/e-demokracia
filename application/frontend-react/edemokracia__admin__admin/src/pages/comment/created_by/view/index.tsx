...
// Page name: edemokracia::Comment.createdBy#View
...
import { commentServiceImpl, userServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useCommentCreatedByView } from './hooks/useCommentCreatedByView';
import { usePageRefreshCreatedByAction } from './actions';

/**
 * Name: edemokracia::Comment.createdBy#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function CommentCreatedByView() {
  ...
  const { queryCustomizer } = useCommentCreatedByView();
  ...
  const title: string = t('edemokracia.Comment.createdBy.View', { defaultValue: 'Entity View' });
