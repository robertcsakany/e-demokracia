...
import { usePageRefreshUserAction, usePageBackUserAction } from './actions';
...
export default function SimpleVoteUserView() {
  ...
  const title: string = t('edemokracia.SimpleVote.user.Entity.View', { defaultValue: 'Entity View' });
