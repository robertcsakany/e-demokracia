...
import { usePageRefreshSubcategoriesAction, usePageBackSubcategoriesAction } from './actions';
...
export default function IssueCategorySubcategoriesView() {
  ...
  const pageBackSubcategoriesAction = usePageBackSubcategoriesAction();
  ...
  const title: string = t('edemokracia.IssueCategory.subcategories.Entity.View', { defaultValue: 'Entity View' });
