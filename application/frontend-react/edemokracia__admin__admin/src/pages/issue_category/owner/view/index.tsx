...
import { usePageRefreshOwnerAction, usePageBackOwnerAction } from './actions';
...
export default function IssueCategoryOwnerView() {
  ...
  const title: string = t('edemokracia.IssueCategory.owner.Entity.View', { defaultValue: 'Entity View' });
