...
// Action name: edemokracia::admin::Admin::edemokracia::IssueCategory::owner#PageRefresh
// Action owner name: edemokracia::IssueCategory.owner#View
...
// Owner Page name: edemokracia::IssueCategory.owner#View
