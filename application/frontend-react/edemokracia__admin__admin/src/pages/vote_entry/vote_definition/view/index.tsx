...
// Page name: edemokracia::VoteEntry.voteDefinition#View
...
import { voteEntryServiceImpl, voteDefinitionServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useVoteEntryVoteDefinitionView } from './hooks/useVoteEntryVoteDefinitionView';
import { usePageRefreshVoteDefinitionAction } from './actions';

/**
 * Name: edemokracia::VoteEntry.voteDefinition#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function VoteEntryVoteDefinitionView() {
  ...
  const { queryCustomizer } = useVoteEntryVoteDefinitionView();
  ...
  const title: string = t('edemokracia.VoteEntry.voteDefinition.View', { defaultValue: 'Entity View' });
