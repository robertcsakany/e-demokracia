...
import { usePageBackVoteDefinitionAction, usePageRefreshVoteDefinitionAction } from './actions';
...
export default function VoteEntryVoteDefinitionView() {
  ...
  const title: string = t('edemokracia.VoteEntry.voteDefinition.Entity.View', { defaultValue: 'Entity View' });
