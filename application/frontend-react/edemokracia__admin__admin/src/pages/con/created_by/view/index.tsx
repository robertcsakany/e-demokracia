...
// Page name: edemokracia::Con.createdBy#View
...
import { User, Con, UserQueryCustomizer, ConStored, UserStored } from '../../../../generated/data-api';
import { conServiceImpl, userServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useConCreatedByView } from './hooks/useConCreatedByView';
import { usePageRefreshCreatedByAction } from './actions';

/**
 * Name: edemokracia::Con.createdBy#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ConCreatedByView() {
  ...
  const { queryCustomizer } = useConCreatedByView();
  ...
  const title: string = t('edemokracia.Con.createdBy.View', { defaultValue: 'Entity View' });
