...
// Page name: edemokracia::Con.votes#View
...
import { conServiceImpl, simpleVoteServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useConVotesView } from './hooks/useConVotesView';
import { usePageRefreshVotesAction } from './actions';

/**
 * Name: edemokracia::Con.votes#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function ConVotesView() {
  ...
  const { queryCustomizer } = useConVotesView();
  ...
  const title: string = t('edemokracia.Con.votes.View', { defaultValue: 'Entity View' });
