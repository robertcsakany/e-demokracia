...
import { usePageBackDebatesAction, usePageRefreshDebatesAction } from './actions';
...
export default function IssueDebatesView() {
  ...
  const title: string = t('edemokracia.Issue.debates.Entity.View', { defaultValue: 'Entity View' });
