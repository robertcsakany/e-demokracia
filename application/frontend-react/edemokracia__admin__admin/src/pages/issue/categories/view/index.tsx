...
import { usePageBackCategoriesAction, usePageRefreshCategoriesAction } from './actions';
...
export default function IssueCategoriesView() {
  ...
  const title: string = t('edemokracia.Issue.categories.Entity.View', { defaultValue: 'Entity View' });
