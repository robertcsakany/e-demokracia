...
// Page name: edemokracia::Issue.categories#View
...
import { issueServiceImpl, issueCategoryServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useIssueCategoriesView } from './hooks/useIssueCategoriesView';
import { usePageRefreshCategoriesAction } from './actions';

/**
 * Name: edemokracia::Issue.categories#View
 * Is Access: false
 * Type: View
...
export default function IssueCategoriesView() {
  ...
  const { queryCustomizer } = useIssueCategoriesView();
  ...
  const [validation, setValidation] = useState<Map<keyof IssueCategory, string>>(new Map());

  const title: string = t('edemokracia.Issue.categories.View', { defaultValue: 'Entity View' });
  ...
  useEffect(() => {
    setValidation(new Map<keyof IssueCategory, string>());
  }, [editMode]);
