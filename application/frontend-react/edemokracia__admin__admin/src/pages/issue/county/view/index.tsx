...
// Page name: edemokracia::Issue.county#View
...
import { Issue, IssueStored, County, CountyQueryCustomizer, CountyStored } from '../../../../generated/data-api';
import { issueServiceImpl, countyServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useIssueCountyView } from './hooks/useIssueCountyView';
import { usePageRefreshCountyAction } from './actions';

/**
 * Name: edemokracia::Issue.county#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function IssueCountyView() {
  ...
  const { queryCustomizer } = useIssueCountyView();
  ...
  const [validation, setValidation] = useState<Map<keyof County, string>>(new Map());

  const title: string = t('edemokracia.Issue.county.View', { defaultValue: 'Entity View' });
  ...
  useEffect(() => {
    setValidation(new Map<keyof County, string>());
  }, [editMode]);
