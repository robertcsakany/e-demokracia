...
// Page name: edemokracia::Issue.owner#View
...
import { useIssueOwnerView } from './hooks/useIssueOwnerView';
import { usePageBackOwnerAction, usePageRefreshOwnerAction } from './actions';

/**
 * Name: edemokracia::Issue.owner#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function IssueOwnerView() {
  ...
  const { queryCustomizer } = useIssueOwnerView();
  ...
  const title: string = t('edemokracia.Issue.owner.Entity.View', { defaultValue: 'Entity View' });
