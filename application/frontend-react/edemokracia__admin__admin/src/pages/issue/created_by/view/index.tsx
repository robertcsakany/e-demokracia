...
// Page name: edemokracia::Issue.createdBy#View
...
import { issueServiceImpl, userServiceImpl } from '../../../../generated/data-axios';
import { JudoIdentifiable } from '@judo/data-api-common';
import { mainContainerPadding } from '../../../../theme';
import { useIssueCreatedByView } from './hooks/useIssueCreatedByView';
import { usePageRefreshCreatedByAction } from './actions';

/**
 * Name: edemokracia::Issue.createdBy#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function IssueCreatedByView() {
  ...
  const { queryCustomizer } = useIssueCreatedByView();
  ...
  const title: string = t('edemokracia.Issue.createdBy.View', { defaultValue: 'Entity View' });
