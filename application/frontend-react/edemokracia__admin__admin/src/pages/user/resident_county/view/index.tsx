...
import { usePageRefreshResidentCountyAction, usePageBackResidentCountyAction } from './actions';
...
export default function UserResidentCountyView() {
  ...
  const pageBackResidentCountyAction = usePageBackResidentCountyAction();
  ...
  const title: string = t('edemokracia.User.residentCounty.Entity.View', { defaultValue: 'Entity View' });
