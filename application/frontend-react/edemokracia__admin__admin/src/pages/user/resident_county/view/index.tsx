...
// Page name: edemokracia::User.residentCounty#View
...
import { useUserResidentCountyView } from './hooks/useUserResidentCountyView';
import { usePageRefreshResidentCountyAction } from './actions';

/**
 * Name: edemokracia::User.residentCounty#View
 * Is Access: false
 * Type: View
 * Edit Mode Available: false
 **/
export default function UserResidentCountyView() {
  ...
  const { queryCustomizer } = useUserResidentCountyView();
  ...
  const title: string = t('edemokracia.User.residentCounty.View', { defaultValue: 'Entity View' });
