...
import { usePageBackActivityCountiesAction, usePageRefreshActivityCountiesAction } from './actions';
...
export default function UserActivityCountiesView() {
  ...
  const pageBackActivityCountiesAction = usePageBackActivityCountiesAction();
  ...
  const title: string = t('edemokracia.User.activityCounties.Entity.View', { defaultValue: 'Entity View' });
