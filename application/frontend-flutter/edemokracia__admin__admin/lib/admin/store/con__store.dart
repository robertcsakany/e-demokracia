...
class ConStore extends _ConStore with _$ConStore {
  ConStore() : super();

  ConStore.clone(ConStore storeToClone) : super.clone(storeToClone);
}

abstract class _ConStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _ConStore();

  _ConStore.clone(ConStore storeToClone) {
