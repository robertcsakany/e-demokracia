...
class CreateCommentInputStore extends _CreateCommentInputStore with _$CreateCommentInputStore {
  CreateCommentInputStore() : super();

  CreateCommentInputStore.clone(CreateCommentInputStore storeToClone) : super.clone(storeToClone);
}

abstract class _CreateCommentInputStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _CreateCommentInputStore();

  _CreateCommentInputStore.clone(CreateCommentInputStore storeToClone) {
  ...
  bool operator ==(Object other) =>
      ...
      other is _CreateCommentInputStore &&
