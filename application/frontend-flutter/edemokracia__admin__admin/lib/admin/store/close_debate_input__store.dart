...
class CloseDebateInputStore extends _CloseDebateInputStore with _$CloseDebateInputStore {
  CloseDebateInputStore() : super();

  CloseDebateInputStore.clone(CloseDebateInputStore storeToClone) : super.clone(storeToClone);
}

abstract class _CloseDebateInputStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _CloseDebateInputStore();

  _CloseDebateInputStore.clone(CloseDebateInputStore storeToClone) {
    ...
    voteType = storeToClone.voteType;
  ...
  String title;
  @observable
  EdemokraciaVoteTypeOnCloseDebate voteType;
  ...
  bool operator ==(Object other) =>
      ...
      other is _CloseDebateInputStore &&
  ...
  void initWithDefaults(CloseDebateInputStore storeToClone) {
    ...
    if (storeToClone.voteType != null) {
      setVoteType(storeToClone.voteType);
    }
