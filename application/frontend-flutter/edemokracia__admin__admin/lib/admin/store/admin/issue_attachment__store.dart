...
class AdminIssueAttachmentStore extends _AdminIssueAttachmentStore with _$AdminIssueAttachmentStore {
  AdminIssueAttachmentStore() : super();

  AdminIssueAttachmentStore.clone(AdminIssueAttachmentStore storeToClone) : super.clone(storeToClone);
}

abstract class _AdminIssueAttachmentStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _AdminIssueAttachmentStore();

  _AdminIssueAttachmentStore.clone(AdminIssueAttachmentStore storeToClone) {
  ...
  bool operator ==(Object other) =>
      ...
      other is _AdminIssueAttachmentStore &&
