...
class AdminConStore extends _AdminConStore with _$AdminConStore {
  AdminConStore() : super();

  AdminConStore.clone(AdminConStore storeToClone) : super.clone(storeToClone);
}

abstract class _AdminConStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _AdminConStore();

  _AdminConStore.clone(AdminConStore storeToClone) {
