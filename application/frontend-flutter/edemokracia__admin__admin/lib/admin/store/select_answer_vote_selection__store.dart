...
class SelectAnswerVoteSelectionStore extends _SelectAnswerVoteSelectionStore with _$SelectAnswerVoteSelectionStore {
  SelectAnswerVoteSelectionStore() : super();

  SelectAnswerVoteSelectionStore.clone(SelectAnswerVoteSelectionStore storeToClone) : super.clone(storeToClone);
}

abstract class _SelectAnswerVoteSelectionStore with Store {
  Set<String> changedFields = Set();
  bool internal__isOriginEmpty;

  _SelectAnswerVoteSelectionStore();

  _SelectAnswerVoteSelectionStore.clone(SelectAnswerVoteSelectionStore storeToClone) {
  ...
  bool operator ==(Object other) =>
      ...
      other is _SelectAnswerVoteSelectionStore &&
