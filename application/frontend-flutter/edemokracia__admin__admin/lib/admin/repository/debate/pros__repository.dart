...
//   Access: false
//
//    Relation: edemokracia::Debate.pros (edemokracia::Pro) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Pro behaviours:  REFRESH

part of admin.repository;

class DebateRepositoryForPros {
  /// GET Collection
  Future<List<ProStore>> edemokraciaDebateProsList(DebateStore owner,
    ...
    List<dynamic> proListResponse = await locator<JudoApiClient>().edemokraciaDebateListPros(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
