...
//   Access: false
//
//    Relation: edemokracia::Debate.comments (edemokracia::Comment) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Comment behaviours:  REFRESH

part of admin.repository;

class DebateRepositoryForComments {
  /// GET Collection
  Future<List<CommentStore>> edemokraciaDebateCommentsList(DebateStore owner,
    ...
    List<dynamic> commentListResponse =
        await locator<JudoApiClient>().edemokraciaDebateListComments(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
