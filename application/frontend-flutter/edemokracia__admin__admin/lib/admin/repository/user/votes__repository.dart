...
//   Access: false
//
//    Relation: edemokracia::User.votes (edemokracia::SimpleVote) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::SimpleVote behaviours:  REFRESH

part of admin.repository;

class UserRepositoryForVotes {
  /// GET Collection
  Future<List<SimpleVoteStore>> edemokraciaUserVotesList(UserStore owner,
    ...
    List<dynamic> simpleVoteListResponse =
        await locator<JudoApiClient>().edemokraciaUserListVotes(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
