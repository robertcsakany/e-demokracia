...
//   Access: false
//
//    Relation: edemokracia::User.activityDistricts (edemokracia::District) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::District behaviours:  REFRESH

part of admin.repository;

class UserRepositoryForActivityDistricts {
  /// GET Collection
  Future<List<DistrictStore>> edemokraciaUserActivityDistrictsList(UserStore owner,
    ...
    List<dynamic> districtListResponse =
        await locator<JudoApiClient>().edemokraciaUserListActivityDistricts(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
