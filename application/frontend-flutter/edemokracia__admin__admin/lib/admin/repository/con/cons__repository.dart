...
//   Access: false
//
//    Relation: edemokracia::Con.cons (edemokracia::Con) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Con behaviours:  REFRESH

part of admin.repository;

class ConRepositoryForCons {
  /// GET Collection
  Future<List<ConStore>> edemokraciaConConsList(ConStore owner,
    ...
    List<dynamic> conListResponse = await locator<JudoApiClient>().edemokraciaConListCons(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
