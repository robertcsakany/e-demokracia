...
//   Access: false
//
//    Relation: edemokracia::Con.votes (edemokracia::SimpleVote) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::SimpleVote behaviours:  REFRESH

part of admin.repository;

class ConRepositoryForVotes {
  /// GET Collection
  Future<List<SimpleVoteStore>> edemokraciaConVotesList(ConStore owner,
    ...
    List<dynamic> simpleVoteListResponse =
        await locator<JudoApiClient>().edemokraciaConListVotes(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
