...
//   Access: false
//
//    Relation: edemokracia::Pro.pros (edemokracia::Pro) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Pro behaviours:  REFRESH

part of admin.repository;

class ProRepositoryForPros {
  /// GET Collection
  Future<List<ProStore>> edemokraciaProProsList(ProStore owner,
    ...
    List<dynamic> proListResponse = await locator<JudoApiClient>().edemokraciaProListPros(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
