...
//   Access: false
//
//    Relation: edemokracia::Pro.votes (edemokracia::SimpleVote) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::SimpleVote behaviours:  REFRESH

part of admin.repository;

class ProRepositoryForVotes {
  /// GET Collection
  Future<List<SimpleVoteStore>> edemokraciaProVotesList(ProStore owner,
    ...
    List<dynamic> simpleVoteListResponse =
        await locator<JudoApiClient>().edemokraciaProListVotes(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
