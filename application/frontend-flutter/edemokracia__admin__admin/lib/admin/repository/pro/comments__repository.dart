...
//   Access: false
//
//    Relation: edemokracia::Pro.comments (edemokracia::Comment) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Comment behaviours:  REFRESH

part of admin.repository;

class ProRepositoryForComments {
  /// GET Collection
  Future<List<CommentStore>> edemokraciaProCommentsList(ProStore owner,
    ...
    List<dynamic> commentListResponse =
        await locator<JudoApiClient>().edemokraciaProListComments(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
