...
//   Access: false
//
//    Relation: edemokracia::Pro.cons (edemokracia::Con) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Con behaviours:  REFRESH

part of admin.repository;

class ProRepositoryForCons {
  /// GET Collection
  Future<List<ConStore>> edemokraciaProConsList(ProStore owner,
    ...
    List<dynamic> conListResponse = await locator<JudoApiClient>().edemokraciaProListCons(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
