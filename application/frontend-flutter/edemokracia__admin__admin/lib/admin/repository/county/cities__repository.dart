...
//
//   Relation: cities
//   Relation owner: edemokracia::County
//   Relation target: edemokracia::City
//   Access: false
//
//    Relation: edemokracia::County.cities (edemokracia::City) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::City behaviours:  REFRESH

part of admin.repository;

class CountyRepositoryForCities {
  /// GET Collection
  Future<List<CityStore>> edemokraciaCountyCitiesList(CountyStore owner,
    ...
    List<dynamic> cityListResponse =
        await locator<JudoApiClient>().edemokraciaCountyListCities(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
