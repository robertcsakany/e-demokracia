...
//   Access: false
//
//    Relation: edemokracia::IssueCategory.owner (edemokracia::User) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::User behaviours:  REFRESH

part of admin.repository;

class IssueCategoryRepositoryForOwner {
  /// GET SINGLE
  Future<UserStore> edemokraciaIssueCategoryOwnerGet(IssueCategoryStore owner, {String mask}) async {
    var queryCustomizer = EdemokraciaExtensionQueryCustomizerUser();
    if (mask != null) {
      queryCustomizer.mask = mask;
    }

    final userResponse = await locator<JudoApiClient>().edemokraciaIssueCategoryListOwner(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
