...
//   Access: false
//
//    Relation: edemokracia::admin::Issue.comments (edemokracia::admin::Comment) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::admin::Comment behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminIssueRepositoryForComments {
  /// GET Collection
  Future<List<AdminCommentStore>> edemokraciaAdminIssueCommentsList(AdminIssueStore owner,
    ...
    List<dynamic> commentListResponse =
        await locator<JudoApiClient>().edemokraciaAdminIssueListComments(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
