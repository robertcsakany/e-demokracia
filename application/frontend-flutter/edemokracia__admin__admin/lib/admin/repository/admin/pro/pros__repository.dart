...
//   Access: false
//
//    Relation: edemokracia::admin::Pro.pros (edemokracia::admin::Pro) behaviours:  LIST  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE
//    TransferObject: edemokracia::admin::Pro behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminProRepositoryForPros {
  /// GET Collection
  Future<List<AdminProStore>> edemokraciaAdminProProsList(AdminProStore owner,
    ...
    List<dynamic> proListResponse =
        await locator<JudoApiClient>().edemokraciaAdminProListPros(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  /// DELETE
  Future<void> edemokraciaAdminProProsDelete(AdminProStore owner, AdminProStore target) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminProDelete(target);
  }

  /// UPDATE
  Future<AdminProStore> edemokraciaAdminProProsUpdate(AdminProStore owner, AdminProStore target) async {
