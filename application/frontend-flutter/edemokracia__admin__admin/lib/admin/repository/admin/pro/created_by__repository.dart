...
//   Access: false
//
//    Relation: edemokracia::admin::Pro.createdBy (edemokracia::admin::User) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::admin::User behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminProRepositoryForCreatedBy {
  /// GET SINGLE
  Future<AdminUserStore> edemokraciaAdminProCreatedByGet(AdminProStore owner, {String mask}) async {
    var queryCustomizer = EdemokraciaExtensionAdminQueryCustomizerUser();
    if (mask != null) {
      queryCustomizer.mask = mask;
    }

    final userResponse = await locator<JudoApiClient>().edemokraciaAdminProListCreatedBy(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  Future<List<AdminCityStore>> edemokraciaAdminProCreatedByRangeOfActivityCitiesToCreate(AdminUserStore target,
  ...
  Future<List<AdminCityStore>> edemokraciaAdminProCreatedByRangeOfActivityCitiesToUpdate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCityStore lastItem, bool reverse}) async {
  ...
  Future<void> edemokraciaAdminProCreatedBySetActivityCities(AdminProStore owner, AdminUserStore target, List<AdminCityStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetActivityCities(target, selected);
  }

  /// ADD activityCities
  Future<void> edemokraciaAdminProCreatedByAddActivityCities(AdminProStore owner, AdminUserStore target, List<AdminCityStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserAddActivityCities(target, selected);
  }

  /// REMOVE activityCities
  Future<void> edemokraciaAdminProCreatedByRemoveActivityCities(AdminProStore owner, AdminUserStore target, List<AdminCityStore> selected) async {
  ...
  Future<List<AdminCountyStore>> edemokraciaAdminProCreatedByRangeOfActivityCountiesToCreate(AdminUserStore target,
  ...
  Future<List<AdminCountyStore>> edemokraciaAdminProCreatedByRangeOfActivityCountiesToUpdate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCountyStore lastItem, bool reverse}) async {
  ...
  Future<void> edemokraciaAdminProCreatedBySetActivityCounties(AdminProStore owner, AdminUserStore target, List<AdminCountyStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetActivityCounties(target, selected);
  }

  /// ADD activityCounties
  Future<void> edemokraciaAdminProCreatedByAddActivityCounties(AdminProStore owner, AdminUserStore target, List<AdminCountyStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserAddActivityCounties(target, selected);
  }

  /// REMOVE activityCounties
  Future<void> edemokraciaAdminProCreatedByRemoveActivityCounties(AdminProStore owner, AdminUserStore target, List<AdminCountyStore> selected) async {
  ...
  Future<List<AdminDistrictStore>> edemokraciaAdminProCreatedByRangeOfActivityDistrictsToCreate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
  ...
  Future<List<AdminDistrictStore>> edemokraciaAdminProCreatedByRangeOfActivityDistrictsToUpdate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
      List<FilterStore> filterStoreList,
      int queryLimit,
  ...
  Future<void> edemokraciaAdminProCreatedBySetActivityDistricts(AdminProStore owner, AdminUserStore target, List<AdminDistrictStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetActivityDistricts(target, selected);
  }

  /// ADD activityDistricts
  Future<void> edemokraciaAdminProCreatedByAddActivityDistricts(AdminProStore owner, AdminUserStore target, List<AdminDistrictStore> selected) async {
  ...
  Future<void> edemokraciaAdminProCreatedByRemoveActivityDistricts(AdminProStore owner, AdminUserStore target, List<AdminDistrictStore> selected) async {
  ...
  Future<List<AdminCityStore>> edemokraciaAdminProCreatedByRangeOfResidentCityToCreate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCityStore lastItem, bool reverse}) async {
  ...
  Future<List<AdminCityStore>> edemokraciaAdminProCreatedByRangeOfResidentCityToUpdate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCityStore lastItem, bool reverse}) async {
  ...
  Future<void> edemokraciaAdminProCreatedBySetResidentCity(AdminProStore owner, AdminUserStore target, AdminCityStore selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetResidentCity(target, selected);
  }

  /// UNSET residentCity
  Future<void> edemokraciaAdminProCreatedByUnsetResidentCity(AdminProStore owner, AdminUserStore target) async {
  ...
  Future<List<AdminCountyStore>> edemokraciaAdminProCreatedByRangeOfResidentCountyToCreate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCountyStore lastItem, bool reverse}) async {
  ...
  Future<List<AdminCountyStore>> edemokraciaAdminProCreatedByRangeOfResidentCountyToUpdate(AdminUserStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminCountyStore lastItem, bool reverse}) async {
  ...
  Future<void> edemokraciaAdminProCreatedBySetResidentCounty(AdminProStore owner, AdminUserStore target, AdminCountyStore selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetResidentCounty(target, selected);
  }

  /// UNSET residentCounty
  Future<void> edemokraciaAdminProCreatedByUnsetResidentCounty(AdminProStore owner, AdminUserStore target) async {
  ...
  Future<List<AdminDistrictStore>> edemokraciaAdminProCreatedByRangeOfResidentDistrictToCreate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
      List<FilterStore> filterStoreList,
      int queryLimit,
  ...
  Future<List<AdminDistrictStore>> edemokraciaAdminProCreatedByRangeOfResidentDistrictToUpdate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
      List<FilterStore> filterStoreList,
      int queryLimit,
  ...
  Future<void> edemokraciaAdminProCreatedBySetResidentDistrict(AdminProStore owner, AdminUserStore target, AdminDistrictStore selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetResidentDistrict(target, selected);
  }

  /// UNSET residentDistrict
  Future<void> edemokraciaAdminProCreatedByUnsetResidentDistrict(AdminProStore owner, AdminUserStore target) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserUnsetResidentDistrict(target);
  }

  /// GET CREATE RANGE FOR votes
  Future<List<AdminSimpleVoteStore>> edemokraciaAdminProCreatedByRangeOfVotesToCreate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
      List<FilterStore> filterStoreList,
      int queryLimit,
  ...
  Future<List<AdminSimpleVoteStore>> edemokraciaAdminProCreatedByRangeOfVotesToUpdate(AdminUserStore target,
      {String sortColumn,
      bool sortAscending,
      List<FilterStore> filterStoreList,
      int queryLimit,
  ...
  Future<void> edemokraciaAdminProCreatedBySetVotes(AdminProStore owner, AdminUserStore target, List<AdminSimpleVoteStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserSetVotes(target, selected);
  }

  /// ADD votes
  Future<void> edemokraciaAdminProCreatedByAddVotes(AdminProStore owner, AdminUserStore target, List<AdminSimpleVoteStore> selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminUserAddVotes(target, selected);
  }

  /// REMOVE votes
  Future<void> edemokraciaAdminProCreatedByRemoveVotes(AdminProStore owner, AdminUserStore target, List<AdminSimpleVoteStore> selected) async {
