...
//   Access: false
//
//    Relation: edemokracia::admin::Pro.comments (edemokracia::admin::Comment) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::admin::Comment behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminProRepositoryForComments {
  /// GET Collection
  Future<List<AdminCommentStore>> edemokraciaAdminProCommentsList(AdminProStore owner,
    ...
    List<dynamic> commentListResponse =
        await locator<JudoApiClient>().edemokraciaAdminProListComments(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
