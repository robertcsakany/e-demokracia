...
//   Access: false
//
//    Relation: edemokracia::admin::Pro.cons (edemokracia::admin::Con) behaviours:  LIST  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE
//    TransferObject: edemokracia::admin::Con behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminProRepositoryForCons {
  /// GET Collection
  Future<List<AdminConStore>> edemokraciaAdminProConsList(AdminProStore owner,
    ...
    List<dynamic> conListResponse =
        await locator<JudoApiClient>().edemokraciaAdminProListCons(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  /// DELETE
  Future<void> edemokraciaAdminProConsDelete(AdminProStore owner, AdminConStore target) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminConDelete(target);
  }

  /// UPDATE
  Future<AdminConStore> edemokraciaAdminProConsUpdate(AdminProStore owner, AdminConStore target) async {
