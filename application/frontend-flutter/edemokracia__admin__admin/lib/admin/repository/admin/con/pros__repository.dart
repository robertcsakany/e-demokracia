...
//   Access: false
//
//    Relation: edemokracia::admin::Con.pros (edemokracia::admin::Pro) behaviours:  LIST  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE
//    TransferObject: edemokracia::admin::Pro behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminConRepositoryForPros {
  /// GET Collection
  Future<List<AdminProStore>> edemokraciaAdminConProsList(AdminConStore owner,
    ...
    List<dynamic> proListResponse =
        await locator<JudoApiClient>().edemokraciaAdminConListPros(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  /// DELETE
  Future<void> edemokraciaAdminConProsDelete(AdminConStore owner, AdminProStore target) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminProDelete(target);
  }

  /// UPDATE
  Future<AdminProStore> edemokraciaAdminConProsUpdate(AdminConStore owner, AdminProStore target) async {
