...
//   Access: false
//
//    Relation: edemokracia::admin::User.votes (edemokracia::admin::SimpleVote) behaviours:  LIST  SET  ADD  REMOVE  RANGE  REFRESH
//    TransferObject: edemokracia::admin::SimpleVote behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE  TEMPLATE

part of admin.repository;

class AdminUserRepositoryForVotes {
  /// GET Collection
  Future<List<AdminSimpleVoteStore>> edemokraciaAdminUserVotesList(AdminUserStore owner,
      {String sortColumn,
      bool sortAscending,
    ...
    List<dynamic> simpleVoteListResponse =
        await locator<JudoApiClient>().edemokraciaAdminUserListVotes(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  Future<List<AdminUserStore>> edemokraciaAdminUserVotesRangeOfUserToCreate(AdminSimpleVoteStore target,
  ...
  Future<List<AdminUserStore>> edemokraciaAdminUserVotesRangeOfUserToUpdate(AdminSimpleVoteStore target,
      {String sortColumn, bool sortAscending, List<FilterStore> filterStoreList, int queryLimit, String mask, AdminUserStore lastItem, bool reverse}) async {
  ...
  /// SET user Single
  Future<void> edemokraciaAdminUserVotesSetUser(AdminUserStore owner, AdminSimpleVoteStore target, AdminUserStore selected) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminSimpleVoteSetUser(target, selected);
  }

  /// UNSET user
  Future<void> edemokraciaAdminUserVotesUnsetUser(AdminUserStore owner, AdminSimpleVoteStore target) async {
