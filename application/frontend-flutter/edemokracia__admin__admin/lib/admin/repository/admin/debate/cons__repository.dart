...
//   Access: false
//
//    Relation: edemokracia::admin::Debate.cons (edemokracia::admin::Con) behaviours:  LIST  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE
//    TransferObject: edemokracia::admin::Con behaviours:  REFRESH  UPDATE  VALIDATE_UPDATE  DELETE

part of admin.repository;

class AdminDebateRepositoryForCons {
  /// GET Collection
  Future<List<AdminConStore>> edemokraciaAdminDebateConsList(AdminDebateStore owner,
    ...
    List<dynamic> conListResponse =
        await locator<JudoApiClient>().edemokraciaAdminDebateListCons(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
  ...
  /// DELETE
  Future<void> edemokraciaAdminDebateConsDelete(AdminDebateStore owner, AdminConStore target) async {
    return await locator<AdminAdminRepository>().edemokraciaAdminConDelete(target);
  }

  /// UPDATE
  Future<AdminConStore> edemokraciaAdminDebateConsUpdate(AdminDebateStore owner, AdminConStore target) async {
