...
//   Access: false
//
//    Relation: edemokracia::Issue.comments (edemokracia::Comment) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::Comment behaviours:  REFRESH

part of admin.repository;

class IssueRepositoryForComments {
  /// GET Collection
  Future<List<CommentStore>> edemokraciaIssueCommentsList(IssueStore owner,
    ...
    List<dynamic> commentListResponse =
        await locator<JudoApiClient>().edemokraciaIssueListComments(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
