...
//   Access: false
//
//    Relation: edemokracia::Issue.createdBy (edemokracia::User) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::User behaviours:  REFRESH

part of admin.repository;

class IssueRepositoryForCreatedBy {
  /// GET SINGLE
  Future<UserStore> edemokraciaIssueCreatedByGet(IssueStore owner, {String mask}) async {
    var queryCustomizer = EdemokraciaExtensionQueryCustomizerUser();
    if (mask != null) {
      queryCustomizer.mask = mask;
    }

    final userResponse = await locator<JudoApiClient>().edemokraciaIssueListCreatedBy(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
