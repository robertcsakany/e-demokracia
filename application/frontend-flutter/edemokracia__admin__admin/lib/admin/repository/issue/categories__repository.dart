...
//   Access: false
//
//    Relation: edemokracia::Issue.categories (edemokracia::IssueCategory) behaviours:  LIST  REFRESH
//    TransferObject: edemokracia::IssueCategory behaviours:  REFRESH

part of admin.repository;

class IssueRepositoryForCategories {
  /// GET Collection
  Future<List<IssueCategoryStore>> edemokraciaIssueCategoriesList(IssueStore owner,
      {String sortColumn,
      bool sortAscending,
    ...
    List<dynamic> issueCategoryListResponse =
        await locator<JudoApiClient>().edemokraciaIssueListCategories(owner.internal__signedIdentifier, input: queryCustomizer.toJson());
