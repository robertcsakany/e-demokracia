...
class IssueCategorySubcategoriesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final IssueCategoryStore targetStore;
  final IssueCategoryStore ownerStore;
  final IssueCategorySubcategoriesViewPageStore pageStore;
  final IssueCategorySubcategoriesViewConfig pageConfig;

  IssueCategorySubcategoriesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
