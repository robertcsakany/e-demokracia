...
class IssueCategoryOwnerViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final IssueCategoryStore ownerStore;
  final IssueCategoryOwnerViewPageStore pageStore;
  final IssueCategoryOwnerViewConfig pageConfig;

  IssueCategoryOwnerViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
