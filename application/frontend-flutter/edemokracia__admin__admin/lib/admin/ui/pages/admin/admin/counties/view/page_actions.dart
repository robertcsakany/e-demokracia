...
class AdminAdminCountiesViewPageActions extends PageActions {
  ...
  AdminAdminCountiesViewPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        try {
          await pageStore.deleteCounty(targetStore);
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminAdminCountiesUpdatePage, arguments: AdminAdminCountiesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
