...
class EdemokraciaAdminUserActivityCitiesEditDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesEditDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
