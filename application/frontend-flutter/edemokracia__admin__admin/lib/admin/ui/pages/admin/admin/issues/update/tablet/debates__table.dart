...
class EdemokraciaAdminAdminIssuesEditDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
