...
class EdemokraciaAdminAdminDashboardhomeDashboardDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
