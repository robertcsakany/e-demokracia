...
Widget getAdminVoteDefinitionDebateViewDesktopPage(BuildContext context, AdminDebateStore targetStore, AdminVoteDefinitionStore ownerStore,
    AdminVoteDefinitionDebateViewPageStore pageStore, AdminVoteDefinitionDebateViewConfig pageConfig) {
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(
                          ...
                          row: 15.0,
                          order: 9,
                          tabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::VoteDefinition::debate_tabBar').tabIndex,
                          setTabIndex:
                              tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::VoteDefinition::debate_tabBar').setTabIndex,
                          tabContent: [
                            JudoRow(
                              mainAxisAlignment: MainAxisAlignment.start,
                              col: 12.0,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewProsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 11,
                                        ...
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewConsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                disabled: pageStore.pageState.disabledByLoading,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewCommentsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 14,
                                                disabled: pageStore.pageState.disabledByLoading,
