...
class AdminUserResidentCountyViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCountyStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserResidentCountyViewPageStore pageStore;
  final AdminUserResidentCountyViewConfig pageConfig;

  AdminUserResidentCountyViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminUserResidentCountyUpdatePage, arguments: AdminUserResidentCountyUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
