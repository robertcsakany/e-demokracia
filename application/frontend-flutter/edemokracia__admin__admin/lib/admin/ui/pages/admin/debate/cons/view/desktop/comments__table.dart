...
class EdemokraciaAdminDebateConsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
