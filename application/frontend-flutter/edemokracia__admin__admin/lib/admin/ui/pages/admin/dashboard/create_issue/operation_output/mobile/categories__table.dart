...
class EdemokraciaAdminDashboardCreateIssueOutputCategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
