...
class EdemokraciaAdminDashboardDebatesViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDashboardDebatesViewPageStore pageStore;
  final AdminDashboardDebatesViewConfig pageConfig;
