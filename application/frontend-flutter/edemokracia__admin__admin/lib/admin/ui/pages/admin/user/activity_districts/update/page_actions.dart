...
class AdminUserActivityDistrictsUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminDistrictStore targetStore;
  final AdminUserActivityDistrictsUpdatePageStore pageStore;
  final AdminUserActivityDistrictsUpdateConfig pageConfig;

  AdminUserActivityDistrictsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
