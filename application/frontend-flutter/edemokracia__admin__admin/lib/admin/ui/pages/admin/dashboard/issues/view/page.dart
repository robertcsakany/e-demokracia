...
class AdminDashboardIssuesViewPageStore extends _AdminDashboardIssuesViewPageStore with _$AdminDashboardIssuesViewPageStore {}

abstract class _AdminDashboardIssuesViewPageStore with Store {
  ...
  _AdminDashboardIssuesViewPageStore() {
  ...
  void initSortAggregatedLists(BuildContext context, AdminDashboardIssuesViewConfig pageConfig) {
    if (targetStore.attachments != null) {
      var dataInfo = EdemokraciaAdminDashboardIssuesViewAttachmentsMobileTable(context, this, pageConfig, disabled: false);
    ...
    if (targetStore.categories != null) {
      var dataInfo = EdemokraciaAdminDashboardIssuesViewCategoriesMobileTable(context, this, pageConfig, disabled: false);
    ...
    if (targetStore.comments != null) {
      var dataInfo = EdemokraciaAdminDashboardIssuesViewCommentsMobileTable(context, this, pageConfig, disabled: false);
    ...
    if (targetStore.debates != null) {
      var dataInfo = EdemokraciaAdminDashboardIssuesViewDebatesMobileTable(context, this, pageConfig, disabled: false);
  ...
  void attachmentsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminIssueStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardIssuesViewAttachments',
  ...
  void categoriesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminIssueStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardIssuesViewCategories',
  ...
  void commentsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminIssueStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardIssuesViewComments',
  ...
  void debatesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminIssueStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardIssuesViewDebates',
...
class AdminDashboardIssuesViewPage extends StatefulWidget {
  static const String title = 'View / Edit Issue';

  final AdminIssueStore targetStore;
  final AdminDashboardStore ownerStore;

  const AdminDashboardIssuesViewPage({Key key, @required this.targetStore, @required this.ownerStore}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _AdminDashboardIssuesViewPageState(targetStore: targetStore, ownerStore: ownerStore);
}

class _AdminDashboardIssuesViewPageState extends State<AdminDashboardIssuesViewPage> {
  AdminIssueStore targetStore;
  final AdminDashboardStore ownerStore;

  final tableService = locator<TableService>();
  final AdminDashboardIssuesViewPageStore pageStore = AdminDashboardIssuesViewPageStore();
  final AdminDashboardIssuesViewConfig pageConfig = AdminDashboardIssuesViewConfig();
  AdminDashboardIssuesViewPageActions pageActions;

  _AdminDashboardIssuesViewPageState({@required this.targetStore, @required this.ownerStore}) {
    ...
    pageActions = AdminDashboardIssuesViewPageActions(navigation, targetStore, ownerStore, pageStore, pageConfig);
    pageStore.refreshIssue(targetStore).then((_) {
      navigation.setCurrentTitle(pageConfig.titleGenerator != null
          ? pageConfig.titleGenerator(context, pageStore, targetStore)
          : AppLocalizations.of(context).lookUpValue(context, AdminDashboardIssuesViewPage.title));
  ...
  Widget build(BuildContext context) {
    LayoutBuilder layout = LayoutBuilder(builder: (context, constraints) {
      if (MediaQuery.of(context).size.width >= 0 && MediaQuery.of(context).size.width <= 599) {
        return getAdminDashboardIssuesViewMobilePage(context, targetStore, ownerStore, pageStore, pageConfig);
      }
      if (MediaQuery.of(context).size.width >= 600 && MediaQuery.of(context).size.width <= 839) {
        return getAdminDashboardIssuesViewTabletPage(context, targetStore, ownerStore, pageStore, pageConfig);
      }
      if (MediaQuery.of(context).size.width >= 840 && MediaQuery.of(context).size.width <= 32767) {
        return getAdminDashboardIssuesViewDesktopPage(context, targetStore, ownerStore, pageStore, pageConfig);
      }
      return getAdminDashboardIssuesViewDesktopPage(context, targetStore, ownerStore, pageStore, pageConfig);
    });
