...
Widget getAdminIssueOwnerViewTabletPage(BuildContext context, AdminUserStore targetStore, AdminIssueStore ownerStore, AdminIssueOwnerViewPageStore pageStore,
    AdminIssueOwnerViewConfig pageConfig) {
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(
                                          ...
                                          order: 12,
                                          tabIndex:
                                              tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Issue::owner_activity').tabIndex,
                                          setTabIndex: tabService
                                              .getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Issue::owner_activity')
                                              .setTabIndex,
                                          tabContent: [
                                            JudoRow(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueOwnerViewActivityCountiesTabletTable(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueOwnerViewActivityCitiesTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueOwnerViewActivityDistrictsTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
