...
class EdemokraciaAdminUserActivityCitiesViewDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesViewDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
