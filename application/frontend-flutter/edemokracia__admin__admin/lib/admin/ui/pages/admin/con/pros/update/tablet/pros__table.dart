...
class EdemokraciaAdminConProsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
