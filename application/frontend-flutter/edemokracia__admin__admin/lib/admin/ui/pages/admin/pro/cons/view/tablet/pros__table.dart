...
class EdemokraciaAdminProConsViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
