...
class EdemokraciaAdminProCreatedByViewActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
