...
class EdemokraciaAdminAdminCategoriesTableCategoriesListTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesTableCategoriesListTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
