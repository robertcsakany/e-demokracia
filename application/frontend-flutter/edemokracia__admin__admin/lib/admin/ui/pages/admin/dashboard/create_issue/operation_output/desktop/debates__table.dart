...
class EdemokraciaAdminDashboardCreateIssueOutputDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
