...
class EdemokraciaAdminVoteDefinitionDebateTableDebateTableDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateTableDebateTableDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
