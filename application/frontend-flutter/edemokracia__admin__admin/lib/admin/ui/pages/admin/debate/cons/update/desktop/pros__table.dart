...
class EdemokraciaAdminDebateConsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
