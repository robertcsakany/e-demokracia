...
class AdminUserResidentCityViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCityStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserResidentCityViewPageStore pageStore;
  final AdminUserResidentCityViewConfig pageConfig;

  AdminUserResidentCityViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminUserResidentCityUpdatePage, arguments: AdminUserResidentCityUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
