...
class AdminAdminCategoriesCreateOwnerDialogTable implements JudoTableDataInfo {
  const AdminAdminCategoriesCreateOwnerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
