...
class EdemokraciaAdminAdminIssuesEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
