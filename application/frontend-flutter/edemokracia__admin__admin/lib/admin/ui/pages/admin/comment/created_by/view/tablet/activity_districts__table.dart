...
class EdemokraciaAdminCommentCreatedByViewActivityDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
