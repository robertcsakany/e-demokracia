...
class EdemokraciaAdminDebateConsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
