...
class EdemokraciaAdminAdminCategoriesCreateSubcategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesCreateSubcategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
