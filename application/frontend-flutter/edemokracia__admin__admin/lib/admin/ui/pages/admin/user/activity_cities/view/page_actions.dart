...
class AdminUserActivityCitiesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCityStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserActivityCitiesViewPageStore pageStore;
  final AdminUserActivityCitiesViewConfig pageConfig;

  AdminUserActivityCitiesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminUserActivityCitiesUpdatePage, arguments: AdminUserActivityCitiesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
