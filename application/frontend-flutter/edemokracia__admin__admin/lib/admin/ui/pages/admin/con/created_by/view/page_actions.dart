...
class AdminConCreatedByViewPageActions extends PageActions {
  ...
  AdminConCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
