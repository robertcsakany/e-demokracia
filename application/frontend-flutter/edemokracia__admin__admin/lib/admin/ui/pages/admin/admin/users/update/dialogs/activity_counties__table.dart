...
class AdminAdminUsersUpdateActivityCountiesDialogTable implements JudoTableDataInfo {
  const AdminAdminUsersUpdateActivityCountiesDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
