...
Widget getAdminUserResidentCityViewDesktopPage(BuildContext context, AdminCityStore targetStore, AdminUserStore ownerStore,
    AdminUserResidentCityViewPageStore pageStore, AdminUserResidentCityViewConfig pageConfig) {
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminUserResidentCityViewDistrictsDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
