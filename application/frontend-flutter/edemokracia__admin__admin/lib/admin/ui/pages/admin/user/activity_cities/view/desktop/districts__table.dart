...
class EdemokraciaAdminUserActivityCitiesViewDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesViewDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
