...
class EdemokraciaAdminDashboardDebatesViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
