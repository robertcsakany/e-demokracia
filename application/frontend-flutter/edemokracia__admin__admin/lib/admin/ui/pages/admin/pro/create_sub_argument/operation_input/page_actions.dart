...
class AdminProCreateSubArgumentOperationInputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CreateArgumentInputStore targetStore;
  final AdminProCreateSubArgumentOperationInputPageStore pageStore;
  final AdminProCreateSubArgumentOperationInputConfig pageConfig;

  AdminProCreateSubArgumentOperationInputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
