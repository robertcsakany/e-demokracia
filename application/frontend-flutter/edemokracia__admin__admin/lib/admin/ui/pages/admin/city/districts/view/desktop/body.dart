...
Widget getAdminCityDistrictsViewDesktopPage(BuildContext context, AdminDistrictStore targetStore, AdminCityStore ownerStore,
    AdminCityDistrictsViewPageStore pageStore, AdminCityDistrictsViewConfig pageConfig) {
