...
Widget getAdminAdminDashboardhomeDashboardDesktopPage(BuildContext context, AdminDashboardStore targetStore,
    AdminAdminDashboardhomeDashboardPageStore pageStore, AdminAdminDashboardhomeDashboardConfig pageConfig) {
                  ...
                  children: [
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(
                          builder: (_) => JudoTab(col: 12.0, row: 21.0, order: 1, tabContent: [
                            JudoRow(
                              ...
                              children: [
                                JudoColumn(
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      var dataInfo =
                                          EdemokraciaAdminAdminDashboardhomeDashboardIssuesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                      return JudoTable(
                                        key: UniqueKey(),
                                        order: 2,
                              ...
                              children: [
                                JudoColumn(
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      var dataInfo =
                                          EdemokraciaAdminAdminDashboardhomeDashboardDebatesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                      return JudoTable(
                                        key: UniqueKey(),
                                        order: 3,
                                        disabled: pageStore.pageState.disabledByLoading,
