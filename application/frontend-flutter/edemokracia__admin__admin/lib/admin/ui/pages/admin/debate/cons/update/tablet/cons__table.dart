...
class EdemokraciaAdminDebateConsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
