...
class AdminDashboardCreateUserOperationOutputPageStore extends _AdminDashboardCreateUserOperationOutputPageStore
    with _$AdminDashboardCreateUserOperationOutputPageStore {}

abstract class _AdminDashboardCreateUserOperationOutputPageStore with Store {
  ...
  _AdminDashboardCreateUserOperationOutputPageStore() {
  ...
  void initSortAggregatedLists(BuildContext context, AdminDashboardCreateUserOperationOutputConfig pageConfig) {
    if (targetStore.activityCities != null) {
      var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCitiesMobileTable(context, this, pageConfig, disabled: false);
    ...
    if (targetStore.activityDistricts != null) {
      var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityDistrictsMobileTable(context, this, pageConfig, disabled: false);
    ...
    if (targetStore.activityCounties != null) {
      var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCountiesMobileTable(context, this, pageConfig, disabled: false);
  ...
  void activityCitiesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminUserStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardCreateUserOutputActivityCities',
  ...
  void activityCountiesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminUserStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardCreateUserOutputActivityCounties',
  ...
  void activityDistrictsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator sortCompare, AdminUserStore store) {
    ...
    tableService.storeSorting(
      'EdemokraciaAdminDashboardCreateUserOutputActivityDistricts',
...
class AdminDashboardCreateUserOperationOutputPage extends StatefulWidget {
  static const String title = 'View / Edit User';

  final AdminUserStore targetStore;

  const AdminDashboardCreateUserOperationOutputPage({Key key, @required this.targetStore}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _AdminDashboardCreateUserOperationOutputPageState(targetStore: targetStore);
}

class _AdminDashboardCreateUserOperationOutputPageState extends State<AdminDashboardCreateUserOperationOutputPage> {
  AdminUserStore targetStore;

  final tableService = locator<TableService>();
  final AdminDashboardCreateUserOperationOutputPageStore pageStore = AdminDashboardCreateUserOperationOutputPageStore();
  final AdminDashboardCreateUserOperationOutputConfig pageConfig = AdminDashboardCreateUserOperationOutputConfig();
  AdminDashboardCreateUserOperationOutputPageActions pageActions;

  _AdminDashboardCreateUserOperationOutputPageState({@required this.targetStore}) {
    ...
    pageActions = AdminDashboardCreateUserOperationOutputPageActions(navigation, targetStore, pageStore, pageConfig);
    pageStore.refreshUser(targetStore).then((_) {
      navigation.setCurrentTitle(pageConfig.titleGenerator != null
          ? pageConfig.titleGenerator(context, pageStore, targetStore)
          : AppLocalizations.of(context).lookUpValue(context, AdminDashboardCreateUserOperationOutputPage.title));
  ...
  Widget build(BuildContext context) {
    LayoutBuilder layout = LayoutBuilder(builder: (context, constraints) {
      if (MediaQuery.of(context).size.width >= 0 && MediaQuery.of(context).size.width <= 599) {
        return getAdminDashboardCreateUserOperationOutputMobilePage(context, targetStore, pageStore, pageConfig);
      }
      if (MediaQuery.of(context).size.width >= 600 && MediaQuery.of(context).size.width <= 839) {
        return getAdminDashboardCreateUserOperationOutputTabletPage(context, targetStore, pageStore, pageConfig);
      }
      if (MediaQuery.of(context).size.width >= 840 && MediaQuery.of(context).size.width <= 32767) {
        return getAdminDashboardCreateUserOperationOutputDesktopPage(context, targetStore, pageStore, pageConfig);
      }
      return getAdminDashboardCreateUserOperationOutputDesktopPage(context, targetStore, pageStore, pageConfig);
    });
