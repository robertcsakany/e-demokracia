...
class EdemokraciaAdminDashboardIssuesViewAttachmentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewAttachmentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
