...
Widget getAdminDashboardIssuesViewDesktopPage(BuildContext context, AdminIssueStore targetStore, AdminDashboardStore ownerStore,
    AdminDashboardIssuesViewPageStore pageStore, AdminDashboardIssuesViewConfig pageConfig) {
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(
                          ...
                          row: 14.0,
                          order: 7,
                          tabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Dashboard::issues_other').tabIndex,
                          setTabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Dashboard::issues_other').setTabIndex,
                          tabContent: [
                            JudoRow(
                              mainAxisAlignment: MainAxisAlignment.start,
                              col: 12.0,
                              ...
                              children: [
                                JudoColumn(
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      var dataInfo =
                                          EdemokraciaAdminDashboardIssuesViewAttachmentsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                      return JudoTable(
                                        key: UniqueKey(),
                                        order: 8,
                              ...
                              children: [
                                JudoColumn(
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      var dataInfo = EdemokraciaAdminDashboardIssuesViewCategoriesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                      return JudoTable(
                                        key: UniqueKey(),
                                        order: 9,
                                        disabled: pageStore.pageState.disabledByLoading,
                              ...
                              children: [
                                JudoColumn(
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      var dataInfo = EdemokraciaAdminDashboardIssuesViewDebatesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                      return JudoTable(
                                        key: UniqueKey(),
                                        order: 10,
                                        disabled: pageStore.pageState.disabledByLoading,
                                          ...
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo =
                                                      EdemokraciaAdminDashboardIssuesViewCommentsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                                  return JudoTable(
                                                    key: UniqueKey(),
                                                    order: 12,
                                                    disabled: pageStore.pageState.disabledByLoading,
                                                        ...
                                                        ? (element) async {
                                                            if (element != null) {
                                                              await navigation.open(Routes.adminIssueCommentsViewPage,
                                                                  arguments:
                                                                      AdminIssueCommentsViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                              try {
                                                                await pageStore.refreshIssue(targetStore);
                                                              } catch (error) {
                                                                messageHandler.handleApiException(context, error, 'View');
