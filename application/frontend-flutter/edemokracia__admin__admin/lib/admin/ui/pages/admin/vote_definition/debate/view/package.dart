...
library admin.ui.pages.admin.vote_definition.debate.view;
...
part 'mobile/pros__table.dart';
part 'mobile/cons__table.dart';
part 'mobile/comments__table.dart';
part 'tablet/body.dart';
part 'tablet/pros__table.dart';
part 'tablet/cons__table.dart';
part 'tablet/comments__table.dart';
part 'desktop/body.dart';
part 'desktop/cons__table.dart';
part 'desktop/pros__table.dart';
