...
Widget getAdminDebateCloseDebateOperationInputMobilePage(BuildContext context, CloseDebateInputStore targetStore,
                                                  ...
                                                  if (pageConfig.operationCall != null) {
                                                    ...
                                                    if (success) {
                                                      if (pageConfig.operationCallSuccess != null) {
                                                        ...
                                                        navigation.close(
                                                            true); // must send back true to view page to trigger refresh if the operation call is successful
                                                      }
                                                    }
                                                  }
                                                } catch (error) {
                                                  messageHandler.handleApiException(
                                                      context, error, 'actionButton', pageStore.validationAttributeErrorMessageMap);
                                                }
                                              },
                                            )),
                                  ],
