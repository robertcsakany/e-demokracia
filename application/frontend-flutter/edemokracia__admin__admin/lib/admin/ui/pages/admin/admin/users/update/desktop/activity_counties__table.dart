...
class EdemokraciaAdminAdminUsersEditActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
