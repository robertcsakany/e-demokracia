...
class EdemokraciaAdminAdminIssuesViewDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
