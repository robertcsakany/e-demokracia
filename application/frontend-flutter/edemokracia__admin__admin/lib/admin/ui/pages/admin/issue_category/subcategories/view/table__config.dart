...
// Page: edemokracia::admin::IssueCategory.subcategories#View

part of admin.ui.pages.admin.issue_category.subcategories.view;

class AdminIssueCategorySubcategoriesViewAdminIssueCategorySubcategoriesTableConfig extends TableConfig {
  AdminIssueCategorySubcategoriesViewPageAdminIssueCategorySubcategoriesTableDataCell titleDataCell;

  AdminIssueCategorySubcategoriesViewPageAdminIssueCategorySubcategoriesTableDataCellOnTap titleDataCellOnTap;
  AdminIssueCategorySubcategoriesViewPageAdminIssueCategorySubcategoriesTableDataCell descriptionDataCell;

  AdminIssueCategorySubcategoriesViewPageAdminIssueCategorySubcategoriesTableDataCellOnTap descriptionDataCellOnTap;
...
class AdminIssueCategorySubcategoriesViewAdminIssueCategoryOwnerTableConfig extends TableConfig {
  AdminIssueCategorySubcategoriesViewPageAdminIssueCategoryOwnerTableDataCell representationDataCell;
