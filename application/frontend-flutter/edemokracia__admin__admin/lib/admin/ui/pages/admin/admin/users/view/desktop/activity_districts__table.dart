...
class EdemokraciaAdminAdminUsersViewActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
