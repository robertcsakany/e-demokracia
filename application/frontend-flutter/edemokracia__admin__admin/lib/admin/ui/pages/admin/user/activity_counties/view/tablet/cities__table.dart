...
class EdemokraciaAdminUserActivityCountiesViewCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesViewCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
