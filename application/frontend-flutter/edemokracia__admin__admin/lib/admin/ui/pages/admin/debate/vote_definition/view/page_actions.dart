...
class AdminDebateVoteDefinitionViewPageActions extends PageActions {
  ...
  AdminDebateVoteDefinitionViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
