...
Widget getAdminCityDistrictsCreateDesktopPage(BuildContext context, AdminDistrictStore targetStore, AdminCityStore ownerStore,
    AdminCityDistrictsCreatePageStore pageStore, AdminCityDistrictsCreateConfig pageConfig, Map inputWidgetKeyMap) {
                          ...
                          children: [
                            Observer(
                                builder: (_) => JudoInputText(
                                      ...
                                      col: 4.0,
                                      maxLength: 255 ?? 250,
                                      label: AppLocalizations.of(context).lookUpValue(context, 'Name'),
