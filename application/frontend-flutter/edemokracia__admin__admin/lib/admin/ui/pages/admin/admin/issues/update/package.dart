...
library admin.ui.pages.admin.admin.issues.update;
...
part 'dialogs/categories.dart';
part 'dialogs/categories__table.dart';
part 'dialogs/owner.dart';
part 'dialogs/owner__table.dart';

part 'mobile/body.dart';
part 'mobile/attachments__table.dart';
part 'mobile/categories__table.dart';
part 'mobile/comments__table.dart';
part 'mobile/debates__table.dart';
part 'tablet/body.dart';
part 'tablet/attachments__table.dart';
part 'tablet/categories__table.dart';
part 'tablet/comments__table.dart';
part 'tablet/debates__table.dart';
part 'desktop/body.dart';
part 'desktop/attachments__table.dart';
part 'desktop/categories__table.dart';
part 'desktop/comments__table.dart';
part 'desktop/debates__table.dart';
