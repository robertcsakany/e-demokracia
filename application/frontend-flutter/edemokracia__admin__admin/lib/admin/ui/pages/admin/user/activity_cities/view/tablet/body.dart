...
Widget getAdminUserActivityCitiesViewTabletPage(BuildContext context, AdminCityStore targetStore, AdminUserStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminUserActivityCitiesViewDistrictsTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
