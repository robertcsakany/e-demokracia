...
class EdemokraciaAdminProProsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
