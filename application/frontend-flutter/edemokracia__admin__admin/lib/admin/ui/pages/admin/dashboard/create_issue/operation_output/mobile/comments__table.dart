...
class EdemokraciaAdminDashboardCreateIssueOutputCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
