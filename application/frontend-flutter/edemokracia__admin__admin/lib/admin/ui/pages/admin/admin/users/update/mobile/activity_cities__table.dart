...
class EdemokraciaAdminAdminUsersEditActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
