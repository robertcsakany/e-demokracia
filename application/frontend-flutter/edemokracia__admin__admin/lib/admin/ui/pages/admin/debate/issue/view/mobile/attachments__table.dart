...
class EdemokraciaAdminDebateIssueViewAttachmentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateIssueViewAttachmentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
