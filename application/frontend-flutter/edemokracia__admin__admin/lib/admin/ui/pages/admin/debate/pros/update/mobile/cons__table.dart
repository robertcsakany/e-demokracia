...
class EdemokraciaAdminDebateProsEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
