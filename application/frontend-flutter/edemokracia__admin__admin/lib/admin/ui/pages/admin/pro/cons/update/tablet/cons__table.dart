...
class EdemokraciaAdminProConsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
