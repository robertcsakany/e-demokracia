...
class EdemokraciaAdminConConsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
