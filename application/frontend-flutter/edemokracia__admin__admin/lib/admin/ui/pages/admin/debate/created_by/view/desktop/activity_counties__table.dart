...
class EdemokraciaAdminDebateCreatedByViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateCreatedByViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDebateCreatedByViewPageStore pageStore;
  final AdminDebateCreatedByViewConfig pageConfig;
