...
Widget getAdminAdminCategoriesCreateDesktopPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminAdminCategoriesCreatePageStore pageStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminAdminCategoriesCreateSubcategoriesDesktopTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
                                disabled: true,
