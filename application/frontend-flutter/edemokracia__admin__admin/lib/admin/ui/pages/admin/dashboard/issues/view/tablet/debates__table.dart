...
class EdemokraciaAdminDashboardIssuesViewDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
