...
class EdemokraciaAdminProConsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
