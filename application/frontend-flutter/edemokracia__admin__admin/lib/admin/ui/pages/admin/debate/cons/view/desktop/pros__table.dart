...
class EdemokraciaAdminDebateConsViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
