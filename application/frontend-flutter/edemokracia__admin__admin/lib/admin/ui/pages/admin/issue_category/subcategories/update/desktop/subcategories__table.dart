...
class EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminIssueCategorySubcategoriesUpdatePageStore pageStore;
  final AdminIssueCategorySubcategoriesUpdateConfig pageConfig;
