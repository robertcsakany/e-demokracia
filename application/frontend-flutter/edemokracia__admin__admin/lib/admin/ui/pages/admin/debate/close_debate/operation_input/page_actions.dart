...
class AdminDebateCloseDebateOperationInputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CloseDebateInputStore targetStore;
  final AdminDebateCloseDebateOperationInputPageStore pageStore;
  final AdminDebateCloseDebateOperationInputConfig pageConfig;

  AdminDebateCloseDebateOperationInputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
