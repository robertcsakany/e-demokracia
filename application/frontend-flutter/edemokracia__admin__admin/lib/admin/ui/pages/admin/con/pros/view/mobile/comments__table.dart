...
class EdemokraciaAdminConProsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
