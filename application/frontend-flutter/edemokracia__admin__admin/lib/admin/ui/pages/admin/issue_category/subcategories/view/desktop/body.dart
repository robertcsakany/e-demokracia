...
Widget getAdminIssueCategorySubcategoriesViewDesktopPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueCategoryStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo =
                                  EdemokraciaAdminIssueCategorySubcategoriesViewSubcategoriesDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
