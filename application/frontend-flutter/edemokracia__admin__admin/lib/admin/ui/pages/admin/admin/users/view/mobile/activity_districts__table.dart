...
class EdemokraciaAdminAdminUsersViewActivityDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
