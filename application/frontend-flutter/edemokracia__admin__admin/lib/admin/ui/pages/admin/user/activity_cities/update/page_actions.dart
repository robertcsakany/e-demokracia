...
class AdminUserActivityCitiesUpdatePageActions extends PageActions {
  ...
  AdminUserActivityCitiesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
