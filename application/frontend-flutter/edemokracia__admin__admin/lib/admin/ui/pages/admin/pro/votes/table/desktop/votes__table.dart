...
class EdemokraciaAdminProVotesTableVotesListDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProVotesTableVotesListDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
