...
class AdminAdminCategoriesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminIssueCategoryStore targetStore;
  final AdminAdminCategoriesViewPageStore pageStore;
  final AdminAdminCategoriesViewConfig pageConfig;

  AdminAdminCategoriesViewPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminAdminCategoriesUpdatePage, arguments: AdminAdminCategoriesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
