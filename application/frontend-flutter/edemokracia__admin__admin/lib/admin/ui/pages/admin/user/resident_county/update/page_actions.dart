...
class AdminUserResidentCountyUpdatePageActions extends PageActions {
  ...
  AdminUserResidentCountyUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
