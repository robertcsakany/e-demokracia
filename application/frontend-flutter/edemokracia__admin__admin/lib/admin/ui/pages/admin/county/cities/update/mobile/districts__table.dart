...
class EdemokraciaAdminCountyCitiesEditDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesEditDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
