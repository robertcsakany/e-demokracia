...
// Page: edemokracia::admin::User.residentCity#View

part of admin.ui.pages.admin.user.resident_city.view;

class AdminUserResidentCityViewAdminCityDistrictsTableConfig extends TableConfig {
  AdminUserResidentCityViewPageAdminCityDistrictsTableDataCell nameDataCell;

  AdminUserResidentCityViewPageAdminCityDistrictsTableDataCellOnTap nameDataCellOnTap;

  AdminUserResidentCityViewAdminCityDistrictsTableConfig({
    this.nameDataCell,
