...
class EdemokraciaAdminUserActivityCitiesEditDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesEditDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
