...
class EdemokraciaAdminConProsEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
