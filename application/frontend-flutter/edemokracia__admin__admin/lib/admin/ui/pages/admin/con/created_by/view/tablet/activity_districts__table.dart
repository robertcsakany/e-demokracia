...
class EdemokraciaAdminConCreatedByViewActivityDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
