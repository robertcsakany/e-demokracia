...
class EdemokraciaAdminUserResidentCountyEditCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyEditCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
