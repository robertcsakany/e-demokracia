...
class EdemokraciaAdminProProsViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
