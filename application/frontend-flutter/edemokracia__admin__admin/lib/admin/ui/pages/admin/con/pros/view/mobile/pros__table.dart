...
class EdemokraciaAdminConProsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
