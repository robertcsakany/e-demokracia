...
class EdemokraciaAdminAdminIssuesEditCategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
