...
class AdminIssueCreatedByViewPageActions extends PageActions {
  ...
  AdminIssueCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
