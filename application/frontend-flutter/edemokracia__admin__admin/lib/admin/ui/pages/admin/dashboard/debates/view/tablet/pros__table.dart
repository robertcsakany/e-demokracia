...
class EdemokraciaAdminDashboardDebatesViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
