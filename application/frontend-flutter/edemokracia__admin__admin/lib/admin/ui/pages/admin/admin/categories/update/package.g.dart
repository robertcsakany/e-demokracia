...
mixin _$AdminAdminCategoriesUpdatePageStore on _AdminAdminCategoriesUpdatePageStore, Store {
  ...
  int get subcategoriesTableItemsRangeStart => (_$subcategoriesTableItemsRangeStartComputed ??=
          Computed<int>(() => super.subcategoriesTableItemsRangeStart, name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTableItemsRangeStart'))
      .value;
  ...
  int get subcategoriesTableItemsRangeEnd => (_$subcategoriesTableItemsRangeEndComputed ??=
          Computed<int>(() => super.subcategoriesTableItemsRangeEnd, name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTableItemsRangeEnd'))
      .value;
  ...
  bool get subcategoriesTablePreviousEnable => (_$subcategoriesTablePreviousEnableComputed ??=
          Computed<bool>(() => super.subcategoriesTablePreviousEnable, name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTablePreviousEnable'))
      .value;
  ...
  bool get subcategoriesTableNextEnable => (_$subcategoriesTableNextEnableComputed ??=
          Computed<bool>(() => super.subcategoriesTableNextEnable, name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTableNextEnable'))
      .value;
  ...
  List<AdminIssueCategoryStore> get subcategoriesTablePagingList =>
      (_$subcategoriesTablePagingListComputed ??= Computed<List<AdminIssueCategoryStore>>(() => super.subcategoriesTablePagingList,
              name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTablePagingList'))
          .value;
  ...
  int get ownerTableForRangeItemsRangeStart => (_$ownerTableForRangeItemsRangeStartComputed ??=
          Computed<int>(() => super.ownerTableForRangeItemsRangeStart, name: '_AdminAdminCategoriesUpdatePageStore.ownerTableForRangeItemsRangeStart'))
      .value;
  ...
  int get ownerTableForRangeItemsRangeEnd => (_$ownerTableForRangeItemsRangeEndComputed ??=
          Computed<int>(() => super.ownerTableForRangeItemsRangeEnd, name: '_AdminAdminCategoriesUpdatePageStore.ownerTableForRangeItemsRangeEnd'))
      .value;
  ...
  bool get previousButtonEnableForOwnerRange => (_$previousButtonEnableForOwnerRangeComputed ??=
          Computed<bool>(() => super.previousButtonEnableForOwnerRange, name: '_AdminAdminCategoriesUpdatePageStore.previousButtonEnableForOwnerRange'))
      .value;

  final _$targetStoreAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.targetStore');
  ...
  final _$subcategoriesTablePageNumberAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTablePageNumber');
  ...
  final _$issueCategoryOwnerStoreRangeFutureAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.issueCategoryOwnerStoreRangeFuture');
  ...
  final _$ownerSortColumnIndexRangeAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.ownerSortColumnIndexRange');
  ...
  final _$ownerSortColumnNameRangeAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.ownerSortColumnNameRange');
  ...
  final _$ownerSortAscRangeAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.ownerSortAscRange');
  ...
  final _$ownerStoreRangeListAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.ownerStoreRangeList');
  ...
  final _$nextButtonEnableForOwnerRangeAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.nextButtonEnableForOwnerRange');
  ...
  final _$nextPageCounterForOwnerRangeAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.nextPageCounterForOwnerRange');
  ...
  final _$issueCategoryOwnerStoreFutureAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.issueCategoryOwnerStoreFuture');
  ...
  final _$subcategoriesSortColumnIndexAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesSortColumnIndex');
  ...
  final _$subcategoriesSortColumnNameAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesSortColumnName');
  ...
  final _$subcategoriesSortAscAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesSortAsc');
  ...
  final _$subcategoriesSortCompareAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesSortCompare');
  ...
  final _$issueCategorySubcategoriesStoreFutureAtom = Atom(name: '_AdminAdminCategoriesUpdatePageStore.issueCategorySubcategoriesStoreFuture');
  ...
  final _$refreshIssueCategoryAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.refreshIssueCategory');
  ...
  final _$validateAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.validate');
  ...
  final _$uploadFileAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.uploadFile');
  ...
  final _$downloadFileAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.downloadFile');
  ...
  final _$getRangeForOwnerAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.getRangeForOwner');
  ...
  final _$setOwnerAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.setOwner');
  ...
  final _$unsetOwnerAsyncAction = AsyncAction('_AdminAdminCategoriesUpdatePageStore.unsetOwner');
  ...
  final _$_AdminAdminCategoriesUpdatePageStoreActionController = ActionController(name: '_AdminAdminCategoriesUpdatePageStore');

  @override
  void initSortAggregatedLists(BuildContext context, AdminAdminCategoriesUpdateConfig pageConfig) {
    final _$actionInfo =
        _$_AdminAdminCategoriesUpdatePageStoreActionController.startAction(name: '_AdminAdminCategoriesUpdatePageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_AdminAdminCategoriesUpdatePageStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void subcategoriesTableNextPage() {
    final _$actionInfo =
        _$_AdminAdminCategoriesUpdatePageStoreActionController.startAction(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTableNextPage');
    try {
  ...
  void subcategoriesTablePreviousPage() {
    final _$actionInfo =
        _$_AdminAdminCategoriesUpdatePageStoreActionController.startAction(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesTablePreviousPage');
    try {
  ...
  void ownerSetSortRange(AdminIssueCategoryStore ownerStore, BuildContext context, String sortColumnName, int sortColumnIndex, bool asc,
    ...
    final _$actionInfo = _$_AdminAdminCategoriesUpdatePageStoreActionController.startAction(name: '_AdminAdminCategoriesUpdatePageStore.ownerSetSortRange');
    try {
  ...
  void subcategoriesSetSort(
    ...
    final _$actionInfo = _$_AdminAdminCategoriesUpdatePageStoreActionController.startAction(name: '_AdminAdminCategoriesUpdatePageStore.subcategoriesSetSort');
    try {
...
mixin _$AdminAdminCategoriesUpdateOwnerDialogStore on _AdminAdminCategoriesUpdateOwnerDialogStore, Store {
  Computed<double> _$getInputWidgetsHeightComputed;

  @override
  double get getInputWidgetsHeight => (_$getInputWidgetsHeightComputed ??=
          Computed<double>(() => super.getInputWidgetsHeight, name: '_AdminAdminCategoriesUpdateOwnerDialogStore.getInputWidgetsHeight'))
      .value;
  Computed<bool> _$searchButtonEnabledComputed;

  @override
  bool get searchButtonEnabled => (_$searchButtonEnabledComputed ??=
          Computed<bool>(() => super.searchButtonEnabled, name: '_AdminAdminCategoriesUpdateOwnerDialogStore.searchButtonEnabled'))
      .value;
  ...
  double get filterWidgetsColumnHeight => (_$filterWidgetsColumnHeightComputed ??=
          Computed<double>(() => super.filterWidgetsColumnHeight, name: '_AdminAdminCategoriesUpdateOwnerDialogStore.filterWidgetsColumnHeight'))
      .value;

  final _$availableFilterListAtom = Atom(name: '_AdminAdminCategoriesUpdateOwnerDialogStore.availableFilterList');
  ...
  final _$numberOfColumnsAtom = Atom(name: '_AdminAdminCategoriesUpdateOwnerDialogStore.numberOfColumns');
  ...
  final _$numberOfColumnsAfterFilterHorizontalAtom = Atom(name: '_AdminAdminCategoriesUpdateOwnerDialogStore.numberOfColumnsAfterFilterHorizontal');
  ...
  final _$_AdminAdminCategoriesUpdateOwnerDialogStoreActionController = ActionController(name: '_AdminAdminCategoriesUpdateOwnerDialogStore');

  @override
  void addNewFilter(FilterStore newFilterStore) {
    final _$actionInfo =
        _$_AdminAdminCategoriesUpdateOwnerDialogStoreActionController.startAction(name: '_AdminAdminCategoriesUpdateOwnerDialogStore.addNewFilter');
    try {
      return super.addNewFilter(newFilterStore);
    } finally {
      _$_AdminAdminCategoriesUpdateOwnerDialogStoreActionController.endAction(_$actionInfo);
    }
  }
