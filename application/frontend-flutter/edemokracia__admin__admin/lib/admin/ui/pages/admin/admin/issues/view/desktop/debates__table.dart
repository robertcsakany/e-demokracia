...
class EdemokraciaAdminAdminIssuesViewDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
