...
class EdemokraciaAdminCommentCreatedByViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
