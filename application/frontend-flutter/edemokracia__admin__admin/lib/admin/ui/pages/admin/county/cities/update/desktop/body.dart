...
Widget getAdminCountyCitiesUpdateDesktopPage(BuildContext context, AdminCityStore targetStore, AdminCountyCitiesUpdatePageStore pageStore,
    AdminCountyCitiesUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminCountyCitiesEditDistrictsDesktopTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
                                disabled: true,
