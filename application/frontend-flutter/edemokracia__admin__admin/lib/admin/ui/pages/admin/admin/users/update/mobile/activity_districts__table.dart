...
class EdemokraciaAdminAdminUsersEditActivityDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
