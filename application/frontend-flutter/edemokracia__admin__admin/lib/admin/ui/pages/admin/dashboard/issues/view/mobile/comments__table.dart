...
class EdemokraciaAdminDashboardIssuesViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
