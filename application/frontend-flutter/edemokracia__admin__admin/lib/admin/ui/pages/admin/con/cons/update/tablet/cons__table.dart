...
class EdemokraciaAdminConConsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
