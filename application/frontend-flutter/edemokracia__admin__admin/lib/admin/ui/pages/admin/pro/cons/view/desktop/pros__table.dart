...
class EdemokraciaAdminProConsViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
