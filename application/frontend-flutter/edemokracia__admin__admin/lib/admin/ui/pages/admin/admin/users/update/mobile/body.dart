...
Widget getAdminAdminUsersUpdateMobilePage(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityCountiesMobileTable(
                                                                      ...
                                                                      onSelected: () async {
                                                                        showDialog(
                                                                            ...
                                                                            builder: (_) => new AlertDialog(
                                                                                  ...
                                                                                  content: new Text(
                                                                                    AppLocalizations.of(context).lookUpValue(context,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityCitiesMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityDistrictsMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
