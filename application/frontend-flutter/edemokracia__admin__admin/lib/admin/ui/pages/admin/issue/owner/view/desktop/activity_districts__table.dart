...
class EdemokraciaAdminIssueOwnerViewActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
