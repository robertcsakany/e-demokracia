...
class EdemokraciaAdminAdminUsersViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
