...
Widget getAdminConCreatedByViewMobilePage(BuildContext context, AdminUserStore targetStore, AdminConStore ownerStore, AdminConCreatedByViewPageStore pageStore,
    AdminConCreatedByViewConfig pageConfig) {
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(
                                          ...
                                          order: 12,
                                          tabIndex:
                                              tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Con::createdBy_activity').tabIndex,
                                          setTabIndex: tabService
                                              .getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Con::createdBy_activity')
                                              .setTabIndex,
                                          tabContent: [
                                            JudoRow(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminConCreatedByViewActivityCountiesMobileTable(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminConCreatedByViewActivityCitiesMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminConCreatedByViewActivityDistrictsMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
