...
Widget getAdminAdminDashboardhomeDashboardMobilePage(BuildContext context, AdminDashboardStore targetStore, AdminAdminDashboardhomeDashboardPageStore pageStore,
              ...
              children: [
                JudoColumn(
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(col: 4.0, row: 21.0, order: 1, tabContent: [
                        JudoRow(
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminAdminDashboardhomeDashboardIssuesMobileTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 2,
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminAdminDashboardhomeDashboardDebatesMobileTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 3,
                                            disabled: pageStore.pageState.disabledByLoading,
