...
class EdemokraciaAdminAdminIssuesEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
