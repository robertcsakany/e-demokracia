...
class EdemokraciaAdminDashboardDebatesViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
