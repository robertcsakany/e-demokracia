...
class EdemokraciaAdminIssueCreatedByViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCreatedByViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminIssueCreatedByViewPageStore pageStore;
  final AdminIssueCreatedByViewConfig pageConfig;
