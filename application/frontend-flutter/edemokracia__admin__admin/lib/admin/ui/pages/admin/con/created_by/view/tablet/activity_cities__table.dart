...
class EdemokraciaAdminConCreatedByViewActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
