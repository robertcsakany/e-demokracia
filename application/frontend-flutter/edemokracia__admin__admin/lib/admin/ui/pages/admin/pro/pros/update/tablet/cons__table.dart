...
class EdemokraciaAdminProProsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
