...
class EdemokraciaAdminProCreatedByViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminProCreatedByViewPageStore pageStore;
  final AdminProCreatedByViewConfig pageConfig;
