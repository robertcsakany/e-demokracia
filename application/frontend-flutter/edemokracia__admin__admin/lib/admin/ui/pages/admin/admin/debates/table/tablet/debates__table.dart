...
class EdemokraciaAdminAdminDebatesTableDebateTableTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesTableDebateTableTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
