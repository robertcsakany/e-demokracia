...
Widget getAdminAdminDebatesTableTabletPage(BuildContext context, AdminAdminDebatesTablePageStore pageStore, AdminAdminDebatesTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminDebatesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminAdminDebatesTableDebateTableTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
