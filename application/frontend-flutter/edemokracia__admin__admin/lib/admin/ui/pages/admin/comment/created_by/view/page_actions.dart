...
class AdminCommentCreatedByViewPageActions extends PageActions {
  ...
  AdminCommentCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
