...
class EdemokraciaAdminAdminCategoriesEditSubcategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesEditSubcategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
