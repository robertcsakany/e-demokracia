...
class EdemokraciaAdminProCreatedByViewActivityDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
