...
class EdemokraciaAdminDebateProsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
