...
class EdemokraciaAdminAdminDebatesTableDebateTableMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesTableDebateTableMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
