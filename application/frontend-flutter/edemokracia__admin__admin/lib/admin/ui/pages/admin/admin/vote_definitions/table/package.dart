...
library admin.ui.pages.admin.admin.vote_definitions.table;
...
part 'dialogs/vote_definition_vote_select_answer.dart';
part 'dialogs/vote_definition_vote_select_answer__table.dart';

part 'mobile/body.dart';
part 'mobile/vote_definitions__table.dart';
part 'tablet/body.dart';
part 'tablet/vote_definitions__table.dart';
part 'desktop/body.dart';
part 'desktop/vote_definitions__table.dart';
