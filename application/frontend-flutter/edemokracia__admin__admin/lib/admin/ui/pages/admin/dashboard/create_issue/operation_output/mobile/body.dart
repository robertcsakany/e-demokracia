...
Widget getAdminDashboardCreateIssueOperationOutputMobilePage(BuildContext context, AdminIssueStore targetStore,
              ...
              children: [
                ...
                JudoColumn(
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(col: 4.0, row: 14.0, order: 8, tabContent: [
                        JudoRow(
                          mainAxisAlignment: MainAxisAlignment.start,
                          col: 4.0,
                          row: 13.0,
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminDashboardCreateIssueOutputAttachmentsMobileTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 9,
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminDashboardCreateIssueOutputCategoriesMobileTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 10,
                                            disabled: pageStore.pageState.disabledByLoading,
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminDashboardCreateIssueOutputDebatesMobileTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 11,
                                            disabled: pageStore.pageState.disabledByLoading,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminDashboardCreateIssueOutputCommentsMobileTable(
