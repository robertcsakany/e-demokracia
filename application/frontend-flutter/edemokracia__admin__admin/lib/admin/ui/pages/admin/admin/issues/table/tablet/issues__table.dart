...
class EdemokraciaAdminAdminIssuesTableIssueTableTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesTableIssueTableTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
