...
class EdemokraciaAdminDashboardIssuesViewCategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
