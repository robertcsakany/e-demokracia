...
class EdemokraciaAdminAdminUsersViewActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
