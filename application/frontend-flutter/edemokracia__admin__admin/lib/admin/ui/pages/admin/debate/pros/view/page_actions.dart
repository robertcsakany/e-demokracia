...
class AdminDebateProsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminProStore targetStore;
  final AdminDebateStore ownerStore;
  final AdminDebateProsViewPageStore pageStore;
  final AdminDebateProsViewConfig pageConfig;

  AdminDebateProsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminDebateProsUpdatePage, arguments: AdminDebateProsUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
