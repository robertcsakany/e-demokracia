...
class AdminAdminUsersUpdatePageActions extends PageActions {
  ...
  AdminAdminUsersUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
