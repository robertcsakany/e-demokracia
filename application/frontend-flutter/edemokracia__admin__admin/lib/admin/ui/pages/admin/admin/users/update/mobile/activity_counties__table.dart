...
class EdemokraciaAdminAdminUsersEditActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
