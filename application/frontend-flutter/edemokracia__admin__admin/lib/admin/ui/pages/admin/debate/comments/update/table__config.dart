...
// Page: edemokracia::admin::Debate.comments#Edit

part of admin.ui.pages.admin.debate.comments.update;

class AdminDebateCommentsUpdateAdminCommentCreatedByTableConfig extends TableConfig {
  AdminDebateCommentsUpdatePageAdminCommentCreatedByTableDataCell representationDataCell;

  AdminDebateCommentsUpdateAdminCommentCreatedByTableConfig({
