...
class EdemokraciaAdminProCreatedByViewActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
