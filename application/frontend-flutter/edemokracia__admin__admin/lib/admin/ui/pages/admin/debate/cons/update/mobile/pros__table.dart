...
class EdemokraciaAdminDebateConsEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
