...
class AdminAdminDebatesUpdatePageActions extends PageActions {
  ...
  AdminAdminDebatesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
