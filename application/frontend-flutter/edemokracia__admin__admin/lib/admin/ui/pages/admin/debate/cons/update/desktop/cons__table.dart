...
class EdemokraciaAdminDebateConsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
