...
class AdminIssueCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCommentStore targetStore;
  final AdminIssueStore ownerStore;
  final AdminIssueCommentsViewPageStore pageStore;
  final AdminIssueCommentsViewConfig pageConfig;

  AdminIssueCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
