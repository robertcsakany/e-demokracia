...
class EdemokraciaAdminConProsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
