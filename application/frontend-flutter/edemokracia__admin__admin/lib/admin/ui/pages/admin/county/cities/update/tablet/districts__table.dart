...
class EdemokraciaAdminCountyCitiesEditDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesEditDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
