...
// Page: edemokracia::admin::County.cities#View

part of admin.ui.pages.admin.county.cities.view;

class AdminCountyCitiesViewAdminCityDistrictsTableConfig extends TableConfig {
  AdminCountyCitiesViewPageAdminCityDistrictsTableDataCell nameDataCell;

  AdminCountyCitiesViewPageAdminCityDistrictsTableDataCellOnTap nameDataCellOnTap;

  AdminCountyCitiesViewAdminCityDistrictsTableConfig({
    this.nameDataCell,
