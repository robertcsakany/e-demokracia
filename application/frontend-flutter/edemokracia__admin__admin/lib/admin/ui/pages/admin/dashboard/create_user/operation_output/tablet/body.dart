...
Widget getAdminDashboardCreateUserOperationOutputTabletPage(BuildContext context, AdminUserStore targetStore,
                            ...
                            JudoColumn(
                              ...
                              children: [
                                ...
                                JudoRow(
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(col: 8.0, row: 11.0, order: 13, tabContent: [
                                        JudoRow(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          col: 8.0,
                                          row: 10.0,
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCountiesTabletTable(
                                                          ...
                                                          return JudoTable(
                                                            ...
                                                            onSort: (int columnIndex, bool asc) {
                                                              pageStore.activityCountiesSetSort(context, dataInfo.getColumnFieldByIndex(columnIndex),
                                                                  columnIndex, asc, TableUtility.getSortComparator(columnIndex, asc, dataInfo), targetStore);
                                                            },
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCitiesTabletTable(
                                                              context, pageStore, pageConfig,
                                                              disabled: false);
                                                          return JudoTable(
                                                            key: UniqueKey(),
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityDistrictsTabletTable(
                                                              context, pageStore, pageConfig,
                                                              disabled: false);
                                                          return JudoTable(
                                                            key: UniqueKey(),
                                                            ...
                                                            sortInitially: true,
                                                            onSort: (int columnIndex, bool asc) {
                                                              pageStore.activityDistrictsSetSort(context, dataInfo.getColumnFieldByIndex(columnIndex),
                                                                  columnIndex, asc, TableUtility.getSortComparator(columnIndex, asc, dataInfo), targetStore);
                                                            },
