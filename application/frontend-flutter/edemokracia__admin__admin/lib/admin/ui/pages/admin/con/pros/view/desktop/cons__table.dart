...
class EdemokraciaAdminConProsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
