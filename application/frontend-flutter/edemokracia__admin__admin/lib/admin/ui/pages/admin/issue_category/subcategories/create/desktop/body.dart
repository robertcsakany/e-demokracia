...
Widget getAdminIssueCategorySubcategoriesCreateDesktopPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueCategoryStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo =
                                  EdemokraciaAdminIssueCategorySubcategoriesCreateSubcategoriesDesktopTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
                                disabled: true,
