...
class EdemokraciaAdminIssueOwnerViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
