...
class EdemokraciaAdminVoteDefinitionDebateViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
