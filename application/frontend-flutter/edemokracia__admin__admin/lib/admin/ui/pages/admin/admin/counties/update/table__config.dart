...
// Page: edemokracia::admin::Admin.counties#Edit

part of admin.ui.pages.admin.admin.counties.update;

class AdminAdminCountiesUpdateAdminCountyCitiesTableConfig extends TableConfig {
  AdminAdminCountiesUpdatePageAdminCountyCitiesTableDataCell nameDataCell;

  AdminAdminCountiesUpdatePageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminAdminCountiesUpdateAdminCountyCitiesTableConfig({
    this.nameDataCell,
