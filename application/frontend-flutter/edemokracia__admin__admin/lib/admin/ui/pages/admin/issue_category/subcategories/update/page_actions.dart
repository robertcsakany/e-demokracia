...
class AdminIssueCategorySubcategoriesUpdatePageActions extends PageActions {
  ...
  AdminIssueCategorySubcategoriesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
