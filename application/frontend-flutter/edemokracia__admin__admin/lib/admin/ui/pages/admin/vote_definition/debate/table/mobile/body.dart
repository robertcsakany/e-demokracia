...
Widget getAdminVoteDefinitionDebateTableMobilePage(BuildContext context, AdminVoteDefinitionStore ownerStore, AdminVoteDefinitionDebateTablePageStore pageStore,
    AdminVoteDefinitionDebateTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.voteDefinitionDebateStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminVoteDefinitionDebateTableDebateTableMobileTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
