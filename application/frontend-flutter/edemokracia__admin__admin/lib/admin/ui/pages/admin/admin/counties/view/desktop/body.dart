...
Widget getAdminAdminCountiesViewDesktopPage(
    BuildContext context, AdminCountyStore targetStore, AdminAdminCountiesViewPageStore pageStore, AdminAdminCountiesViewConfig pageConfig) {
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminAdminCountiesViewCitiesDesktopTable(context, pageStore, pageConfig, disabled: false);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
