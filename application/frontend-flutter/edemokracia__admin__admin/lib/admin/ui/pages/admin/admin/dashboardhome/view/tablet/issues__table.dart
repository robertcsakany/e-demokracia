...
class EdemokraciaAdminAdminDashboardhomeViewIssuesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeViewIssuesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
