...
class EdemokraciaAdminDebateConsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
