...
class EdemokraciaAdminAdminCountiesEditCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesEditCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
