...
class EdemokraciaAdminAdminCountiesViewCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesViewCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
