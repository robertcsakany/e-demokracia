...
class EdemokraciaAdminProCreatedByViewActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
