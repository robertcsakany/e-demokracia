...
Widget getAdminAdminCountiesUpdateDesktopPage(BuildContext context, AdminCountyStore targetStore, AdminAdminCountiesUpdatePageStore pageStore,
    AdminAdminCountiesUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminAdminCountiesEditCitiesDesktopTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
