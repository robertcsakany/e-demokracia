...
class EdemokraciaAdminAdminUsersEditActivityDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
