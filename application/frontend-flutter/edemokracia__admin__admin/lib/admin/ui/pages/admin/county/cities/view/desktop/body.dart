...
Widget getAdminCountyCitiesViewDesktopPage(BuildContext context, AdminCityStore targetStore, AdminCountyStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminCountyCitiesViewDistrictsDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
