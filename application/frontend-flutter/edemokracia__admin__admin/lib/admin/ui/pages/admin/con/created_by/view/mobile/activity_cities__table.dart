...
class EdemokraciaAdminConCreatedByViewActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
