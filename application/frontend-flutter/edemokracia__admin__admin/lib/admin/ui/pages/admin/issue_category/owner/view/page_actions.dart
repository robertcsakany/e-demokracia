...
class AdminIssueCategoryOwnerViewPageActions extends PageActions {
  ...
  AdminIssueCategoryOwnerViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
