...
class EdemokraciaAdminDashboardIssuesViewDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
