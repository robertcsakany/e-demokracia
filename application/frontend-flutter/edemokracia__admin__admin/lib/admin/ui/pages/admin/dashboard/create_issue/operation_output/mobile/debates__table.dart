...
class EdemokraciaAdminDashboardCreateIssueOutputDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
