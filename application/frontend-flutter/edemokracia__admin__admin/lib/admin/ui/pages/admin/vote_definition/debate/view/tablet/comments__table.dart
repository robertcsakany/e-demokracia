...
class EdemokraciaAdminVoteDefinitionDebateViewCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
