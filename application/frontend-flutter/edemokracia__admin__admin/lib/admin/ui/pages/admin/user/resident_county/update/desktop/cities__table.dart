...
class EdemokraciaAdminUserResidentCountyEditCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyEditCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminUserResidentCountyUpdatePageStore pageStore;
  final AdminUserResidentCountyUpdateConfig pageConfig;
