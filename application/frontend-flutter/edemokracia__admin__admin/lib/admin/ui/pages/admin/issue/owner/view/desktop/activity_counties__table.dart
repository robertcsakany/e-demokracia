...
class EdemokraciaAdminIssueOwnerViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminIssueOwnerViewPageStore pageStore;
  final AdminIssueOwnerViewConfig pageConfig;
