...
class EdemokraciaAdminVoteDefinitionDebateViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
