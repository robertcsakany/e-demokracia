...
class AdminIssueCategorySubcategoriesCreateOwnerDialogTable implements JudoTableDataInfo {
  const AdminIssueCategorySubcategoriesCreateOwnerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
