...
class EdemokraciaAdminAdminCategoriesViewSubcategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesViewSubcategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
