...
class EdemokraciaAdminAdminDashboardhomeDashboardIssuesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardIssuesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
