...
library admin.ui.pages.admin.issue_category.subcategories.create;
...
part 'mobile/subcategories__table.dart';
part 'tablet/body.dart';
part 'tablet/subcategories__table.dart';
part 'desktop/body.dart';
part 'desktop/subcategories__table.dart';
