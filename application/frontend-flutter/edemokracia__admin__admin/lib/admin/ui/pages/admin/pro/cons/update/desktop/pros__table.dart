...
class EdemokraciaAdminProConsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
