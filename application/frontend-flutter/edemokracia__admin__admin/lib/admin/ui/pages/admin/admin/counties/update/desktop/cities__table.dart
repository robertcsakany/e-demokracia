...
class EdemokraciaAdminAdminCountiesEditCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesEditCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminAdminCountiesUpdatePageStore pageStore;
  final AdminAdminCountiesUpdateConfig pageConfig;
