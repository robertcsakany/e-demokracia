...
class EdemokraciaAdminDebateProsViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
