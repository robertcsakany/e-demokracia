...
class AdminCountyCitiesUpdatePageActions extends PageActions {
  ...
  AdminCountyCitiesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
