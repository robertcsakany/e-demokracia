...
class EdemokraciaAdminCommentVotesTableVotesListMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentVotesTableVotesListMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
