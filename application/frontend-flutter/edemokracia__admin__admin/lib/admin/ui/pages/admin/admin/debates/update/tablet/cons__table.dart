...
class EdemokraciaAdminAdminDebatesEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
