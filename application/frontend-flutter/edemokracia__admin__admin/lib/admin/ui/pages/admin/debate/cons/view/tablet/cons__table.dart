...
class EdemokraciaAdminDebateConsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
