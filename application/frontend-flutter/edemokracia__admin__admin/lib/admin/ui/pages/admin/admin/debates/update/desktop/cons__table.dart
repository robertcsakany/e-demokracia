...
class EdemokraciaAdminAdminDebatesEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
