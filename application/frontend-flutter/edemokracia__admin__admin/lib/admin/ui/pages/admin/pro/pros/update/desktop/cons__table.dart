...
class EdemokraciaAdminProProsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
