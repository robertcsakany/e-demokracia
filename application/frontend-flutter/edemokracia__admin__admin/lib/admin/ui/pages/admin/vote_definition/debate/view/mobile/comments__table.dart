...
class EdemokraciaAdminVoteDefinitionDebateViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
