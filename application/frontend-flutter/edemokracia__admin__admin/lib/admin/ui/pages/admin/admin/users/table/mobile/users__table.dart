...
class EdemokraciaAdminAdminUsersTableUserTableMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersTableUserTableMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
