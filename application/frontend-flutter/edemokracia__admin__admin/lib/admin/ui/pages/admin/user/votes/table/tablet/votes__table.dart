...
class EdemokraciaAdminUserVotesTableVotesListTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserVotesTableVotesListTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
