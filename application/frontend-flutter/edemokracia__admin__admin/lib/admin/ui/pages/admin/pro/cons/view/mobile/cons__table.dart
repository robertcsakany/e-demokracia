...
class EdemokraciaAdminProConsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
