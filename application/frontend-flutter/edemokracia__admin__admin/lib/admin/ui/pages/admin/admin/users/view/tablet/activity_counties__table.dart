...
class EdemokraciaAdminAdminUsersViewActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
