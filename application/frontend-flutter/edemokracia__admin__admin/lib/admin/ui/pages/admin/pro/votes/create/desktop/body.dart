...
Widget getAdminProVotesCreateDesktopPage(BuildContext context, AdminSimpleVoteStore targetStore, AdminProStore ownerStore,
    AdminProVotesCreatePageStore pageStore, AdminProVotesCreateConfig pageConfig, Map inputWidgetKeyMap) {
