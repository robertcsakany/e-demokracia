...
class EdemokraciaAdminDebateConsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
