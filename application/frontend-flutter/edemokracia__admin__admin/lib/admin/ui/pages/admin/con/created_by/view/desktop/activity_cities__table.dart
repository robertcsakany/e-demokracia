...
class EdemokraciaAdminConCreatedByViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
