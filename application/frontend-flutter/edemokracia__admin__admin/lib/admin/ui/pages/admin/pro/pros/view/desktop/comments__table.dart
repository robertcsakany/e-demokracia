...
class EdemokraciaAdminProProsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
