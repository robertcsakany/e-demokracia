...
class EdemokraciaAdminAdminUsersViewActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
