...
class EdemokraciaAdminConProsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminConProsUpdatePageStore pageStore;
  final AdminConProsUpdateConfig pageConfig;
