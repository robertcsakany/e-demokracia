...
class EdemokraciaAdminUserResidentCountyEditCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyEditCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
