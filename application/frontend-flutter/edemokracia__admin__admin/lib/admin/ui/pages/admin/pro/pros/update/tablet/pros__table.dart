...
class EdemokraciaAdminProProsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
