...
library admin.ui.pages.admin.user.activity_cities.update;
...
part 'mobile/districts__table.dart';
part 'tablet/body.dart';
part 'tablet/districts__table.dart';
part 'desktop/body.dart';
part 'desktop/districts__table.dart';
