...
class EdemokraciaAdminConConsEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
