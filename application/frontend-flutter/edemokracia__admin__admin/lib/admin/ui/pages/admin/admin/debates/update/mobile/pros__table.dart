...
class EdemokraciaAdminAdminDebatesEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
