...
class EdemokraciaAdminConProsViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
