...
class EdemokraciaAdminDashboardCreateIssueOutputAttachmentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputAttachmentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
