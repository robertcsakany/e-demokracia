...
Widget getAdminDebateProsUpdateDesktopPage(
    BuildContext context, AdminProStore targetStore, AdminDebateProsUpdatePageStore pageStore, AdminDebateProsUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditProsDesktopTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                disabled: true,
                                        ...
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditConsDesktopTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 13,
                                                disabled: true,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditCommentsDesktopTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 15,
                                                disabled: true,
