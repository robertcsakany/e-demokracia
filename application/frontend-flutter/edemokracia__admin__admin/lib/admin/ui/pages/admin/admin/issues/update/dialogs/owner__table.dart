...
class AdminAdminIssuesUpdateOwnerDialogTable implements JudoTableDataInfo {
  const AdminAdminIssuesUpdateOwnerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
