...
Widget getAdminIssueCategoriesViewTabletPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminIssueCategoriesViewSubcategoriesTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
