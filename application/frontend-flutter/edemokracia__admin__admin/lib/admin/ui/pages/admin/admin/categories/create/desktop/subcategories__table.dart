...
class EdemokraciaAdminAdminCategoriesCreateSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesCreateSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminAdminCategoriesCreatePageStore pageStore;
  final AdminAdminCategoriesCreateConfig pageConfig;
