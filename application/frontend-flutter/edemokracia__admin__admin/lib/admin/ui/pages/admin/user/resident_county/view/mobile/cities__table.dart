...
class EdemokraciaAdminUserResidentCountyViewCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyViewCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
