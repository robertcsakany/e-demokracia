...
Widget getAdminIssueCategoriesViewDesktopPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueStore ownerStore,
    AdminIssueCategoriesViewPageStore pageStore, AdminIssueCategoriesViewConfig pageConfig) {
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminIssueCategoriesViewSubcategoriesDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
