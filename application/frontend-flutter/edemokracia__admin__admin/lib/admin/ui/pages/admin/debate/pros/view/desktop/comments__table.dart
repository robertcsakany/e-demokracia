...
class EdemokraciaAdminDebateProsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
