...
class EdemokraciaAdminDebateIssueViewAttachmentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateIssueViewAttachmentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
