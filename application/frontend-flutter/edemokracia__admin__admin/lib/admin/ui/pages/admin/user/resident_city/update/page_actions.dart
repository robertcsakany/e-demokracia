...
class AdminUserResidentCityUpdatePageActions extends PageActions {
  ...
  AdminUserResidentCityUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
