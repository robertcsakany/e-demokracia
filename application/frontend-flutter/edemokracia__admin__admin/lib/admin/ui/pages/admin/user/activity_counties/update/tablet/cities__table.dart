...
class EdemokraciaAdminUserActivityCountiesEditCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesEditCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
