...
class EdemokraciaAdminCountyCitiesViewDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesViewDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
