...
// Page: edemokracia::admin::Pro.comments#View

part of admin.ui.pages.admin.pro.comments.view;

class AdminProCommentsViewAdminCommentCreatedByTableConfig extends TableConfig {
  AdminProCommentsViewPageAdminCommentCreatedByTableDataCell representationDataCell;

  AdminProCommentsViewAdminCommentCreatedByTableConfig({
