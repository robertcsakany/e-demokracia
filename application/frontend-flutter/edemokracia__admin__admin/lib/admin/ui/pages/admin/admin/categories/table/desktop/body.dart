...
Widget getAdminAdminCategoriesTableDesktopPage(BuildContext context, AdminAdminCategoriesTablePageStore pageStore, AdminAdminCategoriesTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminCategoriesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminAdminCategoriesTableCategoriesListDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
