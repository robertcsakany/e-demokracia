...
class AdminUserResidentDistrictViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminDistrictStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserResidentDistrictViewPageStore pageStore;
  final AdminUserResidentDistrictViewConfig pageConfig;

  AdminUserResidentDistrictViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res =
            await navigation.open(Routes.adminUserResidentDistrictUpdatePage, arguments: AdminUserResidentDistrictUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
