...
class EdemokraciaAdminConProsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
