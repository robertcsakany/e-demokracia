...
class EdemokraciaAdminUserResidentCityEditDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCityEditDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
