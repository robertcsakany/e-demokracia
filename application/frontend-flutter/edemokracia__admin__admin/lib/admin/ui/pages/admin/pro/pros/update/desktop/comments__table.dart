...
class EdemokraciaAdminProProsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminProProsUpdatePageStore pageStore;
  final AdminProProsUpdateConfig pageConfig;
