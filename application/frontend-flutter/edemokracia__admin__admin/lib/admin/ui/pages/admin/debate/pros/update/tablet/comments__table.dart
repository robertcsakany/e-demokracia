...
class EdemokraciaAdminDebateProsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
