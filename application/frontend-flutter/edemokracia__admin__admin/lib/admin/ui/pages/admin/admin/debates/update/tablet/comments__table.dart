...
class EdemokraciaAdminAdminDebatesEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
