...
class EdemokraciaAdminIssueCreatedByViewActivityDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCreatedByViewActivityDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
