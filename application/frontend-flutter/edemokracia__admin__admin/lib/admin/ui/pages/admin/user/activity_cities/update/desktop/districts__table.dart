...
class EdemokraciaAdminUserActivityCitiesEditDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesEditDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminUserActivityCitiesUpdatePageStore pageStore;
  final AdminUserActivityCitiesUpdateConfig pageConfig;
