...
Widget getAdminUserActivityCountiesViewDesktopPage(BuildContext context, AdminCountyStore targetStore, AdminUserStore ownerStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserActivityCountiesViewCitiesDesktopTable(context, pageStore, pageConfig, disabled: false);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
