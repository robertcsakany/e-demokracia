...
Widget getAdminProCreatedByViewMobilePage(BuildContext context, AdminUserStore targetStore, AdminProStore ownerStore, AdminProCreatedByViewPageStore pageStore,
    AdminProCreatedByViewConfig pageConfig) {
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(
                                          ...
                                          order: 12,
                                          tabIndex:
                                              tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Pro::createdBy_activity').tabIndex,
                                          setTabIndex: tabService
                                              .getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Pro::createdBy_activity')
                                              .setTabIndex,
                                          tabContent: [
                                            JudoRow(
                                              mainAxisAlignment: MainAxisAlignment.start,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminProCreatedByViewActivityCountiesMobileTable(
                                                              ...
                                                              return JudoTable(
                                                                ...
                                                                onSort: (int columnIndex, bool asc) {
                                                                  pageStore.activityCountiesSetSort(
                                                                      context,
                                                                      dataInfo.getColumnFieldByIndex(columnIndex),
                                                                      columnIndex,
                                                                      asc,
                                                                      TableUtility.getSortComparator(columnIndex, asc, dataInfo),
                                                                      targetStore);
                                                                },
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminProCreatedByViewActivityCitiesMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                                ...
                                                                sortInitially: true,
                                                                onSort: (int columnIndex, bool asc) {
                                                                  pageStore.activityCitiesSetSort(
                                                                      context,
                                                                      dataInfo.getColumnFieldByIndex(columnIndex),
                                                                      columnIndex,
                                                                      asc,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminProCreatedByViewActivityDistrictsMobileTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                                ...
                                                                sortInitially: true,
                                                                onSort: (int columnIndex, bool asc) {
                                                                  pageStore.activityDistrictsSetSort(
                                                                      context,
                                                                      dataInfo.getColumnFieldByIndex(columnIndex),
                                                                      columnIndex,
                                                                      asc,
