...
class EdemokraciaAdminDebateIssueViewAttachmentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateIssueViewAttachmentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
