...
class EdemokraciaAdminUserResidentCountyViewCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyViewCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
