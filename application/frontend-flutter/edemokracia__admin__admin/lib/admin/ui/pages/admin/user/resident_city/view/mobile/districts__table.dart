...
class EdemokraciaAdminUserResidentCityViewDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCityViewDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
