...
class EdemokraciaAdminConConsViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
