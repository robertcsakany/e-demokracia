...
Widget getAdminUserResidentCountyUpdateDesktopPage(BuildContext context, AdminCountyStore targetStore, AdminUserResidentCountyUpdatePageStore pageStore,
    AdminUserResidentCountyUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserResidentCountyEditCitiesDesktopTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
