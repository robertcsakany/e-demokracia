...
Widget getAdminIssueCategoryOwnerViewDesktopPage(BuildContext context, AdminUserStore targetStore, AdminIssueCategoryStore ownerStore,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityCountiesDesktopTable(
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityCitiesDesktopTable(
                                                          context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityDistrictsDesktopTable(
                                                          context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
