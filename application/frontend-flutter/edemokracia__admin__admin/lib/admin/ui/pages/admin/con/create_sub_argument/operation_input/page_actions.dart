...
class AdminConCreateSubArgumentOperationInputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CreateArgumentInputStore targetStore;
  final AdminConCreateSubArgumentOperationInputPageStore pageStore;
  final AdminConCreateSubArgumentOperationInputConfig pageConfig;

  AdminConCreateSubArgumentOperationInputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
