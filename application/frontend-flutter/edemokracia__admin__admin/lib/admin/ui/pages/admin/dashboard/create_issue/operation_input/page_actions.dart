...
class AdminDashboardCreateIssueOperationInputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCreateIssueInputStore targetStore;
  final AdminDashboardCreateIssueOperationInputPageStore pageStore;
  final AdminDashboardCreateIssueOperationInputConfig pageConfig;

  AdminDashboardCreateIssueOperationInputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
