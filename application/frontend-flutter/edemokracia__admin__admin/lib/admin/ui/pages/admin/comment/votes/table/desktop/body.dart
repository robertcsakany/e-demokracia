...
Widget getAdminCommentVotesTableDesktopPage(
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.commentVotesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminCommentVotesTableVotesListDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
