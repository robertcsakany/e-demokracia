...
class EdemokraciaAdminAdminCategoriesEditSubcategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesEditSubcategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
