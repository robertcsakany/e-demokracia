...
Widget getAdminIssueCategorySubcategoriesUpdateDesktopPage(BuildContext context, AdminIssueCategoryStore targetStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo =
                                  EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesDesktopTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
                                disabled: true,
