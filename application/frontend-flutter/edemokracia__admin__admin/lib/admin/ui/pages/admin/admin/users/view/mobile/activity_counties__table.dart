...
class EdemokraciaAdminAdminUsersViewActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
