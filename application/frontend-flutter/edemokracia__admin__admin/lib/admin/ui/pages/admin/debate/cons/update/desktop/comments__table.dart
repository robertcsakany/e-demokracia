...
class EdemokraciaAdminDebateConsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDebateConsUpdatePageStore pageStore;
  final AdminDebateConsUpdateConfig pageConfig;
