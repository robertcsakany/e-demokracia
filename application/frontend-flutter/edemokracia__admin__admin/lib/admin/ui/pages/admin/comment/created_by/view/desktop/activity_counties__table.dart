...
class EdemokraciaAdminCommentCreatedByViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminCommentCreatedByViewPageStore pageStore;
  final AdminCommentCreatedByViewConfig pageConfig;
