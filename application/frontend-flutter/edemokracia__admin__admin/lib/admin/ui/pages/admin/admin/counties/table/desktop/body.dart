...
Widget getAdminAdminCountiesTableDesktopPage(BuildContext context, AdminAdminCountiesTablePageStore pageStore, AdminAdminCountiesTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminCountiesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminAdminCountiesTableCountyTableDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
