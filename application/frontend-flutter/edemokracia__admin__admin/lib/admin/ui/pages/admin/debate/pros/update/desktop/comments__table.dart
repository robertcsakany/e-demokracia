...
class EdemokraciaAdminDebateProsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDebateProsUpdatePageStore pageStore;
  final AdminDebateProsUpdateConfig pageConfig;
