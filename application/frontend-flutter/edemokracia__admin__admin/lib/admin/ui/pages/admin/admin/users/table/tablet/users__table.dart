...
class EdemokraciaAdminAdminUsersTableUserTableTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersTableUserTableTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
