...
class AdminIssueAttachmentsCreatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminIssueAttachmentStore targetStore;
  final AdminIssueStore ownerStore;
  final AdminIssueAttachmentsCreatePageStore pageStore;
  final AdminIssueAttachmentsCreateConfig pageConfig;

  AdminIssueAttachmentsCreatePageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
