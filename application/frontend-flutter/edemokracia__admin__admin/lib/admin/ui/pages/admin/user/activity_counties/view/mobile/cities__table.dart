...
class EdemokraciaAdminUserActivityCountiesViewCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesViewCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
