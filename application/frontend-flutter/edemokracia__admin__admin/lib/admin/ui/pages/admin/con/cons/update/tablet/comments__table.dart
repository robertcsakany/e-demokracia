...
class EdemokraciaAdminConConsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
