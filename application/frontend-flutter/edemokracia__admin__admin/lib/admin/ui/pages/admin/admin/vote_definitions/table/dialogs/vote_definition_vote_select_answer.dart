...
// Page: edemokracia::admin::Admin.voteDefinitions#Table
// Operation: voteSelectAnswer

part of admin.ui.pages.admin.admin.vote_definitions.table;

class AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogStore extends _AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogStore
    with _$AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogStore {}

abstract class _AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogStore with Store {
...
Future<SelectAnswerVoteSelectionStore> judoSelectAdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialog(
    {@required BuildContext context,
    AdminAdminVoteDefinitionsTablePageStore pageStore,
    AdminVoteDefinitionStore ownerStore,
    bool dialogTypeAdder = false,
    AdminAdminVoteDefinitionsTableConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogStore();
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.voteDefinitionVoteSelectAnswerStoreRangeFuture.status) {
                        ...
                        case FutureStatus.fulfilled:
                          var dataInfo =
                              AdminAdminVoteDefinitionsTableVoteDefinitionVoteSelectAnswerDialogTable(context, pageStore, pageConfig, disabled: false);
