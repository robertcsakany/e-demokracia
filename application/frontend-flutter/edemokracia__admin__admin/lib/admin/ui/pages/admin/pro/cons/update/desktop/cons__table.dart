...
class EdemokraciaAdminProConsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
