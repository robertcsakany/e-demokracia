...
Widget getAdminVoteDefinitionDebateViewTabletPage(BuildContext context, AdminDebateStore targetStore, AdminVoteDefinitionStore ownerStore,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewProsTabletTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 11,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewConsTabletTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                disabled: pageStore.pageState.disabledByLoading,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminVoteDefinitionDebateViewCommentsTabletTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 14,
                                                disabled: pageStore.pageState.disabledByLoading,
