...
class EdemokraciaAdminDebateProsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
