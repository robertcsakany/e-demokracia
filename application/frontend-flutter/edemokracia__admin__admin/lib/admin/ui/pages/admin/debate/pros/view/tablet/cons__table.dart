...
class EdemokraciaAdminDebateProsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
