...
class EdemokraciaAdminIssueCategoriesViewSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategoriesViewSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminIssueCategoriesViewPageStore pageStore;
  final AdminIssueCategoriesViewConfig pageConfig;
