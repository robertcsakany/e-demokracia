...
class EdemokraciaAdminVoteDefinitionDebateTableDebateTableMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateTableDebateTableMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
