...
class EdemokraciaAdminDebateConsViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
