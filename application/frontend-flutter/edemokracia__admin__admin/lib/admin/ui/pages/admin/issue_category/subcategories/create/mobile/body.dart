...
Widget getAdminIssueCategorySubcategoriesCreateMobilePage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueCategoryStore ownerStore,
    AdminIssueCategorySubcategoriesCreatePageStore pageStore, AdminIssueCategorySubcategoriesCreateConfig pageConfig, Map inputWidgetKeyMap) {
                  ...
                  children: [
                    ...
                    Observer(
                        builder: (_) => JudoInputText(
                              ...
                              onBlur: () {
                                validateMissingRequiredAttribute(context, pageStore.validationAttributeErrorMessageMap['description'], targetStore.description);
                    ...
                    Observer(builder: (_) {
                      return JudoLink(
                        ...
                        setAction: targetStore.internal__updatable
                            ? () async {
                                var selected = await judoSelectAdminIssueCategorySubcategoriesCreateOwnerDialog(
                                  context: context,
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo =
                              EdemokraciaAdminIssueCategorySubcategoriesCreateSubcategoriesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 4,
                            disabled: true,
