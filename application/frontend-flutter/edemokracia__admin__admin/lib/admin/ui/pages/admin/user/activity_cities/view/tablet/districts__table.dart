...
class EdemokraciaAdminUserActivityCitiesViewDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCitiesViewDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
