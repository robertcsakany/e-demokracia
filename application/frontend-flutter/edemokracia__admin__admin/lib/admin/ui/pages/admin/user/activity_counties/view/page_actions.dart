...
class AdminUserActivityCountiesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCountyStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserActivityCountiesViewPageStore pageStore;
  final AdminUserActivityCountiesViewConfig pageConfig;

  AdminUserActivityCountiesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        AdminCountyStore cloned = AdminCountyStore.clone(targetStore);
        var res =
            await navigation.open(Routes.adminUserActivityCountiesUpdatePage, arguments: AdminUserActivityCountiesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
            await pageStore.updateCounty(cloned, targetStore);
          } catch (error) {
