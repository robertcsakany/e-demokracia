...
class EdemokraciaAdminAdminCategoriesTableCategoriesListMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesTableCategoriesListMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
