...
class EdemokraciaAdminDashboardCreateIssueOutputAttachmentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputAttachmentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
