...
class EdemokraciaAdminConCreatedByViewActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
