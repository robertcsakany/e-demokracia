...
class EdemokraciaAdminConProsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
