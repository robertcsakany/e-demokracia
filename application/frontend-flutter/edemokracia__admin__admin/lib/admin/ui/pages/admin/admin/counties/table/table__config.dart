...
// Page: edemokracia::admin::Admin.counties#Table

part of admin.ui.pages.admin.admin.counties.table;

class AdminAdminCountiesTableAdminAdminCountiesTableConfig extends TableConfig {
  AdminAdminCountiesTablePageAdminAdminCountiesTableDataCell nameDataCell;

  AdminAdminCountiesTablePageAdminAdminCountiesTableDataCellOnTap nameDataCellOnTap;

  AdminAdminCountiesTableAdminAdminCountiesTableConfig({
    this.nameDataCell,
