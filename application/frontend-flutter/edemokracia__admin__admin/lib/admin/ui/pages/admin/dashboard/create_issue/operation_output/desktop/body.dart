...
Widget getAdminDashboardCreateIssueOperationOutputDesktopPage(BuildContext context, AdminIssueStore targetStore,
    AdminDashboardCreateIssueOperationOutputPageStore pageStore, AdminDashboardCreateIssueOperationOutputConfig pageConfig) {
              ...
              children: [
                ...
                JudoColumn(
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(col: 12.0, row: 14.0, order: 8, tabContent: [
                        JudoRow(
                          mainAxisAlignment: MainAxisAlignment.start,
                          col: 12.0,
                          row: 13.0,
                          children: [
                            JudoColumn(
                              ...
                              children: [
                                ...
                                Observer(builder: (_) {
                                  var dataInfo =
                                      EdemokraciaAdminDashboardCreateIssueOutputAttachmentsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                  return JudoTable(
                                    key: UniqueKey(),
                                    order: 9,
                          ...
                          children: [
                            JudoColumn(
                              ...
                              children: [
                                ...
                                Observer(builder: (_) {
                                  var dataInfo =
                                      EdemokraciaAdminDashboardCreateIssueOutputCategoriesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                  return JudoTable(
                                    key: UniqueKey(),
                                    order: 10,
                                    disabled: pageStore.pageState.disabledByLoading,
                          ...
                          children: [
                            JudoColumn(
                              ...
                              children: [
                                ...
                                Observer(builder: (_) {
                                  var dataInfo = EdemokraciaAdminDashboardCreateIssueOutputDebatesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                  return JudoTable(
                                    key: UniqueKey(),
                                    order: 11,
                                    disabled: pageStore.pageState.disabledByLoading,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDashboardCreateIssueOutputCommentsDesktopTable(context, pageStore, pageConfig,
                                                  disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 13,
                                                    ...
                                                    ? (element) async {
                                                        if (element != null) {
                                                          await navigation.open(Routes.adminIssueCommentsViewPage,
                                                              arguments: AdminIssueCommentsViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                          try {
                                                            await pageStore.refreshIssue(targetStore);
                                                          } catch (error) {
                                                            messageHandler.handleApiException(context, error, 'View');
