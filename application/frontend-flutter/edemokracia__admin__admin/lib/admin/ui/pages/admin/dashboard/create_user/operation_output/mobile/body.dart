...
Widget getAdminDashboardCreateUserOperationOutputMobilePage(BuildContext context, AdminUserStore targetStore,
                            ...
                            JudoColumn(
                              ...
                              children: [
                                ...
                                JudoRow(
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(col: 4.0, row: 11.0, order: 13, tabContent: [
                                        JudoRow(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          col: 4.0,
                                          row: 10.0,
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCountiesMobileTable(
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCitiesMobileTable(
                                                              context, pageStore, pageConfig,
                                                              disabled: false);
                                                          return JudoTable(
                                                            key: UniqueKey(),
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityDistrictsMobileTable(
                                                              context, pageStore, pageConfig,
                                                              disabled: false);
                                                          return JudoTable(
                                                            key: UniqueKey(),
