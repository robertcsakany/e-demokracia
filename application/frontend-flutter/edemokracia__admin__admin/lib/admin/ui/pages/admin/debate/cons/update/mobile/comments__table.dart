...
class EdemokraciaAdminDebateConsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
