...
class EdemokraciaAdminProProsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
