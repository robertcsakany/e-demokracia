...
class AdminProCreatedByViewPageActions extends PageActions {
  ...
  AdminProCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
