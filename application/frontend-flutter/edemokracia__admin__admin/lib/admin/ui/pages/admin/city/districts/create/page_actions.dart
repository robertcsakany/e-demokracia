...
class AdminCityDistrictsCreatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminDistrictStore targetStore;
  final AdminCityStore ownerStore;
  final AdminCityDistrictsCreatePageStore pageStore;
  final AdminCityDistrictsCreateConfig pageConfig;

  AdminCityDistrictsCreatePageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
