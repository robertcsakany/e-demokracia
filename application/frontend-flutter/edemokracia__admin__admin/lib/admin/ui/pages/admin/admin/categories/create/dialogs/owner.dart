...
class AdminAdminCategoriesCreateOwnerDialogStore extends _AdminAdminCategoriesCreateOwnerDialogStore with _$AdminAdminCategoriesCreateOwnerDialogStore {}

abstract class _AdminAdminCategoriesCreateOwnerDialogStore with Store {
...
Future<AdminUserStore> judoSelectAdminAdminCategoriesCreateOwnerDialog(
    {@required BuildContext context,
    AdminAdminCategoriesCreatePageStore pageStore,
    AdminIssueCategoryStore ownerStore,
    bool dialogTypeAdder = false,
    AdminAdminCategoriesCreateConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminAdminCategoriesCreateOwnerDialogStore();
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.issueCategoryOwnerStoreRangeFuture.status) {
                        ...
                        case FutureStatus.fulfilled:
                          var dataInfo = AdminAdminCategoriesCreateOwnerDialogTable(context, pageStore, pageConfig, disabled: false);
