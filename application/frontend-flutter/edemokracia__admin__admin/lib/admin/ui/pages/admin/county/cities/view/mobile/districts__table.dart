...
class EdemokraciaAdminCountyCitiesViewDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesViewDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
