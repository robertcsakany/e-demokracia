...
class EdemokraciaAdminConProsViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
