...
class EdemokraciaAdminAdminIssuesViewAttachmentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewAttachmentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
