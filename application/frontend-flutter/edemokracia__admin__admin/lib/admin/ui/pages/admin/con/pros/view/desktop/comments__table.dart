...
class EdemokraciaAdminConProsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
