...
class EdemokraciaAdminDebateConsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
