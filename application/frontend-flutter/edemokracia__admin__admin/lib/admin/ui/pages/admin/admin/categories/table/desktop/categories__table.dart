...
class EdemokraciaAdminAdminCategoriesTableCategoriesListDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesTableCategoriesListDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
