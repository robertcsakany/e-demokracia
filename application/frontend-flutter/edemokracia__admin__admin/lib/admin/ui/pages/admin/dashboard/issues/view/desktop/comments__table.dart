...
class EdemokraciaAdminDashboardIssuesViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDashboardIssuesViewPageStore pageStore;
  final AdminDashboardIssuesViewConfig pageConfig;
