...
class EdemokraciaAdminAdminCategoriesViewSubcategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesViewSubcategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
