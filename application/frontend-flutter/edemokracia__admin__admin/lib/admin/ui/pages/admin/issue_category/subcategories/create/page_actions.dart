...
class AdminIssueCategorySubcategoriesCreatePageActions extends PageActions {
  ...
  AdminIssueCategorySubcategoriesCreatePageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
