...
class EdemokraciaAdminProCreatedByViewActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
