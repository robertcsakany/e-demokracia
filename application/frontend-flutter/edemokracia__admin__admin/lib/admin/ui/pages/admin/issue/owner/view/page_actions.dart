...
class AdminIssueOwnerViewPageActions extends PageActions {
  ...
  AdminIssueOwnerViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
