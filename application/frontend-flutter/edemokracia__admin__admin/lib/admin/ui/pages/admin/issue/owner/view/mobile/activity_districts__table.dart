...
class EdemokraciaAdminIssueOwnerViewActivityDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
