...
class EdemokraciaAdminIssueCategorySubcategoriesCreateSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategorySubcategoriesCreateSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminIssueCategorySubcategoriesCreatePageStore pageStore;
  final AdminIssueCategorySubcategoriesCreateConfig pageConfig;
