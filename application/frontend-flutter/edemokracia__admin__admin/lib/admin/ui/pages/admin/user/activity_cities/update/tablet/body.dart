...
Widget getAdminUserActivityCitiesUpdateTabletPage(BuildContext context, AdminCityStore targetStore, AdminUserActivityCitiesUpdatePageStore pageStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminUserActivityCitiesEditDistrictsTabletTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
                                disabled: true,
