...
class EdemokraciaAdminDashboardIssuesViewCategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
