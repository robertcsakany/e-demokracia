...
class EdemokraciaAdminConConsViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
