...
class EdemokraciaAdminAdminDashboardhomeDashboardDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
