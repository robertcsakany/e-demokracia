...
class AdminConCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCommentStore targetStore;
  final AdminConStore ownerStore;
  final AdminConCommentsViewPageStore pageStore;
  final AdminConCommentsViewConfig pageConfig;

  AdminConCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
