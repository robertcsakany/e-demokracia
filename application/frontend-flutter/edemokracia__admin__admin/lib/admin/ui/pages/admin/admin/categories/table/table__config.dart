...
// Page: edemokracia::admin::Admin.categories#Table

part of admin.ui.pages.admin.admin.categories.table;

class AdminAdminCategoriesTableAdminAdminCategoriesTableConfig extends TableConfig {
  AdminAdminCategoriesTablePageAdminAdminCategoriesTableDataCell titleDataCell;

  AdminAdminCategoriesTablePageAdminAdminCategoriesTableDataCellOnTap titleDataCellOnTap;
  AdminAdminCategoriesTablePageAdminAdminCategoriesTableDataCell descriptionDataCell;

  AdminAdminCategoriesTablePageAdminAdminCategoriesTableDataCellOnTap descriptionDataCellOnTap;

  AdminAdminCategoriesTableAdminAdminCategoriesTableConfig({
    this.titleDataCell,
