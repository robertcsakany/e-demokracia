...
class AdminDashboardCreateIssueOperationOutputPageActions extends PageActions {
  ...
  AdminDashboardCreateIssueOperationOutputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
