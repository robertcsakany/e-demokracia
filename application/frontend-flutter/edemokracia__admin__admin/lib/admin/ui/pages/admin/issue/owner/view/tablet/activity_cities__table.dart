...
class EdemokraciaAdminIssueOwnerViewActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
