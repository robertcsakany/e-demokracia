...
// Page: edemokracia::admin::Admin.counties#View

part of admin.ui.pages.admin.admin.counties.view;

class AdminAdminCountiesViewAdminCountyCitiesTableConfig extends TableConfig {
  AdminAdminCountiesViewPageAdminCountyCitiesTableDataCell nameDataCell;

  AdminAdminCountiesViewPageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminAdminCountiesViewAdminCountyCitiesTableConfig({
    this.nameDataCell,
