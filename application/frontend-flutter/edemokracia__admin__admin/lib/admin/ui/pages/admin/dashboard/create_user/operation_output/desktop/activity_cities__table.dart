...
class EdemokraciaAdminDashboardCreateUserOutputActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateUserOutputActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
