...
class EdemokraciaAdminAdminDebatesEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
