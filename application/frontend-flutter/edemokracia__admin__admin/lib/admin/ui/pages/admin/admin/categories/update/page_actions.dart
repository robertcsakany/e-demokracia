...
class AdminAdminCategoriesUpdatePageActions extends PageActions {
  ...
  AdminAdminCategoriesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
