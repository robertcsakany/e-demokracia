...
// Page: edemokracia::admin::Debate.comments#View

part of admin.ui.pages.admin.debate.comments.view;

class AdminDebateCommentsViewAdminCommentCreatedByTableConfig extends TableConfig {
  AdminDebateCommentsViewPageAdminCommentCreatedByTableDataCell representationDataCell;

  AdminDebateCommentsViewAdminCommentCreatedByTableConfig({
