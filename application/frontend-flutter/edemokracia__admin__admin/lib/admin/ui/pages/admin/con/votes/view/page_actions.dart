...
class AdminConVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminConStore ownerStore;
  final AdminConVotesViewPageStore pageStore;
  final AdminConVotesViewConfig pageConfig;

  AdminConVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
