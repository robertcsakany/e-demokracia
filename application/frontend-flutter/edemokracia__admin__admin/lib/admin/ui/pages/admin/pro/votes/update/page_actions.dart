...
class AdminProVotesUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminProVotesUpdatePageStore pageStore;
  final AdminProVotesUpdateConfig pageConfig;

  AdminProVotesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
