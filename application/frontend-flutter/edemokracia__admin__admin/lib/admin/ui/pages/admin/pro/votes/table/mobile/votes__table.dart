...
class EdemokraciaAdminProVotesTableVotesListMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProVotesTableVotesListMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
