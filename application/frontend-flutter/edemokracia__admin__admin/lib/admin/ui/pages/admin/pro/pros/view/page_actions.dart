...
class AdminProProsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminProStore targetStore;
  final AdminProStore ownerStore;
  final AdminProProsViewPageStore pageStore;
  final AdminProProsViewConfig pageConfig;

  AdminProProsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminProProsUpdatePage, arguments: AdminProProsUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
