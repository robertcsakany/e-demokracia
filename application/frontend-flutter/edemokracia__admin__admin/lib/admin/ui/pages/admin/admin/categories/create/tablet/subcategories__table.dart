...
class EdemokraciaAdminAdminCategoriesCreateSubcategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesCreateSubcategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
