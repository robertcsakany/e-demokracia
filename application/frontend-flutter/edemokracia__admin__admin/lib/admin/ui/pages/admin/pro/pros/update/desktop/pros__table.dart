...
class EdemokraciaAdminProProsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
