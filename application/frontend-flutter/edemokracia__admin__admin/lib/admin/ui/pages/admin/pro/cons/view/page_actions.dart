...
class AdminProConsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminConStore targetStore;
  final AdminProStore ownerStore;
  final AdminProConsViewPageStore pageStore;
  final AdminProConsViewConfig pageConfig;

  AdminProConsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminProConsUpdatePage, arguments: AdminProConsUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
