...
class EdemokraciaAdminProConsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
