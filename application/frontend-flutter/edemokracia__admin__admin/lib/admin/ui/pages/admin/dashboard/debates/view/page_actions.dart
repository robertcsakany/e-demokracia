...
class AdminDashboardDebatesViewPageActions extends PageActions {
  ...
  AdminDashboardDebatesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
