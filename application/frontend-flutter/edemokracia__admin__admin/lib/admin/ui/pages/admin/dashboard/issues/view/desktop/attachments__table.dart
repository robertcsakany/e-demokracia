...
class EdemokraciaAdminDashboardIssuesViewAttachmentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewAttachmentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
