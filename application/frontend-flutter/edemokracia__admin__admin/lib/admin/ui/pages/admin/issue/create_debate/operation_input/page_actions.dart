...
class AdminIssueCreateDebateOperationInputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CreateDebateInputStore targetStore;
  final AdminIssueCreateDebateOperationInputPageStore pageStore;
  final AdminIssueCreateDebateOperationInputConfig pageConfig;

  AdminIssueCreateDebateOperationInputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
