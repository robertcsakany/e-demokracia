...
class EdemokraciaAdminConConsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
