...
class EdemokraciaAdminAdminDashboardhomeDashboardIssuesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardIssuesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
