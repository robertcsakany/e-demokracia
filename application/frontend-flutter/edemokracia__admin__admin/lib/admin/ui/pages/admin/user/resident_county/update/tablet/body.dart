...
Widget getAdminUserResidentCountyUpdateTabletPage(BuildContext context, AdminCountyStore targetStore, AdminUserResidentCountyUpdatePageStore pageStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserResidentCountyEditCitiesTabletTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
