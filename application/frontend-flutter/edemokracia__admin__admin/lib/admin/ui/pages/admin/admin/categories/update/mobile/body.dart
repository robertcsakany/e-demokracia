...
Widget getAdminAdminCategoriesUpdateMobilePage(BuildContext context, AdminIssueCategoryStore targetStore, AdminAdminCategoriesUpdatePageStore pageStore,
    AdminAdminCategoriesUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                  ...
                  children: [
                    ...
                    Observer(builder: (_) {
                      return JudoLink(
                        ...
                        setAction: targetStore.internal__updatable
                            ? () async {
                                var selected = await judoSelectAdminAdminCategoriesUpdateOwnerDialog(
                                  context: context,
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminAdminCategoriesEditSubcategoriesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 4,
                            disabled: true,
