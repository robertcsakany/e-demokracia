...
Widget getAdminAdminDashboardhomeViewDesktopPage(
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminAdminDashboardhomeViewIssuesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 2,
                                  ...
                                  children: [
                                    JudoColumn(
                                      ...
                                      children: [
                                        ...
                                        Observer(builder: (_) {
                                          var dataInfo =
                                              EdemokraciaAdminAdminDashboardhomeViewDebatesDesktopTable(context, pageStore, pageConfig, disabled: false);
                                          return JudoTable(
                                            key: UniqueKey(),
                                            order: 3,
                                            disabled: pageStore.pageState.disabledByLoading,
