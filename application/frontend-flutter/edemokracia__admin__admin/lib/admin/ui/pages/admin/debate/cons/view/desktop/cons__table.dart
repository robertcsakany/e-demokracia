...
class EdemokraciaAdminDebateConsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
