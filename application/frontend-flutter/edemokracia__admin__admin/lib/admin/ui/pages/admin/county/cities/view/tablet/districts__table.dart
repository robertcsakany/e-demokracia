...
class EdemokraciaAdminCountyCitiesViewDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesViewDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
