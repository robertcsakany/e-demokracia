...
class AdminIssueAttachmentsUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminIssueAttachmentStore targetStore;
  final AdminIssueAttachmentsUpdatePageStore pageStore;
  final AdminIssueAttachmentsUpdateConfig pageConfig;

  AdminIssueAttachmentsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
