...
class EdemokraciaAdminConConsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
