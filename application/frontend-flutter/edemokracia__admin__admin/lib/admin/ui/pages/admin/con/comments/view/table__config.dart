...
// Page: edemokracia::admin::Con.comments#View

part of admin.ui.pages.admin.con.comments.view;

class AdminConCommentsViewAdminCommentCreatedByTableConfig extends TableConfig {
  AdminConCommentsViewPageAdminCommentCreatedByTableDataCell representationDataCell;

  AdminConCommentsViewAdminCommentCreatedByTableConfig({
