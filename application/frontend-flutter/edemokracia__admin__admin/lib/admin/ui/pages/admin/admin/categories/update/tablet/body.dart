...
Widget getAdminAdminCategoriesUpdateTabletPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminAdminCategoriesUpdatePageStore pageStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminAdminCategoriesEditSubcategoriesTabletTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
                                disabled: true,
