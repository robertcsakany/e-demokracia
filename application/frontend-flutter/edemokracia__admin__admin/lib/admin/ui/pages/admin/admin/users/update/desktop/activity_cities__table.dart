...
class EdemokraciaAdminAdminUsersEditActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
