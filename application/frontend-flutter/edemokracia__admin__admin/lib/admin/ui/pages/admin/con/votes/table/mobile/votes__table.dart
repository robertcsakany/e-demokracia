...
class EdemokraciaAdminConVotesTableVotesListMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConVotesTableVotesListMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
