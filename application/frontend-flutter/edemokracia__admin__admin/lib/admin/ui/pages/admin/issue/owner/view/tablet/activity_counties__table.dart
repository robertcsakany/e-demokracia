...
class EdemokraciaAdminIssueOwnerViewActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
