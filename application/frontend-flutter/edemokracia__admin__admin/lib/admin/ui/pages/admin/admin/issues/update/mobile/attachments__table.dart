...
class EdemokraciaAdminAdminIssuesEditAttachmentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditAttachmentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
