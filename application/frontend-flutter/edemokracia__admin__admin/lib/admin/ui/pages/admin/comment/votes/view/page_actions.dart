...
class AdminCommentVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminCommentStore ownerStore;
  final AdminCommentVotesViewPageStore pageStore;
  final AdminCommentVotesViewConfig pageConfig;

  AdminCommentVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminCommentVotesUpdatePage, arguments: AdminCommentVotesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
