...
Widget getAdminDashboardDebatesViewMobilePage(BuildContext context, AdminDebateStore targetStore, AdminDashboardStore ownerStore,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminDashboardDebatesViewProsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 11,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminDashboardDebatesViewConsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                disabled: pageStore.pageState.disabledByLoading,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminDashboardDebatesViewCommentsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 14,
                                                disabled: pageStore.pageState.disabledByLoading,
