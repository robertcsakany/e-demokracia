...
class AdminIssueCategorySubcategoriesUpdateOwnerDialogTable implements JudoTableDataInfo {
  const AdminIssueCategorySubcategoriesUpdateOwnerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
