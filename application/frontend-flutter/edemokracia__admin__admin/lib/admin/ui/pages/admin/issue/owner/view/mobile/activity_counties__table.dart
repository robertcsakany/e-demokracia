...
class EdemokraciaAdminIssueOwnerViewActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
