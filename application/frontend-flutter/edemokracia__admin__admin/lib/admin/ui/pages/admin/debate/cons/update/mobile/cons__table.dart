...
class EdemokraciaAdminDebateConsEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
