...
class EdemokraciaAdminAdminUsersEditActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
