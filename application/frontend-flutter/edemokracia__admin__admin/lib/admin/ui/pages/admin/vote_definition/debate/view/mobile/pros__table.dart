...
class EdemokraciaAdminVoteDefinitionDebateViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
