...
Widget getAdminDebateProsViewDesktopPage(BuildContext context, AdminProStore targetStore, AdminDebateStore ownerStore, AdminDebateProsViewPageStore pageStore,
    AdminDebateProsViewConfig pageConfig) {
                  ...
                  children: [
                                          ...
                                          targetStore.createdBy != null
                                              ? IconButton(
                                                  ...
                                                  onPressed: pageStore.pageState.disabledByLoading
                                                      ? null
                                                      : () async {
                                                          var response = await navigation.open(Routes.adminProCreatedByViewPage,
                                                              arguments: AdminProCreatedByViewPageArguments(
                                  ...
                                  children: [
                                    Observer(
                                        builder: (_) => JudoButton(
                                              ...
                                              onPressed: () async {
                                                try {
                                                  await pageStore.edemokraciaAdminProVoteUp(targetStore);
                                    ...
                                    Observer(
                                        builder: (_) => JudoButton(
                                              ...
                                              onPressed: () async {
                                                try {
                                                  await pageStore.edemokraciaAdminProVoteDown(targetStore);
                                    ...
                                    Observer(
                                        builder: (_) => JudoButton(
                                              ...
                                              disabled: pageStore.pageState.disabledByLoading || false,
                                              onPressed: () async {
                                                await navigation.open(Routes.adminProVotesTablePage,
                                                    arguments: AdminProVotesTablePageArguments(ownerStore: targetStore));
                                              },
                                            )),
                                    JudoSpacer(
                                      col: 4.0,
                    ...
                    Observer(
                      builder: (_) => JudoTab(
                          ...
                          row: 54.0,
                          order: 10,
                          tabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Debate::pros_tabBar').tabIndex,
                          setTabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Debate::pros_tabBar').setTabIndex,
                          tabContent: [
                            JudoRow(
                              mainAxisAlignment: MainAxisAlignment.start,
                              col: 12.0,
                                                ...
                                                builder: (_) => JudoButton(
                                                      ...
                                                      onPressed: () async {
                                                        var ret = await navigation.open(Routes.adminProCreateSubArgumentOperationInputPage, arguments:
                                                          ...
                                                          try {
                                                            await pageStore.edemokraciaAdminProCreateSubArgument(input, targetStore);
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsViewProsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                ...
                                                navigateToViewPageAction: pageConfig.prosTableConfig.rowClickNavigate
                                                    ? (element) async {
                                                        if (element != null) {
                                                          await navigation.open(Routes.adminProProsViewPage,
                                                              arguments: AdminProProsViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                          try {
                                                            await pageStore.refreshPro(targetStore);
                                                          } catch (error) {
                                                            messageHandler.handleApiException(context, error, 'View');
                                                ...
                                                rowActionList: [
                                                  TableRowAction(
                                                    ...
                                                    action: (element) async {
                                                      ...
                                                      var res = await navigation.open(Routes.adminProProsUpdatePage,
                                                          arguments: AdminProProsUpdatePageArguments(targetStore: cloned));
                                                      if (res != null) {
                                                        try {
                                        ...
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsViewConsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 13,
                                                disabled: pageStore.pageState.disabledByLoading,
                                                ...
                                                navigateToViewPageAction: pageConfig.consTableConfig.rowClickNavigate
                                                    ? (element) async {
                                                        if (element != null) {
                                                          await navigation.open(Routes.adminProConsViewPage,
                                                              arguments: AdminProConsViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                          try {
                                                            await pageStore.refreshPro(targetStore);
                                                          } catch (error) {
                                                            messageHandler.handleApiException(context, error, 'View');
                                                ...
                                                rowActionList: [
                                                  TableRowAction(
                                                    ...
                                                    action: (element) async {
                                                      ...
                                                      var res = await navigation.open(Routes.adminProConsUpdatePage,
                                                          arguments: AdminProConsUpdatePageArguments(targetStore: cloned));
                                                      if (res != null) {
                                                        try {
                                                ...
                                                builder: (_) => JudoButton(
                                                      ...
                                                      onPressed: () async {
                                                        var ret = await navigation.open(Routes.adminProCreateCommentOperationInputPage, arguments:
                                                          ...
                                                          try {
                                                            await pageStore.edemokraciaAdminProCreateComment(input, targetStore);
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminDebateProsViewCommentsDesktopTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 15,
                                                disabled: pageStore.pageState.disabledByLoading,
                                                ...
                                                navigateToViewPageAction: pageConfig.commentsTableConfig.rowClickNavigate
                                                    ? (element) async {
                                                        if (element != null) {
                                                          await navigation.open(Routes.adminProCommentsViewPage,
                                                              arguments: AdminProCommentsViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                          try {
                                                            await pageStore.refreshPro(targetStore);
                                                          } catch (error) {
                                                            messageHandler.handleApiException(context, error, 'View');
