...
Widget getAdminCountyCitiesUpdateTabletPage(BuildContext context, AdminCityStore targetStore, AdminCountyCitiesUpdatePageStore pageStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminCountyCitiesEditDistrictsTabletTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
                                disabled: true,
