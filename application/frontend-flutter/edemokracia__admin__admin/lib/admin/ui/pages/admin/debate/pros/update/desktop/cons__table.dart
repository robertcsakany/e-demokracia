...
class EdemokraciaAdminDebateProsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
