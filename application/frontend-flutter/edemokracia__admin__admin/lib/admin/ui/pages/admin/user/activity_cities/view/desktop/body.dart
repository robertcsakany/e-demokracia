...
Widget getAdminUserActivityCitiesViewDesktopPage(BuildContext context, AdminCityStore targetStore, AdminUserStore ownerStore,
    AdminUserActivityCitiesViewPageStore pageStore, AdminUserActivityCitiesViewConfig pageConfig) {
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminUserActivityCitiesViewDistrictsDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
