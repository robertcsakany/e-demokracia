...
class EdemokraciaAdminUserActivityCountiesViewCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesViewCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
