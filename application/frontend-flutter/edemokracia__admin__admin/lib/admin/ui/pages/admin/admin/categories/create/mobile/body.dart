...
Widget getAdminAdminCategoriesCreateMobilePage(BuildContext context, AdminIssueCategoryStore targetStore, AdminAdminCategoriesCreatePageStore pageStore,
    AdminAdminCategoriesCreateConfig pageConfig, Map inputWidgetKeyMap) {
                  ...
                  children: [
                    ...
                    Observer(builder: (_) {
                      return JudoLink(
                        ...
                        setAction: targetStore.internal__updatable
                            ? () async {
                                var selected = await judoSelectAdminAdminCategoriesCreateOwnerDialog(
                                  context: context,
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminAdminCategoriesCreateSubcategoriesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 4,
                            disabled: true,
