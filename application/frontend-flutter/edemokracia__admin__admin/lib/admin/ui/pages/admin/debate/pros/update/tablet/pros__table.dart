...
class EdemokraciaAdminDebateProsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
