...
class EdemokraciaAdminProCreatedByViewActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
