...
class EdemokraciaAdminConConsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
