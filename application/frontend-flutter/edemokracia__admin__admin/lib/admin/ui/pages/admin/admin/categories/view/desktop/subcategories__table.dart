...
class EdemokraciaAdminAdminCategoriesViewSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesViewSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
