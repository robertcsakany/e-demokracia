...
class EdemokraciaAdminAdminIssuesEditAttachmentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditAttachmentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
