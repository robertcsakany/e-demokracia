...
Widget getAdminAdminUsersUpdateTabletPage(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityCountiesTabletTable(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityCitiesTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminAdminUsersEditActivityDistrictsTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
