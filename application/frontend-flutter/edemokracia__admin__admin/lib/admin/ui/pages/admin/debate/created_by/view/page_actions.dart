...
class AdminDebateCreatedByViewPageActions extends PageActions {
  ...
  AdminDebateCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
