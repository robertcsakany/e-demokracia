...
Widget getAdminDashboardCreateUserOperationOutputDesktopPage(BuildContext context, AdminUserStore targetStore,
    AdminDashboardCreateUserOperationOutputPageStore pageStore, AdminDashboardCreateUserOperationOutputConfig pageConfig) {
                            ...
                            JudoColumn(
                              ...
                              children: [
                                ...
                                JudoRow(
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(col: 12.0, row: 11.0, order: 13, tabContent: [
                                        JudoRow(
                                          mainAxisAlignment: MainAxisAlignment.start,
                                          col: 12.0,
                                          row: 10.0,
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCountiesDesktopTable(
                                                  ...
                                                  return JudoTable(
                                                    ...
                                                    onSort: (int columnIndex, bool asc) {
                                                      pageStore.activityCountiesSetSort(context, dataInfo.getColumnFieldByIndex(columnIndex), columnIndex, asc,
                                          ...
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityCitiesDesktopTable(
                                                      context, pageStore, pageConfig,
                                                      disabled: false);
                                                  return JudoTable(
                                                    key: UniqueKey(),
                                                    ...
                                                    sortInitially: true,
                                                    onSort: (int columnIndex, bool asc) {
                                                      pageStore.activityCitiesSetSort(context, dataInfo.getColumnFieldByIndex(columnIndex), columnIndex, asc,
                                                          TableUtility.getSortComparator(columnIndex, asc, dataInfo), targetStore);
                                                    },
                                                        ...
                                                        ? (element) async {
                                                            if (element != null) {
                                                              await navigation.open(Routes.adminUserActivityCitiesViewPage,
                                                                  arguments:
                                                                      AdminUserActivityCitiesViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                              try {
                                                                await pageStore.refreshUser(targetStore);
                                                              } catch (error) {
                                                                messageHandler.handleApiException(context, error, 'View');
                                          ...
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo = EdemokraciaAdminDashboardCreateUserOutputActivityDistrictsDesktopTable(
                                                      context, pageStore, pageConfig,
                                                      disabled: false);
                                                  return JudoTable(
                                                    key: UniqueKey(),
                                                    ...
                                                    sortInitially: true,
                                                    onSort: (int columnIndex, bool asc) {
                                                      pageStore.activityDistrictsSetSort(context, dataInfo.getColumnFieldByIndex(columnIndex), columnIndex, asc,
                                                          TableUtility.getSortComparator(columnIndex, asc, dataInfo), targetStore);
                                                    },
