...
class AdminIssueCategoriesViewPageActions extends PageActions {
  ...
  AdminIssueCategoriesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
