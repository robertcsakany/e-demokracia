...
class EdemokraciaAdminVoteDefinitionDebateViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
