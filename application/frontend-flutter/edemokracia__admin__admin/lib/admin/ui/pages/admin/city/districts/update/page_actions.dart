...
class AdminCityDistrictsUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminDistrictStore targetStore;
  final AdminCityDistrictsUpdatePageStore pageStore;
  final AdminCityDistrictsUpdateConfig pageConfig;

  AdminCityDistrictsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
