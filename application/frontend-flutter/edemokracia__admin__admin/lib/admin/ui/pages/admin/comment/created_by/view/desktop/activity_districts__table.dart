...
class EdemokraciaAdminCommentCreatedByViewActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
