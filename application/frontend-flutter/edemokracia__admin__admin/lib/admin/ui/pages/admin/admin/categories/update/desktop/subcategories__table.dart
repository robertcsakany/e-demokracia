...
class EdemokraciaAdminAdminCategoriesEditSubcategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCategoriesEditSubcategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
