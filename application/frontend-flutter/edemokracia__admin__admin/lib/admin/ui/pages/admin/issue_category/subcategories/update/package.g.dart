...
mixin _$AdminIssueCategorySubcategoriesUpdatePageStore on _AdminIssueCategorySubcategoriesUpdatePageStore, Store {
  ...
  int get subcategoriesTableItemsRangeStart => (_$subcategoriesTableItemsRangeStartComputed ??= Computed<int>(() => super.subcategoriesTableItemsRangeStart,
          name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTableItemsRangeStart'))
      .value;
  ...
  int get subcategoriesTableItemsRangeEnd => (_$subcategoriesTableItemsRangeEndComputed ??=
          Computed<int>(() => super.subcategoriesTableItemsRangeEnd, name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTableItemsRangeEnd'))
      .value;
  ...
  bool get subcategoriesTablePreviousEnable => (_$subcategoriesTablePreviousEnableComputed ??= Computed<bool>(() => super.subcategoriesTablePreviousEnable,
          name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTablePreviousEnable'))
      .value;
  ...
  bool get subcategoriesTableNextEnable => (_$subcategoriesTableNextEnableComputed ??=
          Computed<bool>(() => super.subcategoriesTableNextEnable, name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTableNextEnable'))
      .value;
  ...
  List<AdminIssueCategoryStore> get subcategoriesTablePagingList =>
      (_$subcategoriesTablePagingListComputed ??= Computed<List<AdminIssueCategoryStore>>(() => super.subcategoriesTablePagingList,
              name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTablePagingList'))
          .value;
  ...
  int get ownerTableForRangeItemsRangeStart => (_$ownerTableForRangeItemsRangeStartComputed ??= Computed<int>(() => super.ownerTableForRangeItemsRangeStart,
          name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerTableForRangeItemsRangeStart'))
      .value;
  ...
  int get ownerTableForRangeItemsRangeEnd => (_$ownerTableForRangeItemsRangeEndComputed ??=
          Computed<int>(() => super.ownerTableForRangeItemsRangeEnd, name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerTableForRangeItemsRangeEnd'))
      .value;
  ...
  bool get previousButtonEnableForOwnerRange => (_$previousButtonEnableForOwnerRangeComputed ??= Computed<bool>(() => super.previousButtonEnableForOwnerRange,
          name: '_AdminIssueCategorySubcategoriesUpdatePageStore.previousButtonEnableForOwnerRange'))
      .value;

  final _$targetStoreAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.targetStore');
  ...
  final _$subcategoriesTablePageNumberAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTablePageNumber');
  ...
  final _$issueCategoryOwnerStoreRangeFutureAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.issueCategoryOwnerStoreRangeFuture');
  ...
  final _$ownerSortColumnIndexRangeAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerSortColumnIndexRange');
  ...
  final _$ownerSortColumnNameRangeAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerSortColumnNameRange');
  ...
  final _$ownerSortAscRangeAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerSortAscRange');
  ...
  final _$ownerStoreRangeListAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerStoreRangeList');
  ...
  final _$nextButtonEnableForOwnerRangeAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.nextButtonEnableForOwnerRange');
  ...
  final _$nextPageCounterForOwnerRangeAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.nextPageCounterForOwnerRange');
  ...
  final _$issueCategoryOwnerStoreFutureAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.issueCategoryOwnerStoreFuture');
  ...
  final _$subcategoriesSortColumnIndexAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesSortColumnIndex');
  ...
  final _$subcategoriesSortColumnNameAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesSortColumnName');
  ...
  final _$subcategoriesSortAscAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesSortAsc');
  ...
  final _$subcategoriesSortCompareAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesSortCompare');
  ...
  final _$issueCategorySubcategoriesStoreFutureAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdatePageStore.issueCategorySubcategoriesStoreFuture');
  ...
  final _$refreshIssueCategoryAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.refreshIssueCategory');
  ...
  final _$validateAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.validate');
  ...
  final _$uploadFileAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.uploadFile');
  ...
  final _$downloadFileAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.downloadFile');
  ...
  final _$getRangeForOwnerAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.getRangeForOwner');
  ...
  final _$setOwnerAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.setOwner');
  ...
  final _$unsetOwnerAsyncAction = AsyncAction('_AdminIssueCategorySubcategoriesUpdatePageStore.unsetOwner');
  ...
  final _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController = ActionController(name: '_AdminIssueCategorySubcategoriesUpdatePageStore');

  @override
  void initSortAggregatedLists(BuildContext context, AdminIssueCategorySubcategoriesUpdateConfig pageConfig) {
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdatePageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void subcategoriesTableNextPage() {
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTableNextPage');
    try {
  ...
  void subcategoriesTablePreviousPage() {
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesTablePreviousPage');
    try {
  ...
  void ownerSetSortRange(AdminIssueCategoryStore ownerStore, BuildContext context, String sortColumnName, int sortColumnIndex, bool asc,
    ...
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdatePageStore.ownerSetSortRange');
    try {
  ...
  void subcategoriesSetSort(
    ...
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdatePageStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdatePageStore.subcategoriesSetSort');
    try {
...
mixin _$AdminIssueCategorySubcategoriesUpdateOwnerDialogStore on _AdminIssueCategorySubcategoriesUpdateOwnerDialogStore, Store {
  Computed<double> _$getInputWidgetsHeightComputed;

  @override
  double get getInputWidgetsHeight => (_$getInputWidgetsHeightComputed ??=
          Computed<double>(() => super.getInputWidgetsHeight, name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.getInputWidgetsHeight'))
      .value;
  Computed<bool> _$searchButtonEnabledComputed;

  @override
  bool get searchButtonEnabled => (_$searchButtonEnabledComputed ??=
          Computed<bool>(() => super.searchButtonEnabled, name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.searchButtonEnabled'))
      .value;
  ...
  double get filterWidgetsColumnHeight => (_$filterWidgetsColumnHeightComputed ??=
          Computed<double>(() => super.filterWidgetsColumnHeight, name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.filterWidgetsColumnHeight'))
      .value;

  final _$availableFilterListAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.availableFilterList');
  ...
  final _$numberOfColumnsAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.numberOfColumns');
  ...
  final _$numberOfColumnsAfterFilterHorizontalAtom = Atom(name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.numberOfColumnsAfterFilterHorizontal');
  ...
  final _$_AdminIssueCategorySubcategoriesUpdateOwnerDialogStoreActionController =
      ActionController(name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore');

  @override
  void addNewFilter(FilterStore newFilterStore) {
    final _$actionInfo = _$_AdminIssueCategorySubcategoriesUpdateOwnerDialogStoreActionController.startAction(
        name: '_AdminIssueCategorySubcategoriesUpdateOwnerDialogStore.addNewFilter');
    try {
      return super.addNewFilter(newFilterStore);
    } finally {
      _$_AdminIssueCategorySubcategoriesUpdateOwnerDialogStoreActionController.endAction(_$actionInfo);
    }
  }
