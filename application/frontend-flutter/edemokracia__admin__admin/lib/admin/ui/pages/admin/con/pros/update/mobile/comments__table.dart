...
class EdemokraciaAdminConProsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
