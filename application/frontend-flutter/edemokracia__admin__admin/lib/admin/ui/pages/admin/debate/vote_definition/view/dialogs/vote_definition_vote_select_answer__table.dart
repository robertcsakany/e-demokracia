...
class AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogTable implements JudoTableDataInfo {
  const AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDebateVoteDefinitionViewPageStore pageStore;
  final AdminDebateVoteDefinitionViewConfig pageConfig;
