...
class EdemokraciaAdminConConsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
