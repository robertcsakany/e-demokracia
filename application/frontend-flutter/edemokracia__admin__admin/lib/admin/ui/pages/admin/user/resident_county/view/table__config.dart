...
// Page: edemokracia::admin::User.residentCounty#View

part of admin.ui.pages.admin.user.resident_county.view;

class AdminUserResidentCountyViewAdminCountyCitiesTableConfig extends TableConfig {
  AdminUserResidentCountyViewPageAdminCountyCitiesTableDataCell nameDataCell;

  AdminUserResidentCountyViewPageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminUserResidentCountyViewAdminCountyCitiesTableConfig({
    this.nameDataCell,
