...
class EdemokraciaAdminProCreatedByViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProCreatedByViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
