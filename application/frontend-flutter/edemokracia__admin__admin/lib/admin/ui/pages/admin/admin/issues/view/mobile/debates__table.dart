...
class EdemokraciaAdminAdminIssuesViewDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
