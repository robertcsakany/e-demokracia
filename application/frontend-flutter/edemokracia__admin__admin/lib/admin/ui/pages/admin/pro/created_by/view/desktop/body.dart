...
Widget getAdminProCreatedByViewDesktopPage(BuildContext context, AdminUserStore targetStore, AdminProStore ownerStore, AdminProCreatedByViewPageStore pageStore,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminProCreatedByViewActivityCountiesDesktopTable(
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminProCreatedByViewActivityCitiesDesktopTable(context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
                                                        order: 14,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminProCreatedByViewActivityDistrictsDesktopTable(
                                                          context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
