...
class AdminIssueCreateDebateOperationOutputPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final DebateStore targetStore;

  final AdminIssueCreateDebateOperationOutputPageStore pageStore;
  final AdminIssueCreateDebateOperationOutputConfig pageConfig;

  AdminIssueCreateDebateOperationOutputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
