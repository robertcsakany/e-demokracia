...
class AdminDebateIssueViewPageActions extends PageActions {
  ...
  AdminDebateIssueViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
