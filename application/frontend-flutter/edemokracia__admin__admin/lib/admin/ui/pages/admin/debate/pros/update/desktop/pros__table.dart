...
class EdemokraciaAdminDebateProsEditProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
