...
class EdemokraciaAdminDashboardIssuesViewAttachmentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewAttachmentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
