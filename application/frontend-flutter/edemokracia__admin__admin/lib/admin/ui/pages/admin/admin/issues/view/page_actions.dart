...
class AdminAdminIssuesViewPageActions extends PageActions {
  ...
  AdminAdminIssuesViewPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        try {
          await pageStore.deleteIssue(targetStore);
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        AdminIssueStore cloned = AdminIssueStore.clone(targetStore);
        var res = await navigation.open(Routes.adminAdminIssuesUpdatePage, arguments: AdminAdminIssuesUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
            await pageStore.updateIssue(cloned, targetStore);
          } catch (error) {
