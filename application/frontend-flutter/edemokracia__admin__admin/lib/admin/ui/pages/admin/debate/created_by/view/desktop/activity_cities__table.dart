...
class EdemokraciaAdminDebateCreatedByViewActivityCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateCreatedByViewActivityCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
