...
Widget getAdminAdminIssuesUpdateMobilePage(BuildContext context, AdminIssueStore targetStore, AdminAdminIssuesUpdatePageStore pageStore,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminAdminIssuesEditAttachmentsMobileTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 8,
                                                disabled: true,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminAdminIssuesEditCategoriesMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 9,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminAdminIssuesEditDebatesMobileTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 10,
                                                disabled: true,
                                                  ...
                                                  children: [
                                                    JudoColumn(
                                                      ...
                                                      children: [
                                                        ...
                                                        Observer(builder: (_) {
                                                          var dataInfo = EdemokraciaAdminAdminIssuesEditCommentsMobileTable(context, pageStore, pageConfig,
                                                              disabled: true);
                                                          return JudoTable(
                                                            key: UniqueKey(),
                                                            order: 12,
