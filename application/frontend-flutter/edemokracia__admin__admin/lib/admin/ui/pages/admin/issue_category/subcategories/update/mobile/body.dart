...
Widget getAdminIssueCategorySubcategoriesUpdateMobilePage(BuildContext context, AdminIssueCategoryStore targetStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 4,
                            disabled: true,
