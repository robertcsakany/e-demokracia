...
Widget getAdminIssueCategoriesViewMobilePage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueStore ownerStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminIssueCategoriesViewSubcategoriesMobileTable(context, pageStore, pageConfig, disabled: false);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 4,
