...
class EdemokraciaAdminConVotesTableVotesListDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConVotesTableVotesListDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
