...
class AdminDebateConsUpdatePageActions extends PageActions {
  ...
  AdminDebateConsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
