...
class EdemokraciaAdminDebateConsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateConsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
