...
class EdemokraciaAdminAdminUsersViewActivityDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
