...
class EdemokraciaAdminVoteDefinitionDebateViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminVoteDefinitionDebateViewPageStore pageStore;
  final AdminVoteDefinitionDebateViewConfig pageConfig;
