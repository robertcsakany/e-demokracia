...
class EdemokraciaAdminDebateProsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
