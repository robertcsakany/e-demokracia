...
class AdminAdminCountiesUpdatePageActions extends PageActions {
  ...
  AdminAdminCountiesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
