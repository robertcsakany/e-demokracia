...
library admin.ui.pages.admin.user.votes.table;
...
part 'dialogs/votes.dart';
part 'dialogs/votes__table.dart';

part 'mobile/body.dart';
part 'mobile/votes__table.dart';
part 'tablet/body.dart';
part 'tablet/votes__table.dart';
part 'desktop/body.dart';
part 'desktop/votes__table.dart';
