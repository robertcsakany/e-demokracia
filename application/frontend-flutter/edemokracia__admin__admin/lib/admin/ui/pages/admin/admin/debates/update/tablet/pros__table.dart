...
class EdemokraciaAdminAdminDebatesEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
