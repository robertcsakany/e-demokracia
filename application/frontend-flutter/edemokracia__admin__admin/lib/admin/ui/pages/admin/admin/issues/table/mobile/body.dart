...
Widget getAdminAdminIssuesTableMobilePage(BuildContext context, AdminAdminIssuesTablePageStore pageStore, AdminAdminIssuesTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminIssuesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminAdminIssuesTableIssueTableMobileTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
