...
Widget getAdminUserResidentCityUpdateMobilePage(BuildContext context, AdminCityStore targetStore, AdminUserResidentCityUpdatePageStore pageStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserResidentCityEditDistrictsMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
