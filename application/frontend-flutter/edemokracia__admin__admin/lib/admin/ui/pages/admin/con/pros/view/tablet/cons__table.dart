...
class EdemokraciaAdminConProsViewConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
