...
class AdminIssueCategorySubcategoriesUpdateOwnerDialogStore extends _AdminIssueCategorySubcategoriesUpdateOwnerDialogStore
    with _$AdminIssueCategorySubcategoriesUpdateOwnerDialogStore {}

abstract class _AdminIssueCategorySubcategoriesUpdateOwnerDialogStore with Store {
...
Future<AdminUserStore> judoSelectAdminIssueCategorySubcategoriesUpdateOwnerDialog(
    ...
    AdminIssueCategorySubcategoriesUpdateConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminIssueCategorySubcategoriesUpdateOwnerDialogStore();
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.issueCategoryOwnerStoreRangeFuture.status) {
                        ...
                        case FutureStatus.fulfilled:
                          var dataInfo = AdminIssueCategorySubcategoriesUpdateOwnerDialogTable(context, pageStore, pageConfig, disabled: false);
