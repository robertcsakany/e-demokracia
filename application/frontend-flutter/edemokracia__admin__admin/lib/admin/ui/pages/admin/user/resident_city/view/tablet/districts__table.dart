...
class EdemokraciaAdminUserResidentCityViewDistrictsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCityViewDistrictsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
