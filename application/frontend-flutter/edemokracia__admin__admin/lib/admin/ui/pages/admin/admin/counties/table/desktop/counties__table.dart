...
class EdemokraciaAdminAdminCountiesTableCountyTableDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesTableCountyTableDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
