...
Widget getAdminProVotesTableDesktopPage(
    BuildContext context, AdminProStore ownerStore, AdminProVotesTablePageStore pageStore, AdminProVotesTableConfig pageConfig) {
                  ...
                  Observer(
                    builder: (_) => JudoColumn(
                      ...
                      children: [
                            ...
                            children: getInputFilterWidgetsForTablePage(
                              ...
                              () async {
                                try {
                                  ...
                                  pageStore.tableService.storeFilters('EdemokraciaAdminProVotesTableVotes', pageStore.availableFilterList);
                                } catch (error) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.proVotesStoreFuture.status) {
                            case FutureStatus.pending:
                              return JudoLoadingProgress();
                            case FutureStatus.rejected:
                              return Container();
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminProVotesTableVotesListDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                ...
                                navigateToViewPageAction: pageConfig.votesTableConfig.rowClickNavigate
                                    ? (element) async {
                                        if (element != null) {
                                          await navigation.open(Routes.adminProVotesViewPage,
                                              arguments: AdminProVotesViewPageArguments(ownerStore: ownerStore, targetStore: element));
                                          try {
                                            await pageStore.getVotes(ownerStore);
                                          } catch (error) {
                                ...
                                rowActionList: [
                                  TableRowAction(
                                    ...
                                    action: (element) async {
                                      ...
                                      var res = await navigation.open(Routes.adminProVotesUpdatePage,
                                          arguments: AdminProVotesUpdatePageArguments(targetStore: cloned));
                                      if (res != null) {
                                        try {
