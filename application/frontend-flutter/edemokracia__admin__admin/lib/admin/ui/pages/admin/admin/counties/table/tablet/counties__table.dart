...
class EdemokraciaAdminAdminCountiesTableCountyTableTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesTableCountyTableTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
