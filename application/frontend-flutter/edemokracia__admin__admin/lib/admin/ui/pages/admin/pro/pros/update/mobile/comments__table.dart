...
class EdemokraciaAdminProProsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
