...
class AdminVoteDefinitionDebateViewPageActions extends PageActions {
  ...
  AdminVoteDefinitionDebateViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
