...
class EdemokraciaAdminAdminIssuesEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
