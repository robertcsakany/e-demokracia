...
class EdemokraciaAdminDashboardCreateIssueOutputCategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
