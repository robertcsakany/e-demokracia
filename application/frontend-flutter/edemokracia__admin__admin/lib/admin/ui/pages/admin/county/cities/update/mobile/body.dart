...
Widget getAdminCountyCitiesUpdateMobilePage(BuildContext context, AdminCityStore targetStore, AdminCountyCitiesUpdatePageStore pageStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminCountyCitiesEditDistrictsMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
