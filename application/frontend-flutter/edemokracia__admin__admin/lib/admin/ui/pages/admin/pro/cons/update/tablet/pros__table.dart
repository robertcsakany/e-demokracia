...
class EdemokraciaAdminProConsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
