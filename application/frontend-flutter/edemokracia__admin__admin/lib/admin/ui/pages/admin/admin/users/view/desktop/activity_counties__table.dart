...
class EdemokraciaAdminAdminUsersViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
