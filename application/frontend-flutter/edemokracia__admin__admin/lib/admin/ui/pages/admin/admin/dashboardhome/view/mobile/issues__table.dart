...
class EdemokraciaAdminAdminDashboardhomeViewIssuesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeViewIssuesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
