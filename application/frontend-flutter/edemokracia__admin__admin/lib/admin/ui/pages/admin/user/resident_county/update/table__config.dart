...
// Page: edemokracia::admin::User.residentCounty#Edit

part of admin.ui.pages.admin.user.resident_county.update;

class AdminUserResidentCountyUpdateAdminCountyCitiesTableConfig extends TableConfig {
  AdminUserResidentCountyUpdatePageAdminCountyCitiesTableDataCell nameDataCell;

  AdminUserResidentCountyUpdatePageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminUserResidentCountyUpdateAdminCountyCitiesTableConfig({
    this.nameDataCell,
