...
class AdminUserActivityCountiesUpdatePageActions extends PageActions {
  ...
  AdminUserActivityCountiesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
