...
class EdemokraciaAdminAdminDebatesEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
