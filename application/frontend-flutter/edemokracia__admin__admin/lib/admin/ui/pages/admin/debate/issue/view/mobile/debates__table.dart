...
class EdemokraciaAdminDebateIssueViewDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateIssueViewDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
