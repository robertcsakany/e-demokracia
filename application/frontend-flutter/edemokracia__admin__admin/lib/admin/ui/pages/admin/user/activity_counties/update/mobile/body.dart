...
Widget getAdminUserActivityCountiesUpdateMobilePage(BuildContext context, AdminCountyStore targetStore, AdminUserActivityCountiesUpdatePageStore pageStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserActivityCountiesEditCitiesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
