...
class EdemokraciaAdminConConsViewCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
