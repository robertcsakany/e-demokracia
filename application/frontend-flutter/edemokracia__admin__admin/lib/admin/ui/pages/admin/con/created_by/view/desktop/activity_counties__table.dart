...
class EdemokraciaAdminConCreatedByViewActivityCountiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityCountiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminConCreatedByViewPageStore pageStore;
  final AdminConCreatedByViewConfig pageConfig;
