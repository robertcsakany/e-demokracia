...
class AdminProCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCommentStore targetStore;
  final AdminProStore ownerStore;
  final AdminProCommentsViewPageStore pageStore;
  final AdminProCommentsViewConfig pageConfig;

  AdminProCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
