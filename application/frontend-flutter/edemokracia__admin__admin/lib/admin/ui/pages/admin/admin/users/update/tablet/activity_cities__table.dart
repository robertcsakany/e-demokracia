...
class EdemokraciaAdminAdminUsersEditActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
