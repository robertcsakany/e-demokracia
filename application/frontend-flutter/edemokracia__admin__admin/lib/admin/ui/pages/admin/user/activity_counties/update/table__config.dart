...
// Page: edemokracia::admin::User.activityCounties#Edit

part of admin.ui.pages.admin.user.activity_counties.update;

class AdminUserActivityCountiesUpdateAdminCountyCitiesTableConfig extends TableConfig {
  AdminUserActivityCountiesUpdatePageAdminCountyCitiesTableDataCell nameDataCell;

  AdminUserActivityCountiesUpdatePageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminUserActivityCountiesUpdateAdminCountyCitiesTableConfig({
    this.nameDataCell,
