...
class AdminCountyCitiesCreatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCityStore targetStore;
  final AdminCountyStore ownerStore;
  final AdminCountyCitiesCreatePageStore pageStore;
  final AdminCountyCitiesCreateConfig pageConfig;

  AdminCountyCitiesCreatePageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
