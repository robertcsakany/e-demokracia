...
class EdemokraciaAdminAdminDashboardhomeViewDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeViewDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
