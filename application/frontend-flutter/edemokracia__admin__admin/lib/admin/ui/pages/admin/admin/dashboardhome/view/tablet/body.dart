...
Widget getAdminAdminDashboardhomeViewTabletPage(
    BuildContext context, AdminDashboardStore targetStore, AdminAdminDashboardhomeViewPageStore pageStore, AdminAdminDashboardhomeViewConfig pageConfig) {
                      ...
                      children: [
                        ...
                        Observer(
                          builder: (_) => JudoTab(
                              ...
                              row: 21.0,
                              order: 1,
                              tabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Admin::dashboardhome_tabBar').tabIndex,
                              setTabIndex:
                                  tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Admin::dashboardhome_tabBar').setTabIndex,
                              tabContent: [
                                JudoRow(
                                          ...
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo =
                                                      EdemokraciaAdminAdminDashboardhomeViewIssuesTabletTable(context, pageStore, pageConfig, disabled: false);
                                                  return JudoTable(
                                                    key: UniqueKey(),
                                                    order: 2,
                                                        ...
                                                        ? (element) async {
                                                            if (element != null) {
                                                              await navigation.open(Routes.adminDashboardIssuesViewPage,
                                                                  arguments:
                                                                      AdminDashboardIssuesViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                              try {
                                                                await pageStore.refreshDashboard(targetStore);
                                                              } catch (error) {
                                          ...
                                          children: [
                                            JudoColumn(
                                              ...
                                              children: [
                                                ...
                                                Observer(builder: (_) {
                                                  var dataInfo =
                                                      EdemokraciaAdminAdminDashboardhomeViewDebatesTabletTable(context, pageStore, pageConfig, disabled: false);
                                                  return JudoTable(
                                                    key: UniqueKey(),
                                                    order: 3,
                                                    disabled: pageStore.pageState.disabledByLoading,
                                                        ...
                                                        ? (element) async {
                                                            if (element != null) {
                                                              await navigation.open(Routes.adminDashboardDebatesViewPage,
                                                                  arguments:
                                                                      AdminDashboardDebatesViewPageArguments(ownerStore: targetStore, targetStore: element));
                                                              try {
                                                                await pageStore.refreshDashboard(targetStore);
                                                              } catch (error) {
                                                                messageHandler.handleApiException(context, error, 'View');
                                                        ...
                                                        action: (element) async {
                                                          var ret = await navigation.open(Routes.adminDebateCreateArgumentOperationInputPage, arguments:
                                                              AdminDebateCreateArgumentOperationInputPageArguments(operationCall:
                                                                  (CreateArgumentInputStore input,
