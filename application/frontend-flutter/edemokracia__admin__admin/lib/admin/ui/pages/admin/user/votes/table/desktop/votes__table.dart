...
class EdemokraciaAdminUserVotesTableVotesListDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserVotesTableVotesListDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
