...
mixin _$AdminCountyCitiesUpdatePageStore on _AdminCountyCitiesUpdatePageStore, Store {
  ...
  int get districtsTableItemsRangeStart => (_$districtsTableItemsRangeStartComputed ??=
          Computed<int>(() => super.districtsTableItemsRangeStart, name: '_AdminCountyCitiesUpdatePageStore.districtsTableItemsRangeStart'))
      .value;
  ...
  int get districtsTableItemsRangeEnd => (_$districtsTableItemsRangeEndComputed ??=
          Computed<int>(() => super.districtsTableItemsRangeEnd, name: '_AdminCountyCitiesUpdatePageStore.districtsTableItemsRangeEnd'))
      .value;
  ...
  bool get districtsTablePreviousEnable => (_$districtsTablePreviousEnableComputed ??=
          Computed<bool>(() => super.districtsTablePreviousEnable, name: '_AdminCountyCitiesUpdatePageStore.districtsTablePreviousEnable'))
      .value;
  Computed<bool> _$districtsTableNextEnableComputed;

  @override
  bool get districtsTableNextEnable => (_$districtsTableNextEnableComputed ??=
          Computed<bool>(() => super.districtsTableNextEnable, name: '_AdminCountyCitiesUpdatePageStore.districtsTableNextEnable'))
      .value;
  ...
  List<AdminDistrictStore> get districtsTablePagingList => (_$districtsTablePagingListComputed ??=
          Computed<List<AdminDistrictStore>>(() => super.districtsTablePagingList, name: '_AdminCountyCitiesUpdatePageStore.districtsTablePagingList'))
      .value;

  final _$targetStoreAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.targetStore');
  ...
  final _$districtsTablePageNumberAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.districtsTablePageNumber');
  ...
  final _$districtsSortColumnIndexAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.districtsSortColumnIndex');
  ...
  final _$districtsSortColumnNameAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.districtsSortColumnName');
  ...
  final _$districtsSortAscAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.districtsSortAsc');
  ...
  final _$districtsSortCompareAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.districtsSortCompare');
  ...
  final _$cityDistrictsStoreFutureAtom = Atom(name: '_AdminCountyCitiesUpdatePageStore.cityDistrictsStoreFuture');
  ...
  final _$refreshCityAsyncAction = AsyncAction('_AdminCountyCitiesUpdatePageStore.refreshCity');
  ...
  final _$validateAsyncAction = AsyncAction('_AdminCountyCitiesUpdatePageStore.validate');
  ...
  final _$uploadFileAsyncAction = AsyncAction('_AdminCountyCitiesUpdatePageStore.uploadFile');
  ...
  final _$downloadFileAsyncAction = AsyncAction('_AdminCountyCitiesUpdatePageStore.downloadFile');
  ...
  final _$_AdminCountyCitiesUpdatePageStoreActionController = ActionController(name: '_AdminCountyCitiesUpdatePageStore');

  @override
  void initSortAggregatedLists(BuildContext context, AdminCountyCitiesUpdateConfig pageConfig) {
    final _$actionInfo = _$_AdminCountyCitiesUpdatePageStoreActionController.startAction(name: '_AdminCountyCitiesUpdatePageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_AdminCountyCitiesUpdatePageStoreActionController.endAction(_$actionInfo);
    }
  }

  @override
  void districtsTableNextPage() {
    final _$actionInfo = _$_AdminCountyCitiesUpdatePageStoreActionController.startAction(name: '_AdminCountyCitiesUpdatePageStore.districtsTableNextPage');
    try {
  ...
  void districtsTablePreviousPage() {
    final _$actionInfo = _$_AdminCountyCitiesUpdatePageStoreActionController.startAction(name: '_AdminCountyCitiesUpdatePageStore.districtsTablePreviousPage');
    try {
  ...
  void districtsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, AdminCityStore store) {
    final _$actionInfo = _$_AdminCountyCitiesUpdatePageStoreActionController.startAction(name: '_AdminCountyCitiesUpdatePageStore.districtsSetSort');
    try {
