...
class AdminAdminCategoriesCreatePageActions extends PageActions {
  ...
  AdminAdminCategoriesCreatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        try {
          var created = await pageStore.createCategories(targetStore);
          if (created != null) {
