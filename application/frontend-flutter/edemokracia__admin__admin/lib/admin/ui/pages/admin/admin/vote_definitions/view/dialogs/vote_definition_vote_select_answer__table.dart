...
class AdminAdminVoteDefinitionsViewVoteDefinitionVoteSelectAnswerDialogTable implements JudoTableDataInfo {
  const AdminAdminVoteDefinitionsViewVoteDefinitionVoteSelectAnswerDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
