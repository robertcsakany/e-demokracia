...
class AdminAdminCategoriesUpdateOwnerDialogStore extends _AdminAdminCategoriesUpdateOwnerDialogStore with _$AdminAdminCategoriesUpdateOwnerDialogStore {}

abstract class _AdminAdminCategoriesUpdateOwnerDialogStore with Store {
...
Future<AdminUserStore> judoSelectAdminAdminCategoriesUpdateOwnerDialog(
    {@required BuildContext context,
    AdminAdminCategoriesUpdatePageStore pageStore,
    AdminIssueCategoryStore ownerStore,
    bool dialogTypeAdder = false,
    AdminAdminCategoriesUpdateConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminAdminCategoriesUpdateOwnerDialogStore();
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.issueCategoryOwnerStoreRangeFuture.status) {
                        ...
                        case FutureStatus.fulfilled:
                          var dataInfo = AdminAdminCategoriesUpdateOwnerDialogTable(context, pageStore, pageConfig, disabled: false);
