...
class EdemokraciaAdminProConsViewCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
