...
class EdemokraciaAdminConProsEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
