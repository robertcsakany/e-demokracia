...
class EdemokraciaAdminDashboardDebatesViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
