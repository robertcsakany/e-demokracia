...
class AdminAdminVoteDefinitionsUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminVoteDefinitionStore targetStore;
  final AdminAdminVoteDefinitionsUpdatePageStore pageStore;
  final AdminAdminVoteDefinitionsUpdateConfig pageConfig;

  AdminAdminVoteDefinitionsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
