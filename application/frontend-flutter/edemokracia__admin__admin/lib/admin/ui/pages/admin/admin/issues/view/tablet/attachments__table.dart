...
class EdemokraciaAdminAdminIssuesViewAttachmentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewAttachmentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
