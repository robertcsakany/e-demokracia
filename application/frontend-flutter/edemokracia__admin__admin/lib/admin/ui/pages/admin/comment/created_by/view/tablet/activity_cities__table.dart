...
class EdemokraciaAdminCommentCreatedByViewActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
