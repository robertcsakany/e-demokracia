...
class EdemokraciaAdminCommentVotesTableVotesListDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentVotesTableVotesListDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
