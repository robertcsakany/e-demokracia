...
class EdemokraciaAdminDashboardDebatesViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
