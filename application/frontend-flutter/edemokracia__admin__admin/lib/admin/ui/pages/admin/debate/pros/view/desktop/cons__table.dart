...
class EdemokraciaAdminDebateProsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
