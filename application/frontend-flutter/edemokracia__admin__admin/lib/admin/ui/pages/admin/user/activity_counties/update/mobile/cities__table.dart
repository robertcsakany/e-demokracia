...
class EdemokraciaAdminUserActivityCountiesEditCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesEditCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
