...
class EdemokraciaAdminDashboardCreateIssueOutputCategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
