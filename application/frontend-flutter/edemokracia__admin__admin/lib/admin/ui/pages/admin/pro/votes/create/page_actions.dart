...
class AdminProVotesCreatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminProStore ownerStore;
  final AdminProVotesCreatePageStore pageStore;
  final AdminProVotesCreateConfig pageConfig;

  AdminProVotesCreatePageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
