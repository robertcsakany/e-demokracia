...
class EdemokraciaAdminUserResidentCountyViewCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCountyViewCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
