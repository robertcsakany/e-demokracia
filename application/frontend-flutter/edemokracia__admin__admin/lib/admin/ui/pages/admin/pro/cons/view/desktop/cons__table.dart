...
class EdemokraciaAdminProConsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
