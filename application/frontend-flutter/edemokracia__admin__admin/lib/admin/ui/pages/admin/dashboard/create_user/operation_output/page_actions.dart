...
class AdminDashboardCreateUserOperationOutputPageActions extends PageActions {
  ...
  AdminDashboardCreateUserOperationOutputPageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
