...
Widget getAdminAdminCountiesUpdateMobilePage(BuildContext context, AdminCountyStore targetStore, AdminAdminCountiesUpdatePageStore pageStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminAdminCountiesEditCitiesMobileTable(context, pageStore, pageConfig, disabled: true);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
                            disabled: true,
