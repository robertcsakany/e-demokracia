...
class EdemokraciaAdminProConsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
