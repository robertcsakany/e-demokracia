...
class EdemokraciaAdminCommentCreatedByViewActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
