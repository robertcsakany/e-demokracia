...
class EdemokraciaAdminDashboardIssuesViewDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
