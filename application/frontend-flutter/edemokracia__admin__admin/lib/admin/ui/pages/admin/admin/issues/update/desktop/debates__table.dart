...
class EdemokraciaAdminAdminIssuesEditDebatesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditDebatesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
