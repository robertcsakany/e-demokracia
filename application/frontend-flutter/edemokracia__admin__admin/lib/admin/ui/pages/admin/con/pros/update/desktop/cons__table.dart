...
class EdemokraciaAdminConProsEditConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsEditConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
