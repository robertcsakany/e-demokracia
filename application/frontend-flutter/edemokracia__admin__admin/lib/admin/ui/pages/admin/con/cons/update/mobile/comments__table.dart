...
class EdemokraciaAdminConConsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
