...
library admin.ui.pages.admin.admin.users.update;
...
part 'dialogs/activity_cities.dart';
part 'dialogs/activity_cities__table.dart';
part 'dialogs/activity_districts.dart';
part 'dialogs/activity_districts__table.dart';
part 'dialogs/activity_counties.dart';
part 'dialogs/activity_counties__table.dart';
part 'dialogs/resident_city.dart';
part 'dialogs/resident_city__table.dart';
part 'dialogs/resident_county.dart';
part 'dialogs/resident_county__table.dart';
part 'dialogs/resident_district.dart';
part 'dialogs/resident_district__table.dart';
