...
class EdemokraciaAdminDebateProsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
