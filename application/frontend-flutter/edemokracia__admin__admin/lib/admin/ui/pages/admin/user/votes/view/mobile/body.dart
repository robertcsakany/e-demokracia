...
Widget getAdminUserVotesViewMobilePage(BuildContext context, AdminSimpleVoteStore targetStore, AdminUserStore ownerStore, AdminUserVotesViewPageStore pageStore,
    AdminUserVotesViewConfig pageConfig) {
