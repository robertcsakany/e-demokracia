...
class EdemokraciaAdminProConsEditCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
