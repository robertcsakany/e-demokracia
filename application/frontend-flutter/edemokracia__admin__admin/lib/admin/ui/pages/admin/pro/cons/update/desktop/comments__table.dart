...
class EdemokraciaAdminProConsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
