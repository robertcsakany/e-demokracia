...
class EdemokraciaAdminAdminIssuesEditAttachmentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditAttachmentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
