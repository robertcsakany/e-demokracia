...
Widget getAdminAdminDashboardhomeViewMobilePage(
                  ...
                  children: [
                    ...
                    Observer(
                      builder: (_) => JudoTab(
                          ...
                          setTabIndex: tabService.getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::Admin::dashboardhome_tabBar').setTabIndex,
                          tabContent: [
                            JudoRow(
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminAdminDashboardhomeViewIssuesMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 2,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo =
                                                  EdemokraciaAdminAdminDashboardhomeViewDebatesMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 3,
                                                disabled: pageStore.pageState.disabledByLoading,
