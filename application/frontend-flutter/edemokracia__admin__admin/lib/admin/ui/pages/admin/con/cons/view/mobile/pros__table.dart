...
class EdemokraciaAdminConConsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
