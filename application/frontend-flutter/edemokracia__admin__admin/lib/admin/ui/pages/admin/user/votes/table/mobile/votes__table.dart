...
class EdemokraciaAdminUserVotesTableVotesListMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserVotesTableVotesListMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
