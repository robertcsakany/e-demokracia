...
class EdemokraciaAdminDashboardIssuesViewCategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
