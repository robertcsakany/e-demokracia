...
Widget getAdminUserResidentCityUpdateDesktopPage(BuildContext context, AdminCityStore targetStore, AdminUserResidentCityUpdatePageStore pageStore,
    AdminUserResidentCityUpdateConfig pageConfig, Map inputWidgetKeyMap) {
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo = EdemokraciaAdminUserResidentCityEditDistrictsDesktopTable(context, pageStore, pageConfig, disabled: true);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 2,
                                disabled: true,
