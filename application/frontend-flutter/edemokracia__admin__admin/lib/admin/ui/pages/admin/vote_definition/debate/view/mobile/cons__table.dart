...
class EdemokraciaAdminVoteDefinitionDebateViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
