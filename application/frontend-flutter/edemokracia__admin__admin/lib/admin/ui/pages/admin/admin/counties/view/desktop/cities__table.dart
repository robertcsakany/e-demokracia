...
class EdemokraciaAdminAdminCountiesViewCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesViewCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
