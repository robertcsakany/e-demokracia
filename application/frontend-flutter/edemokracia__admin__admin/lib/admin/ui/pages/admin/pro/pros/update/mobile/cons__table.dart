...
class EdemokraciaAdminProProsEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
