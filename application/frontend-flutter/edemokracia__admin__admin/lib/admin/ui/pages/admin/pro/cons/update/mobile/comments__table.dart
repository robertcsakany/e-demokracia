...
class EdemokraciaAdminProConsEditCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsEditCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
