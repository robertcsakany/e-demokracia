...
class EdemokraciaAdminConConsViewCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
