...
class AdminAdminUsersUpdateActivityCitiesDialogTable implements JudoTableDataInfo {
  const AdminAdminUsersUpdateActivityCitiesDialogTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
