...
class EdemokraciaAdminDashboardCreateIssueOutputDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
