...
Widget getAdminIssueCategoryOwnerViewTabletPage(BuildContext context, AdminUserStore targetStore, AdminIssueCategoryStore ownerStore,
    AdminIssueCategoryOwnerViewPageStore pageStore, AdminIssueCategoryOwnerViewConfig pageConfig) {
                                  ...
                                  children: [
                                    Observer(
                                      builder: (_) => JudoTab(
                                          ...
                                          order: 12,
                                          tabIndex: tabService
                                              .getOrCreateTabStore('edemokracia::admin::Admin::edemokracia::admin::IssueCategory::owner_activity')
                                              .tabIndex,
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityCountiesTabletTable(
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityCitiesTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
                                                      ...
                                                      children: [
                                                        JudoColumn(
                                                          ...
                                                          children: [
                                                            ...
                                                            Observer(builder: (_) {
                                                              var dataInfo = EdemokraciaAdminIssueCategoryOwnerViewActivityDistrictsTabletTable(
                                                                  context, pageStore, pageConfig,
                                                                  disabled: false);
                                                              return JudoTable(
                                                                key: UniqueKey(),
