...
class EdemokraciaAdminProProsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
