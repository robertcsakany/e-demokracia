...
Widget getAdminUserResidentCountyViewDesktopPage(BuildContext context, AdminCountyStore targetStore, AdminUserStore ownerStore,
    AdminUserResidentCountyViewPageStore pageStore, AdminUserResidentCountyViewConfig pageConfig) {
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserResidentCountyViewCitiesDesktopTable(context, pageStore, pageConfig, disabled: false);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
