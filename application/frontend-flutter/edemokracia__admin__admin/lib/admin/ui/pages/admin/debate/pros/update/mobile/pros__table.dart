...
class EdemokraciaAdminDebateProsEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
