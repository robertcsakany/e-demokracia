...
class AdminUserVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminUserStore ownerStore;
  final AdminUserVotesViewPageStore pageStore;
  final AdminUserVotesViewConfig pageConfig;

  AdminUserVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
