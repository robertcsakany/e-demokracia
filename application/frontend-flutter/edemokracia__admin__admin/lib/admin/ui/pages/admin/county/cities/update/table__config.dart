...
// Page: edemokracia::admin::County.cities#Edit

part of admin.ui.pages.admin.county.cities.update;

class AdminCountyCitiesUpdateAdminCityDistrictsTableConfig extends TableConfig {
  AdminCountyCitiesUpdatePageAdminCityDistrictsTableDataCell nameDataCell;

  AdminCountyCitiesUpdatePageAdminCityDistrictsTableDataCellOnTap nameDataCellOnTap;

  AdminCountyCitiesUpdateAdminCityDistrictsTableConfig({
    this.nameDataCell,
