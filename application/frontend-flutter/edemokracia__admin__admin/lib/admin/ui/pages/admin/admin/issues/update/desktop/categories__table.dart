...
class EdemokraciaAdminAdminIssuesEditCategoriesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCategoriesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
