...
class AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogStore extends _AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogStore
    with _$AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogStore {}

abstract class _AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogStore with Store {
...
Future<SelectAnswerVoteSelectionStore> judoSelectAdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialog(
    {@required BuildContext context,
    AdminDebateVoteDefinitionViewPageStore pageStore,
    AdminVoteDefinitionStore ownerStore,
    bool dialogTypeAdder = false,
    AdminDebateVoteDefinitionViewConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogStore();
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.voteDefinitionVoteSelectAnswerStoreRangeFuture.status) {
                        ...
                        case FutureStatus.fulfilled:
                          var dataInfo =
                              AdminDebateVoteDefinitionViewVoteDefinitionVoteSelectAnswerDialogTable(context, pageStore, pageConfig, disabled: false);
