...
mixin _$AdminCountyCitiesViewPageStore on _AdminCountyCitiesViewPageStore, Store {
  ...
  int get districtsTableItemsRangeStart => (_$districtsTableItemsRangeStartComputed ??=
          Computed<int>(() => super.districtsTableItemsRangeStart, name: '_AdminCountyCitiesViewPageStore.districtsTableItemsRangeStart'))
      .value;
  ...
  int get districtsTableItemsRangeEnd => (_$districtsTableItemsRangeEndComputed ??=
          Computed<int>(() => super.districtsTableItemsRangeEnd, name: '_AdminCountyCitiesViewPageStore.districtsTableItemsRangeEnd'))
      .value;
  ...
  bool get districtsTablePreviousEnable => (_$districtsTablePreviousEnableComputed ??=
          Computed<bool>(() => super.districtsTablePreviousEnable, name: '_AdminCountyCitiesViewPageStore.districtsTablePreviousEnable'))
      .value;
  Computed<bool> _$districtsTableNextEnableComputed;

  @override
  bool get districtsTableNextEnable => (_$districtsTableNextEnableComputed ??=
          Computed<bool>(() => super.districtsTableNextEnable, name: '_AdminCountyCitiesViewPageStore.districtsTableNextEnable'))
      .value;
  ...
  List<AdminDistrictStore> get districtsTablePagingList => (_$districtsTablePagingListComputed ??=
          Computed<List<AdminDistrictStore>>(() => super.districtsTablePagingList, name: '_AdminCountyCitiesViewPageStore.districtsTablePagingList'))
      .value;

  final _$targetStoreAtom = Atom(name: '_AdminCountyCitiesViewPageStore.targetStore');
  ...
  final _$districtsTablePageNumberAtom = Atom(name: '_AdminCountyCitiesViewPageStore.districtsTablePageNumber');
  ...
  final _$districtsSortColumnIndexAtom = Atom(name: '_AdminCountyCitiesViewPageStore.districtsSortColumnIndex');
  ...
  final _$districtsSortColumnNameAtom = Atom(name: '_AdminCountyCitiesViewPageStore.districtsSortColumnName');
  ...
  final _$districtsSortAscAtom = Atom(name: '_AdminCountyCitiesViewPageStore.districtsSortAsc');
  ...
  final _$districtsSortCompareAtom = Atom(name: '_AdminCountyCitiesViewPageStore.districtsSortCompare');
  ...
  final _$cityDistrictsStoreFutureAtom = Atom(name: '_AdminCountyCitiesViewPageStore.cityDistrictsStoreFuture');
  ...
  final _$refreshCityAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.refreshCity');
  ...
  final _$updateCityAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.updateCity');
  ...
  final _$deleteCityAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.deleteCity');

  @override
  Future<void> deleteCity(AdminCityStore targetStore) {
    return _$deleteCityAsyncAction.run(() => super.deleteCity(targetStore));
  }

  final _$downloadFileAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.downloadFile');
  ...
  final _$createDistrictsAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.createDistricts');
  ...
  final _$deleteDistrictsDistrictAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.deleteDistrictsDistrict');
  ...
  final _$updateDistrictsDistrictAsyncAction = AsyncAction('_AdminCountyCitiesViewPageStore.updateDistrictsDistrict');
  ...
  final _$_AdminCountyCitiesViewPageStoreActionController = ActionController(name: '_AdminCountyCitiesViewPageStore');

  @override
  void initSortAggregatedLists(BuildContext context, AdminCountyCitiesViewConfig pageConfig) {
    final _$actionInfo = _$_AdminCountyCitiesViewPageStoreActionController.startAction(name: '_AdminCountyCitiesViewPageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_AdminCountyCitiesViewPageStoreActionController.endAction(_$actionInfo);
    }
  }

  @override
  void districtsTableNextPage() {
    final _$actionInfo = _$_AdminCountyCitiesViewPageStoreActionController.startAction(name: '_AdminCountyCitiesViewPageStore.districtsTableNextPage');
    try {
  ...
  void districtsTablePreviousPage() {
    final _$actionInfo = _$_AdminCountyCitiesViewPageStoreActionController.startAction(name: '_AdminCountyCitiesViewPageStore.districtsTablePreviousPage');
    try {
  ...
  void districtsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, AdminCityStore store) {
    final _$actionInfo = _$_AdminCountyCitiesViewPageStoreActionController.startAction(name: '_AdminCountyCitiesViewPageStore.districtsSetSort');
    try {
