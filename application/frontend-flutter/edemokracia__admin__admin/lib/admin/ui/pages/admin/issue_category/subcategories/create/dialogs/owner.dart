...
class AdminIssueCategorySubcategoriesCreateOwnerDialogStore extends _AdminIssueCategorySubcategoriesCreateOwnerDialogStore
    with _$AdminIssueCategorySubcategoriesCreateOwnerDialogStore {}

abstract class _AdminIssueCategorySubcategoriesCreateOwnerDialogStore with Store {
...
Future<AdminUserStore> judoSelectAdminIssueCategorySubcategoriesCreateOwnerDialog(
    ...
    AdminIssueCategorySubcategoriesCreateConfig pageConfig}) async {
  final messageHandler = locator<MessageHandler>();
  var dialogHelperStore = AdminIssueCategorySubcategoriesCreateOwnerDialogStore();
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Observer(builder: (_) {
                      switch (pageStore.issueCategoryOwnerStoreRangeFuture.status) {
                        case FutureStatus.pending:
                          return JudoLoadingProgress();
                        case FutureStatus.rejected:
                          return Container();
                        case FutureStatus.fulfilled:
                          var dataInfo = AdminIssueCategorySubcategoriesCreateOwnerDialogTable(context, pageStore, pageConfig, disabled: false);
