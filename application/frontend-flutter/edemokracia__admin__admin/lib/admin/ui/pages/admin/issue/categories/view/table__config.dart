...
// Page: edemokracia::admin::Issue.categories#View

part of admin.ui.pages.admin.issue.categories.view;

class AdminIssueCategoriesViewAdminIssueCategorySubcategoriesTableConfig extends TableConfig {
  AdminIssueCategoriesViewPageAdminIssueCategorySubcategoriesTableDataCell titleDataCell;

  AdminIssueCategoriesViewPageAdminIssueCategorySubcategoriesTableDataCellOnTap titleDataCellOnTap;
  AdminIssueCategoriesViewPageAdminIssueCategorySubcategoriesTableDataCell descriptionDataCell;

  AdminIssueCategoriesViewPageAdminIssueCategorySubcategoriesTableDataCellOnTap descriptionDataCellOnTap;
...
class AdminIssueCategoriesViewAdminIssueCategoryOwnerTableConfig extends TableConfig {
  AdminIssueCategoriesViewPageAdminIssueCategoryOwnerTableDataCell representationDataCell;

  AdminIssueCategoriesViewAdminIssueCategoryOwnerTableConfig({
