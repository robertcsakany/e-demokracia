...
class EdemokraciaAdminCommentCreatedByViewActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
