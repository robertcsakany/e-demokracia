...
class EdemokraciaAdminConConsEditProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
