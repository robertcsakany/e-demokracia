...
class EdemokraciaAdminConProsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConProsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
