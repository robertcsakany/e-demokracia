...
class EdemokraciaAdminConCreatedByViewActivityDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConCreatedByViewActivityDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
