...
// Page: edemokracia::admin::User.residentCity#Edit

part of admin.ui.pages.admin.user.resident_city.update;

class AdminUserResidentCityUpdateAdminCityDistrictsTableConfig extends TableConfig {
  AdminUserResidentCityUpdatePageAdminCityDistrictsTableDataCell nameDataCell;

  AdminUserResidentCityUpdatePageAdminCityDistrictsTableDataCellOnTap nameDataCellOnTap;

  AdminUserResidentCityUpdateAdminCityDistrictsTableConfig({
    this.nameDataCell,
