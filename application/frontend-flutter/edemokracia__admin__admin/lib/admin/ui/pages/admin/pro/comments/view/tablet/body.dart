...
Widget getAdminProCommentsViewTabletPage(BuildContext context, AdminCommentStore targetStore, AdminProStore ownerStore, AdminProCommentsViewPageStore pageStore,
    AdminProCommentsViewConfig pageConfig) {
