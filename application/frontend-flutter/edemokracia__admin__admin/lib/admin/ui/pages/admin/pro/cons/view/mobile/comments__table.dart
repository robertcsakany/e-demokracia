...
class EdemokraciaAdminProConsViewCommentsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProConsViewCommentsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
