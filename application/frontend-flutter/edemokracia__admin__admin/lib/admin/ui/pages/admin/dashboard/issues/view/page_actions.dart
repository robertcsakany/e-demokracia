...
class AdminDashboardIssuesViewPageActions extends PageActions {
  ...
  AdminDashboardIssuesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
