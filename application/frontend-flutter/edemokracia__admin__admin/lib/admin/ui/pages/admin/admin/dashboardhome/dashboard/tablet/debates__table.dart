...
class EdemokraciaAdminAdminDashboardhomeDashboardDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
