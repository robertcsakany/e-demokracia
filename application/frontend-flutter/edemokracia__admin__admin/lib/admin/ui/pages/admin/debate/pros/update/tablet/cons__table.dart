...
class EdemokraciaAdminDebateProsEditConsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateProsEditConsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
