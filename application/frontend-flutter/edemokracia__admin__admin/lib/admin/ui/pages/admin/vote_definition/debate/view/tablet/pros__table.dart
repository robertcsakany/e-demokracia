...
class EdemokraciaAdminVoteDefinitionDebateViewProsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminVoteDefinitionDebateViewProsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
