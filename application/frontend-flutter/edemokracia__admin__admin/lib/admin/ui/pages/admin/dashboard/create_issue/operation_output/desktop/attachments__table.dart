...
class EdemokraciaAdminDashboardCreateIssueOutputAttachmentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputAttachmentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
