...
Widget getAdminUserActivityCitiesViewMobilePage(BuildContext context, AdminCityStore targetStore, AdminUserStore ownerStore,
                  ...
                  children: [
                    ...
                    JudoColumn(
                      ...
                      children: [
                        ...
                        Observer(builder: (_) {
                          var dataInfo = EdemokraciaAdminUserActivityCitiesViewDistrictsMobileTable(context, pageStore, pageConfig, disabled: false);
                          return JudoTable(
                            key: UniqueKey(),
                            order: 2,
