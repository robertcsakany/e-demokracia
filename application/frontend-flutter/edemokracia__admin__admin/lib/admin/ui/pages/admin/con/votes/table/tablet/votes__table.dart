...
class EdemokraciaAdminConVotesTableVotesListTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminConVotesTableVotesListTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
