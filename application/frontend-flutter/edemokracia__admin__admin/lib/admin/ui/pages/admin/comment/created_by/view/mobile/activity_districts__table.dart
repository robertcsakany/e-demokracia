...
class EdemokraciaAdminCommentCreatedByViewActivityDistrictsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityDistrictsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
