...
class EdemokraciaAdminAdminCountiesEditCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminCountiesEditCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
