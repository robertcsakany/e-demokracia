...
class EdemokraciaAdminConConsEditConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
