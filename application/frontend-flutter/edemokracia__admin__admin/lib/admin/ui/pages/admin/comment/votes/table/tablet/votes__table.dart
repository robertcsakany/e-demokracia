...
class EdemokraciaAdminCommentVotesTableVotesListTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentVotesTableVotesListTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
