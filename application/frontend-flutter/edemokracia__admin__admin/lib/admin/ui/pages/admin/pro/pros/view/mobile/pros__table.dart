...
class EdemokraciaAdminProProsViewProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
