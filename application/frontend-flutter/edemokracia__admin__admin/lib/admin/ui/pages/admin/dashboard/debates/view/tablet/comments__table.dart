...
class EdemokraciaAdminDashboardDebatesViewCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
