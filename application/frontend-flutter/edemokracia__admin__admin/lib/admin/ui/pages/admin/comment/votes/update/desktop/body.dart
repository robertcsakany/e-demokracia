...
Widget getAdminCommentVotesUpdateDesktopPage(BuildContext context, AdminSimpleVoteStore targetStore, AdminCommentVotesUpdatePageStore pageStore,
    AdminCommentVotesUpdateConfig pageConfig, Map inputWidgetKeyMap) {
