...
class EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategorySubcategoriesEditSubcategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
