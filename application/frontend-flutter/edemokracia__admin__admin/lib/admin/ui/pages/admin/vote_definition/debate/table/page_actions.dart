...
class AdminVoteDefinitionDebateTablePageActions extends PageActions {
  ...
  AdminVoteDefinitionDebateTablePageActions(this.navigation, this.ownerStore, this.pageStore, this.pageConfig);
