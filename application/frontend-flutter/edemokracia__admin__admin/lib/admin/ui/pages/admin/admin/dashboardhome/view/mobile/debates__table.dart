...
class EdemokraciaAdminAdminDashboardhomeViewDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeViewDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
