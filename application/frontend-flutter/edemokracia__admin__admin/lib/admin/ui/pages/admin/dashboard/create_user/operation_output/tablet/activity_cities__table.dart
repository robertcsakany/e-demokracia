...
class EdemokraciaAdminDashboardCreateUserOutputActivityCitiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateUserOutputActivityCitiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
