...
class EdemokraciaAdminUserResidentCityEditDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCityEditDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
