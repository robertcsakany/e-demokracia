...
Widget getAdminConCreatedByViewDesktopPage(BuildContext context, AdminUserStore targetStore, AdminConStore ownerStore, AdminConCreatedByViewPageStore pageStore,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminConCreatedByViewActivityCountiesDesktopTable(
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminConCreatedByViewActivityCitiesDesktopTable(context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
                                                        order: 14,
                                              ...
                                              children: [
                                                JudoColumn(
                                                  ...
                                                  children: [
                                                    ...
                                                    Observer(builder: (_) {
                                                      var dataInfo = EdemokraciaAdminConCreatedByViewActivityDistrictsDesktopTable(
                                                          context, pageStore, pageConfig,
                                                          disabled: false);
                                                      return JudoTable(
                                                        key: UniqueKey(),
