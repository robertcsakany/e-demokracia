...
class EdemokraciaAdminDashboardCreateIssueOutputCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
