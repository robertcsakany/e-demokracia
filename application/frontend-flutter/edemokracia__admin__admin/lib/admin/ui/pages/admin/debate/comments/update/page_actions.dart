...
class AdminDebateCommentsUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminCommentStore targetStore;
  final AdminDebateCommentsUpdatePageStore pageStore;
  final AdminDebateCommentsUpdateConfig pageConfig;

  AdminDebateCommentsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
