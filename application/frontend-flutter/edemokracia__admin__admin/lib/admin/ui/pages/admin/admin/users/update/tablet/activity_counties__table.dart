...
class EdemokraciaAdminAdminUsersEditActivityCountiesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminUsersEditActivityCountiesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
