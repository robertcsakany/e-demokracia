...
class EdemokraciaAdminProProsEditProsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsEditProsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
