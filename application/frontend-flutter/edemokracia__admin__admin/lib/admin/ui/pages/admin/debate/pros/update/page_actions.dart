...
class AdminDebateProsUpdatePageActions extends PageActions {
  ...
  AdminDebateProsUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
