...
class EdemokraciaAdminConConsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
