...
Widget getAdminAdminVoteDefinitionsTableDesktopPage(
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminVoteDefinitionsStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo =
                                  EdemokraciaAdminAdminVoteDefinitionsTableTransferObjectTableDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
