...
Widget getAdminCommentVotesTableTabletPage(
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.commentVotesStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminCommentVotesTableVotesListTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
