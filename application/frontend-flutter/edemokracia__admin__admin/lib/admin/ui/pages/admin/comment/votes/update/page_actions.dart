...
class AdminCommentVotesUpdatePageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final AdminSimpleVoteStore targetStore;
  final AdminCommentVotesUpdatePageStore pageStore;
  final AdminCommentVotesUpdateConfig pageConfig;

  AdminCommentVotesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
