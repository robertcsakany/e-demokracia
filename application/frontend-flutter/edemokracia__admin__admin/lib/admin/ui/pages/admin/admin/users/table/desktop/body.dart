...
Widget getAdminAdminUsersTableDesktopPage(BuildContext context, AdminAdminUsersTablePageStore pageStore, AdminAdminUsersTableConfig pageConfig) {
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminUsersStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminAdminUsersTableUserTableDesktopTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
