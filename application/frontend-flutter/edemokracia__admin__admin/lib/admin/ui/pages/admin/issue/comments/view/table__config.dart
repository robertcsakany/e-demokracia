...
// Page: edemokracia::admin::Issue.comments#View

part of admin.ui.pages.admin.issue.comments.view;

class AdminIssueCommentsViewAdminCommentCreatedByTableConfig extends TableConfig {
  AdminIssueCommentsViewPageAdminCommentCreatedByTableDataCell representationDataCell;

  AdminIssueCommentsViewAdminCommentCreatedByTableConfig({
