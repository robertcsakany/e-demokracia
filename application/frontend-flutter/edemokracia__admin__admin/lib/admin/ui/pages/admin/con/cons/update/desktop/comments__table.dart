...
class EdemokraciaAdminConConsEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminConConsEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminConConsUpdatePageStore pageStore;
  final AdminConConsUpdateConfig pageConfig;
