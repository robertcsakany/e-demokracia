...
class EdemokraciaAdminDashboardDebatesViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
