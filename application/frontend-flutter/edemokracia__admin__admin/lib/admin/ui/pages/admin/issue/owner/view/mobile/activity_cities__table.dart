...
class EdemokraciaAdminIssueOwnerViewActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueOwnerViewActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
