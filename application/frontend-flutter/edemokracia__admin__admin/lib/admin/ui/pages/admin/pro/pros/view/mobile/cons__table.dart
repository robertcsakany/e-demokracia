...
class EdemokraciaAdminProProsViewConsMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewConsMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
