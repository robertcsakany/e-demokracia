...
class EdemokraciaAdminIssueCategoryOwnerViewActivityCountiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategoryOwnerViewActivityCountiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
