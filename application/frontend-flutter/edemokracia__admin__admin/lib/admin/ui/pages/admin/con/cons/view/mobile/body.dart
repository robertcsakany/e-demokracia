...
Widget getAdminConConsViewMobilePage(
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminConConsViewProsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminConConsViewConsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 13,
                                                disabled: pageStore.pageState.disabledByLoading,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminConConsViewCommentsMobileTable(context, pageStore, pageConfig, disabled: false);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 15,
                                                disabled: pageStore.pageState.disabledByLoading,
