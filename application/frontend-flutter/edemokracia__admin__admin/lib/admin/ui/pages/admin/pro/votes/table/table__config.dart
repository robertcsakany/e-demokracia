...
// Page: edemokracia::admin::Pro.votes#Table

part of admin.ui.pages.admin.pro.votes.table;

class AdminProVotesTableAdminProVotesTableConfig extends TableConfig {
  AdminProVotesTablePageAdminProVotesTableDataCell createdDataCell;

  AdminProVotesTablePageAdminProVotesTableDataCellOnTap createdDataCellOnTap;
  AdminProVotesTablePageAdminProVotesTableDataCell typeDataCell;

  AdminProVotesTablePageAdminProVotesTableDataCellOnTap typeDataCellOnTap;

  AdminProVotesTableAdminProVotesTableConfig({
