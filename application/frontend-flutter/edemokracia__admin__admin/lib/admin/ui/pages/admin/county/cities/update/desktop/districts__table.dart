...
class EdemokraciaAdminCountyCitiesEditDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminCountyCitiesEditDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminCountyCitiesUpdatePageStore pageStore;
  final AdminCountyCitiesUpdateConfig pageConfig;
