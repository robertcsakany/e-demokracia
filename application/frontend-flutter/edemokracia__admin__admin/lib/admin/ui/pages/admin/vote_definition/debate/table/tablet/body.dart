...
Widget getAdminVoteDefinitionDebateTableTabletPage(BuildContext context, AdminVoteDefinitionStore ownerStore, AdminVoteDefinitionDebateTablePageStore pageStore,
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.voteDefinitionDebateStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo = EdemokraciaAdminVoteDefinitionDebateTableDebateTableTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
