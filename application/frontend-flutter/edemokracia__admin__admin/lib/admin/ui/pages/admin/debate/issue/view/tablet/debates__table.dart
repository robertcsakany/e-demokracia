...
class EdemokraciaAdminDebateIssueViewDebatesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDebateIssueViewDebatesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
