...
class EdemokraciaAdminAdminDashboardhomeDashboardIssuesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDashboardhomeDashboardIssuesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
