...
class EdemokraciaAdminAdminIssuesEditDebatesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditDebatesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
