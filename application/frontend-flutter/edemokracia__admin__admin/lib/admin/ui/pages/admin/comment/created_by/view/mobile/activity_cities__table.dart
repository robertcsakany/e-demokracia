...
class EdemokraciaAdminCommentCreatedByViewActivityCitiesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminCommentCreatedByViewActivityCitiesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
