...
class EdemokraciaAdminDashboardIssuesViewCommentsTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardIssuesViewCommentsTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
