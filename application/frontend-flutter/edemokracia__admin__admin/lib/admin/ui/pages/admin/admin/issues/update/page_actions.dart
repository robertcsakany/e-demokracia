...
class AdminAdminIssuesUpdatePageActions extends PageActions {
  ...
  AdminAdminIssuesUpdatePageActions(this.navigation, this.targetStore, this.pageStore, this.pageConfig);
