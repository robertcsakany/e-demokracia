...
// Page: edemokracia::admin::User.activityCounties#View

part of admin.ui.pages.admin.user.activity_counties.view;

class AdminUserActivityCountiesViewAdminCountyCitiesTableConfig extends TableConfig {
  AdminUserActivityCountiesViewPageAdminCountyCitiesTableDataCell nameDataCell;

  AdminUserActivityCountiesViewPageAdminCountyCitiesTableDataCellOnTap nameDataCellOnTap;

  AdminUserActivityCountiesViewAdminCountyCitiesTableConfig({
    this.nameDataCell,
