...
class EdemokraciaAdminDashboardCreateIssueOutputCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardCreateIssueOutputCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminDashboardCreateIssueOperationOutputPageStore pageStore;
  final AdminDashboardCreateIssueOperationOutputConfig pageConfig;
  ...
  List<DataColumn> getColumns(Function onAdd, Function onSort) {
    return [
      ...
      DataColumn(
        label: Text(
          AppLocalizations.of(context).lookUpValue(context, 'CreatedByName'),
          style: JudoComponentCustomizer.get().getTableHeaderTextStyle(Theme.of(context)),
        ),
        onSort: onSort,
      ),
