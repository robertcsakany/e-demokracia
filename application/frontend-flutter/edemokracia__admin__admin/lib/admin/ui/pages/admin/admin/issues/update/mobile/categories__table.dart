...
class EdemokraciaAdminAdminIssuesEditCategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesEditCategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
