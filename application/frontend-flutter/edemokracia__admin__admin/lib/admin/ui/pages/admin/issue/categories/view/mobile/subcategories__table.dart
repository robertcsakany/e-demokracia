...
class EdemokraciaAdminIssueCategoriesViewSubcategoriesMobileTable implements JudoTableDataInfo {
  const EdemokraciaAdminIssueCategoriesViewSubcategoriesMobileTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
