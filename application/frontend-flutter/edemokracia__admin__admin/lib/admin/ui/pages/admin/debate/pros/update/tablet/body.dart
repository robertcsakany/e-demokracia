...
Widget getAdminDebateProsUpdateTabletPage(
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditProsTabletTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 12,
                                                disabled: true,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditConsTabletTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 13,
                                                disabled: true,
                                      ...
                                      children: [
                                        JudoColumn(
                                          ...
                                          children: [
                                            ...
                                            Observer(builder: (_) {
                                              var dataInfo = EdemokraciaAdminDebateProsEditCommentsTabletTable(context, pageStore, pageConfig, disabled: true);
                                              return JudoTable(
                                                key: UniqueKey(),
                                                order: 15,
                                                disabled: true,
