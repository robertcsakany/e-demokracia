...
class EdemokraciaAdminUserActivityCountiesEditCitiesDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserActivityCountiesEditCitiesDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminUserActivityCountiesUpdatePageStore pageStore;
  final AdminUserActivityCountiesUpdateConfig pageConfig;
