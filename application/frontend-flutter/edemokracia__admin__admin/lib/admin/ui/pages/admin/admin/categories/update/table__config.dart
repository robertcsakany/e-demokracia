...
// Page: edemokracia::admin::Admin.categories#Edit

part of admin.ui.pages.admin.admin.categories.update;

class AdminAdminCategoriesUpdateAdminIssueCategorySubcategoriesTableConfig extends TableConfig {
  AdminAdminCategoriesUpdatePageAdminIssueCategorySubcategoriesTableDataCell titleDataCell;

  AdminAdminCategoriesUpdatePageAdminIssueCategorySubcategoriesTableDataCellOnTap titleDataCellOnTap;
  AdminAdminCategoriesUpdatePageAdminIssueCategorySubcategoriesTableDataCell descriptionDataCell;

  AdminAdminCategoriesUpdatePageAdminIssueCategorySubcategoriesTableDataCellOnTap descriptionDataCellOnTap;
...
class AdminAdminCategoriesUpdateAdminIssueCategoryOwnerTableConfig extends TableConfig {
  AdminAdminCategoriesUpdatePageAdminIssueCategoryOwnerTableDataCell representationDataCell;

  AdminAdminCategoriesUpdateAdminIssueCategoryOwnerTableConfig({
