...
Widget getAdminAdminVoteDefinitionsTableMobilePage(
                        ...
                        Observer(builder: (_) {
                          switch (pageStore.adminVoteDefinitionsStoreFuture.status) {
                            ...
                            case FutureStatus.fulfilled:
                              var dataInfo =
                                  EdemokraciaAdminAdminVoteDefinitionsTableTransferObjectTableMobileTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
