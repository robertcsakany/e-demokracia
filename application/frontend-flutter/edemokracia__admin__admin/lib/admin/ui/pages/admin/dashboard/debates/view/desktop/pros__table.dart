...
class EdemokraciaAdminDashboardDebatesViewProsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminDashboardDebatesViewProsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
