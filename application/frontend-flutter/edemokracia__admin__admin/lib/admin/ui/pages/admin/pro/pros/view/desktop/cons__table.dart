...
class EdemokraciaAdminProProsViewConsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminProProsViewConsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
