...
Widget getAdminIssueCategorySubcategoriesViewTabletPage(BuildContext context, AdminIssueCategoryStore targetStore, AdminIssueCategoryStore ownerStore,
                      ...
                      children: [
                        ...
                        JudoColumn(
                          ...
                          children: [
                            ...
                            Observer(builder: (_) {
                              var dataInfo =
                                  EdemokraciaAdminIssueCategorySubcategoriesViewSubcategoriesTabletTable(context, pageStore, pageConfig, disabled: false);
                              return JudoTable(
                                key: UniqueKey(),
                                order: 4,
