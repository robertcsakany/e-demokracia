...
class EdemokraciaAdminUserResidentCityViewDistrictsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminUserResidentCityViewDistrictsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
