...
class EdemokraciaAdminAdminDebatesEditCommentsDesktopTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminDebatesEditCommentsDesktopTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});

  final BuildContext context;
  final bool disabled;
  final AdminAdminDebatesUpdatePageStore pageStore;
  final AdminAdminDebatesUpdateConfig pageConfig;
