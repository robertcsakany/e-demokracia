...
class AdminDebateConsViewPageActions extends PageActions {
  ...
  AdminDebateConsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        ...
        var res = await navigation.open(Routes.adminDebateConsUpdatePage, arguments: AdminDebateConsUpdatePageArguments(targetStore: cloned));
        if (res != null) {
          try {
