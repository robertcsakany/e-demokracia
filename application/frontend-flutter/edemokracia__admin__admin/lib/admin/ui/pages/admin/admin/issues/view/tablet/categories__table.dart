...
class EdemokraciaAdminAdminIssuesViewCategoriesTabletTable implements JudoTableDataInfo {
  const EdemokraciaAdminAdminIssuesViewCategoriesTabletTable(this.context, this.pageStore, this.pageConfig, {this.disabled = false});
