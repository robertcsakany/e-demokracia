...
Widget getCountyCitiesViewDesktopPage(
    BuildContext context, CityStore targetStore, CountyStore ownerStore, CountyCitiesViewPageStore pageStore, CountyCitiesViewConfig pageConfig) {
