...
class CountyCitiesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CityStore targetStore;
  final CountyStore ownerStore;
  final CountyCitiesViewPageStore pageStore;
  final CountyCitiesViewConfig pageConfig;

  CountyCitiesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
