...
class VoteEntryUserViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final VoteEntryStore ownerStore;
  final VoteEntryUserViewPageStore pageStore;
  final VoteEntryUserViewConfig pageConfig;

  VoteEntryUserViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
