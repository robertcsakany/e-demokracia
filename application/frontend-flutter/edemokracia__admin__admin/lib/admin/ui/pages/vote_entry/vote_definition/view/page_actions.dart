...
class VoteEntryVoteDefinitionViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final VoteDefinitionStore targetStore;
  final VoteEntryStore ownerStore;
  final VoteEntryVoteDefinitionViewPageStore pageStore;
  final VoteEntryVoteDefinitionViewConfig pageConfig;

  VoteEntryVoteDefinitionViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
