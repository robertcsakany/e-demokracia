...
class ConCreatedByViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final ConStore ownerStore;
  final ConCreatedByViewPageStore pageStore;
  final ConCreatedByViewConfig pageConfig;

  ConCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
