...
class ConVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final SimpleVoteStore targetStore;
  final ConStore ownerStore;
  final ConVotesViewPageStore pageStore;
  final ConVotesViewConfig pageConfig;

  ConVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
