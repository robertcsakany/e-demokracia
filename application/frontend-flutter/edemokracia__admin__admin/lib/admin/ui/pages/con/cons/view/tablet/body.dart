...
Widget getConConsViewTabletPage(BuildContext context, ConStore targetStore, ConStore ownerStore, ConConsViewPageStore pageStore, ConConsViewConfig pageConfig) {
