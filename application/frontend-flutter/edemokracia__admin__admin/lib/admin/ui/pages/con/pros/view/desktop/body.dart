...
Widget getConProsViewDesktopPage(
    BuildContext context, ProStore targetStore, ConStore ownerStore, ConProsViewPageStore pageStore, ConProsViewConfig pageConfig) {
