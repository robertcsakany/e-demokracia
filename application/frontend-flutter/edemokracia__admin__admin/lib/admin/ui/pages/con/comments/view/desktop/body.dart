...
Widget getConCommentsViewDesktopPage(
    BuildContext context, CommentStore targetStore, ConStore ownerStore, ConCommentsViewPageStore pageStore, ConCommentsViewConfig pageConfig) {
