...
class ConConsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ConStore targetStore;
  final ConStore ownerStore;
  final ConConsViewPageStore pageStore;
  final ConConsViewConfig pageConfig;

  ConConsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
