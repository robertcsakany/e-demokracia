...
class ConCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CommentStore targetStore;
  final ConStore ownerStore;
  final ConCommentsViewPageStore pageStore;
  final ConCommentsViewConfig pageConfig;

  ConCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
