...
class ConProsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ProStore targetStore;
  final ConStore ownerStore;
  final ConProsViewPageStore pageStore;
  final ConProsViewConfig pageConfig;

  ConProsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
