...
Widget getCityDistrictsViewDesktopPage(
    BuildContext context, DistrictStore targetStore, CityStore ownerStore, CityDistrictsViewPageStore pageStore, CityDistrictsViewConfig pageConfig) {
