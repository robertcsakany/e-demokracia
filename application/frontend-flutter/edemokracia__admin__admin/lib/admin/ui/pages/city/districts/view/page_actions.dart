...
class CityDistrictsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final DistrictStore targetStore;
  final CityStore ownerStore;
  final CityDistrictsViewPageStore pageStore;
  final CityDistrictsViewConfig pageConfig;

  CityDistrictsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
