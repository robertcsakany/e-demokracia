...
class VoteDefinitionVoteEntriesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final VoteEntryStore targetStore;
  final VoteDefinitionStore ownerStore;
  final VoteDefinitionVoteEntriesViewPageStore pageStore;
  final VoteDefinitionVoteEntriesViewConfig pageConfig;

  VoteDefinitionVoteEntriesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
  ...
  List<Widget> getActions(BuildContext context) {
    ...
    list.add(JudoAppBarButton(
      ...
      onPressed: () async {
        try {
          await pageStore.refreshVoteEntry(targetStore);
        } catch (error) {
