...
Widget getCommentVotesViewDesktopPage(
    BuildContext context, SimpleVoteStore targetStore, CommentStore ownerStore, CommentVotesViewPageStore pageStore, CommentVotesViewConfig pageConfig) {
