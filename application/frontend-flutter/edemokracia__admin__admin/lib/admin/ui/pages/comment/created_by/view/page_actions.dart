...
class CommentCreatedByViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final CommentStore ownerStore;
  final CommentCreatedByViewPageStore pageStore;
  final CommentCreatedByViewConfig pageConfig;

  CommentCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
