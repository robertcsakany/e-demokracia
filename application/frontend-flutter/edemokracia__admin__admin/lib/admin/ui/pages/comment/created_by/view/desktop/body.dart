...
Widget getCommentCreatedByViewDesktopPage(
    BuildContext context, UserStore targetStore, CommentStore ownerStore, CommentCreatedByViewPageStore pageStore, CommentCreatedByViewConfig pageConfig) {
