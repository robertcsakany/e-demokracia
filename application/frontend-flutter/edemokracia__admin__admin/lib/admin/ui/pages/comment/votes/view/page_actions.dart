...
class CommentVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final SimpleVoteStore targetStore;
  final CommentStore ownerStore;
  final CommentVotesViewPageStore pageStore;
  final CommentVotesViewConfig pageConfig;

  CommentVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
