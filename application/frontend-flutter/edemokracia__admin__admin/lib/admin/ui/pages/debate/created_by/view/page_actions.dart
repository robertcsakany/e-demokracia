...
class DebateCreatedByViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final DebateStore ownerStore;
  final DebateCreatedByViewPageStore pageStore;
  final DebateCreatedByViewConfig pageConfig;

  DebateCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
