...
class DebateDebateVoteViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final VoteDefinitionStore targetStore;
  final DebateStore ownerStore;
  final DebateDebateVoteViewPageStore pageStore;
  final DebateDebateVoteViewConfig pageConfig;

  DebateDebateVoteViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
