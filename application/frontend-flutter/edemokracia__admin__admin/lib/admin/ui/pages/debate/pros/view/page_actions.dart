...
class DebateProsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ProStore targetStore;
  final DebateStore ownerStore;
  final DebateProsViewPageStore pageStore;
  final DebateProsViewConfig pageConfig;

  DebateProsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
