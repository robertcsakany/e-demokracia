...
class DebateCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CommentStore targetStore;
  final DebateStore ownerStore;
  final DebateCommentsViewPageStore pageStore;
  final DebateCommentsViewConfig pageConfig;

  DebateCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
