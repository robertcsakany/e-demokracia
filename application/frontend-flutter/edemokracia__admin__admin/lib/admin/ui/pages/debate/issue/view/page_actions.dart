...
class DebateIssueViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final IssueStore targetStore;
  final DebateStore ownerStore;
  final DebateIssueViewPageStore pageStore;
  final DebateIssueViewConfig pageConfig;

  DebateIssueViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
