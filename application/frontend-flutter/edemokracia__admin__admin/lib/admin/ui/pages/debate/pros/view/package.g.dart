...
mixin _$DebateProsViewPageStore on _DebateProsViewPageStore, Store {
  final _$targetStoreAtom = Atom(name: '_DebateProsViewPageStore.targetStore');

  @override
  ProStore get targetStore {
    _$targetStoreAtom.reportRead();
    return super.targetStore;
  }

  @override
  set targetStore(ProStore value) {
    _$targetStoreAtom.reportWrite(value, super.targetStore, () {
      super.targetStore = value;
    });
  }

  final _$commentsSortColumnIndexAtom = Atom(name: '_DebateProsViewPageStore.commentsSortColumnIndex');
  ...
  final _$commentsSortColumnNameAtom = Atom(name: '_DebateProsViewPageStore.commentsSortColumnName');
  ...
  final _$commentsSortAscAtom = Atom(name: '_DebateProsViewPageStore.commentsSortAsc');
  ...
  final _$commentsSortCompareAtom = Atom(name: '_DebateProsViewPageStore.commentsSortCompare');
  ...
  final _$proCommentsStoreFutureAtom = Atom(name: '_DebateProsViewPageStore.proCommentsStoreFuture');
  ...
  final _$prosSortColumnIndexAtom = Atom(name: '_DebateProsViewPageStore.prosSortColumnIndex');
  ...
  final _$prosSortColumnNameAtom = Atom(name: '_DebateProsViewPageStore.prosSortColumnName');
  ...
  final _$prosSortAscAtom = Atom(name: '_DebateProsViewPageStore.prosSortAsc');
  ...
  final _$prosSortCompareAtom = Atom(name: '_DebateProsViewPageStore.prosSortCompare');
  ...
  final _$proProsStoreFutureAtom = Atom(name: '_DebateProsViewPageStore.proProsStoreFuture');
  ...
  final _$votesSortColumnIndexAtom = Atom(name: '_DebateProsViewPageStore.votesSortColumnIndex');
  ...
  final _$votesSortColumnNameAtom = Atom(name: '_DebateProsViewPageStore.votesSortColumnName');
  ...
  final _$votesSortAscAtom = Atom(name: '_DebateProsViewPageStore.votesSortAsc');
  ...
  final _$votesSortCompareAtom = Atom(name: '_DebateProsViewPageStore.votesSortCompare');
  ...
  final _$proVotesStoreFutureAtom = Atom(name: '_DebateProsViewPageStore.proVotesStoreFuture');
  ...
  final _$refreshProAsyncAction = AsyncAction('_DebateProsViewPageStore.refreshPro');

  @override
  Future<void> refreshPro(ProStore targetStore) {
    return _$refreshProAsyncAction.run(() => super.refreshPro(targetStore));
  }

  final _$downloadFileAsyncAction = AsyncAction('_DebateProsViewPageStore.downloadFile');
  ...
  final _$_DebateProsViewPageStoreActionController = ActionController(name: '_DebateProsViewPageStore');

  @override
  void initSortAggregatedLists(BuildContext context, DebateProsViewConfig pageConfig) {
    final _$actionInfo = _$_DebateProsViewPageStoreActionController.startAction(name: '_DebateProsViewPageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_DebateProsViewPageStoreActionController.endAction(_$actionInfo);
    }
  }

  @override
  void commentsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_DebateProsViewPageStoreActionController.startAction(name: '_DebateProsViewPageStore.commentsSetSort');
    try {
  ...
  @override
  void prosSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_DebateProsViewPageStoreActionController.startAction(name: '_DebateProsViewPageStore.prosSetSort');
    try {
  ...
  @override
  void votesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_DebateProsViewPageStoreActionController.startAction(name: '_DebateProsViewPageStore.votesSetSort');
    try {
