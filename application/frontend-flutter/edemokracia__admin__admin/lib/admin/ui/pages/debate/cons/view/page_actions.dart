...
class DebateConsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ConStore targetStore;
  final DebateStore ownerStore;
  final DebateConsViewPageStore pageStore;
  final DebateConsViewConfig pageConfig;

  DebateConsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
