...
Widget getDebateProsViewDesktopPage(
    BuildContext context, ProStore targetStore, DebateStore ownerStore, DebateProsViewPageStore pageStore, DebateProsViewConfig pageConfig) {
