...
Widget getDebateCreatedByViewDesktopPage(
    BuildContext context, UserStore targetStore, DebateStore ownerStore, DebateCreatedByViewPageStore pageStore, DebateCreatedByViewConfig pageConfig) {
