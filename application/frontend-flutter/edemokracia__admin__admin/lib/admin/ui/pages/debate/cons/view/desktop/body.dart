...
Widget getDebateConsViewDesktopPage(
    BuildContext context, ConStore targetStore, DebateStore ownerStore, DebateConsViewPageStore pageStore, DebateConsViewConfig pageConfig) {
