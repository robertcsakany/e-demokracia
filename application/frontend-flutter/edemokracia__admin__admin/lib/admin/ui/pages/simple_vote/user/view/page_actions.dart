...
class SimpleVoteUserViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final SimpleVoteStore ownerStore;
  final SimpleVoteUserViewPageStore pageStore;
  final SimpleVoteUserViewConfig pageConfig;

  SimpleVoteUserViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
