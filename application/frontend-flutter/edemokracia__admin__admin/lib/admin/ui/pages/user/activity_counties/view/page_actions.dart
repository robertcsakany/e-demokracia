...
class UserActivityCountiesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CountyStore targetStore;
  final UserStore ownerStore;
  final UserActivityCountiesViewPageStore pageStore;
  final UserActivityCountiesViewConfig pageConfig;

  UserActivityCountiesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
