...
class UserResidentCountyViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CountyStore targetStore;
  final UserStore ownerStore;
  final UserResidentCountyViewPageStore pageStore;
  final UserResidentCountyViewConfig pageConfig;

  UserResidentCountyViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
