...
class UserActivityCitiesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CityStore targetStore;
  final UserStore ownerStore;
  final UserActivityCitiesViewPageStore pageStore;
  final UserActivityCitiesViewConfig pageConfig;

  UserActivityCitiesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
