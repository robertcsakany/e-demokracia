...
class UserResidentDistrictViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final DistrictStore targetStore;
  final UserStore ownerStore;
  final UserResidentDistrictViewPageStore pageStore;
  final UserResidentDistrictViewConfig pageConfig;

  UserResidentDistrictViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
