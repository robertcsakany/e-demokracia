...
class UserActivityDistrictsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final DistrictStore targetStore;
  final UserStore ownerStore;
  final UserActivityDistrictsViewPageStore pageStore;
  final UserActivityDistrictsViewConfig pageConfig;

  UserActivityDistrictsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
