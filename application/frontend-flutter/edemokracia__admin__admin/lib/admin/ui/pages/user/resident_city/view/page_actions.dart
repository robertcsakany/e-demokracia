...
class UserResidentCityViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CityStore targetStore;
  final UserStore ownerStore;
  final UserResidentCityViewPageStore pageStore;
  final UserResidentCityViewConfig pageConfig;

  UserResidentCityViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
