...
class UserVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final SimpleVoteStore targetStore;
  final UserStore ownerStore;
  final UserVotesViewPageStore pageStore;
  final UserVotesViewConfig pageConfig;

  UserVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
