...
mixin _$IssueDebatesViewPageStore on _IssueDebatesViewPageStore, Store {
  final _$targetStoreAtom = Atom(name: '_IssueDebatesViewPageStore.targetStore');

  @override
  DebateStore get targetStore {
    _$targetStoreAtom.reportRead();
    return super.targetStore;
  }

  @override
  set targetStore(DebateStore value) {
    _$targetStoreAtom.reportWrite(value, super.targetStore, () {
      super.targetStore = value;
    });
  }

  final _$commentsSortColumnIndexAtom = Atom(name: '_IssueDebatesViewPageStore.commentsSortColumnIndex');
  ...
  final _$commentsSortColumnNameAtom = Atom(name: '_IssueDebatesViewPageStore.commentsSortColumnName');
  ...
  final _$commentsSortAscAtom = Atom(name: '_IssueDebatesViewPageStore.commentsSortAsc');
  ...
  final _$commentsSortCompareAtom = Atom(name: '_IssueDebatesViewPageStore.commentsSortCompare');
  ...
  final _$debateCommentsStoreFutureAtom = Atom(name: '_IssueDebatesViewPageStore.debateCommentsStoreFuture');
  ...
  final _$consSortColumnIndexAtom = Atom(name: '_IssueDebatesViewPageStore.consSortColumnIndex');
  ...
  final _$consSortColumnNameAtom = Atom(name: '_IssueDebatesViewPageStore.consSortColumnName');
  ...
  final _$consSortAscAtom = Atom(name: '_IssueDebatesViewPageStore.consSortAsc');
  ...
  final _$consSortCompareAtom = Atom(name: '_IssueDebatesViewPageStore.consSortCompare');
  ...
  final _$debateConsStoreFutureAtom = Atom(name: '_IssueDebatesViewPageStore.debateConsStoreFuture');
  ...
  final _$debateDebateVoteStoreFutureAtom = Atom(name: '_IssueDebatesViewPageStore.debateDebateVoteStoreFuture');

  @override
  ObservableFuture<dynamic> get debateDebateVoteStoreFuture {
    _$debateDebateVoteStoreFutureAtom.reportRead();
    return super.debateDebateVoteStoreFuture;
  }

  @override
  set debateDebateVoteStoreFuture(ObservableFuture<dynamic> value) {
    _$debateDebateVoteStoreFutureAtom.reportWrite(value, super.debateDebateVoteStoreFuture, () {
      super.debateDebateVoteStoreFuture = value;
    });
  }

  final _$prosSortColumnIndexAtom = Atom(name: '_IssueDebatesViewPageStore.prosSortColumnIndex');
  ...
  final _$prosSortColumnNameAtom = Atom(name: '_IssueDebatesViewPageStore.prosSortColumnName');
  ...
  final _$prosSortAscAtom = Atom(name: '_IssueDebatesViewPageStore.prosSortAsc');
  ...
  final _$prosSortCompareAtom = Atom(name: '_IssueDebatesViewPageStore.prosSortCompare');
  ...
  final _$debateProsStoreFutureAtom = Atom(name: '_IssueDebatesViewPageStore.debateProsStoreFuture');
  ...
  final _$refreshDebateAsyncAction = AsyncAction('_IssueDebatesViewPageStore.refreshDebate');

  @override
  Future<void> refreshDebate(DebateStore targetStore) {
    return _$refreshDebateAsyncAction.run(() => super.refreshDebate(targetStore));
  }

  final _$downloadFileAsyncAction = AsyncAction('_IssueDebatesViewPageStore.downloadFile');
  ...
  final _$_IssueDebatesViewPageStoreActionController = ActionController(name: '_IssueDebatesViewPageStore');

  @override
  void initSortAggregatedLists(BuildContext context, IssueDebatesViewConfig pageConfig) {
    final _$actionInfo = _$_IssueDebatesViewPageStoreActionController.startAction(name: '_IssueDebatesViewPageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_IssueDebatesViewPageStoreActionController.endAction(_$actionInfo);
    }
  }

  @override
  void commentsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, DebateStore store) {
    final _$actionInfo = _$_IssueDebatesViewPageStoreActionController.startAction(name: '_IssueDebatesViewPageStore.commentsSetSort');
    try {
  ...
  @override
  void consSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, DebateStore store) {
    final _$actionInfo = _$_IssueDebatesViewPageStoreActionController.startAction(name: '_IssueDebatesViewPageStore.consSetSort');
    try {
  ...
  @override
  void prosSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, DebateStore store) {
    final _$actionInfo = _$_IssueDebatesViewPageStoreActionController.startAction(name: '_IssueDebatesViewPageStore.prosSetSort');
    try {
...
debateDebateVoteStoreFuture: ${debateDebateVoteStoreFuture},
