...
class IssueCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CommentStore targetStore;
  final IssueStore ownerStore;
  final IssueCommentsViewPageStore pageStore;
  final IssueCommentsViewConfig pageConfig;

  IssueCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
