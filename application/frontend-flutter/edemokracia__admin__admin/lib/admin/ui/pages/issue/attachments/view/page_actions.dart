...
class IssueAttachmentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final IssueAttachmentStore targetStore;
  final IssueStore ownerStore;
  final IssueAttachmentsViewPageStore pageStore;
  final IssueAttachmentsViewConfig pageConfig;

  IssueAttachmentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
