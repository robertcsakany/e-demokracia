...
class IssueOwnerViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final IssueStore ownerStore;
  final IssueOwnerViewPageStore pageStore;
  final IssueOwnerViewConfig pageConfig;

  IssueOwnerViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
