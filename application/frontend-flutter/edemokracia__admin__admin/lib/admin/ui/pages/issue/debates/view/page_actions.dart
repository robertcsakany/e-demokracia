...
class IssueDebatesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final DebateStore targetStore;
  final IssueStore ownerStore;
  final IssueDebatesViewPageStore pageStore;
  final IssueDebatesViewConfig pageConfig;

  IssueDebatesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
