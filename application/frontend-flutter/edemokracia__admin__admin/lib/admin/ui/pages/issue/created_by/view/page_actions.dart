...
class IssueCreatedByViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final IssueStore ownerStore;
  final IssueCreatedByViewPageStore pageStore;
  final IssueCreatedByViewConfig pageConfig;

  IssueCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
