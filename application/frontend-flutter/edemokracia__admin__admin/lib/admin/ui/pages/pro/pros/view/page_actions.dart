...
class ProProsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ProStore targetStore;
  final ProStore ownerStore;
  final ProProsViewPageStore pageStore;
  final ProProsViewConfig pageConfig;

  ProProsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
