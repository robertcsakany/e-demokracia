...
class ProCommentsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final CommentStore targetStore;
  final ProStore ownerStore;
  final ProCommentsViewPageStore pageStore;
  final ProCommentsViewConfig pageConfig;

  ProCommentsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
