...
class ProConsViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final ConStore targetStore;
  final ProStore ownerStore;
  final ProConsViewPageStore pageStore;
  final ProConsViewConfig pageConfig;

  ProConsViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
