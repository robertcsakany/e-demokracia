...
class ProCreatedByViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final UserStore targetStore;
  final ProStore ownerStore;
  final ProCreatedByViewPageStore pageStore;
  final ProCreatedByViewConfig pageConfig;

  ProCreatedByViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
