...
Widget getProConsViewDesktopPage(
    BuildContext context, ConStore targetStore, ProStore ownerStore, ProConsViewPageStore pageStore, ProConsViewConfig pageConfig) {
