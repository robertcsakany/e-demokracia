...
mixin _$ProProsViewPageStore on _ProProsViewPageStore, Store {
  final _$targetStoreAtom = Atom(name: '_ProProsViewPageStore.targetStore');
  ...
  final _$commentsSortColumnIndexAtom = Atom(name: '_ProProsViewPageStore.commentsSortColumnIndex');
  ...
  final _$commentsSortColumnNameAtom = Atom(name: '_ProProsViewPageStore.commentsSortColumnName');
  ...
  final _$commentsSortAscAtom = Atom(name: '_ProProsViewPageStore.commentsSortAsc');
  ...
  final _$commentsSortCompareAtom = Atom(name: '_ProProsViewPageStore.commentsSortCompare');
  ...
  final _$proCommentsStoreFutureAtom = Atom(name: '_ProProsViewPageStore.proCommentsStoreFuture');
  ...
  final _$prosSortColumnIndexAtom = Atom(name: '_ProProsViewPageStore.prosSortColumnIndex');
  ...
  final _$prosSortColumnNameAtom = Atom(name: '_ProProsViewPageStore.prosSortColumnName');
  ...
  final _$prosSortAscAtom = Atom(name: '_ProProsViewPageStore.prosSortAsc');
  ...
  final _$prosSortCompareAtom = Atom(name: '_ProProsViewPageStore.prosSortCompare');
  ...
  final _$proProsStoreFutureAtom = Atom(name: '_ProProsViewPageStore.proProsStoreFuture');
  ...
  final _$votesSortColumnIndexAtom = Atom(name: '_ProProsViewPageStore.votesSortColumnIndex');
  ...
  final _$votesSortColumnNameAtom = Atom(name: '_ProProsViewPageStore.votesSortColumnName');
  ...
  final _$votesSortAscAtom = Atom(name: '_ProProsViewPageStore.votesSortAsc');
  ...
  final _$votesSortCompareAtom = Atom(name: '_ProProsViewPageStore.votesSortCompare');
  ...
  final _$proVotesStoreFutureAtom = Atom(name: '_ProProsViewPageStore.proVotesStoreFuture');
  ...
  final _$refreshProAsyncAction = AsyncAction('_ProProsViewPageStore.refreshPro');
  ...
  final _$downloadFileAsyncAction = AsyncAction('_ProProsViewPageStore.downloadFile');
  ...
  final _$_ProProsViewPageStoreActionController = ActionController(name: '_ProProsViewPageStore');

  @override
  void initSortAggregatedLists(BuildContext context, ProProsViewConfig pageConfig) {
    final _$actionInfo = _$_ProProsViewPageStoreActionController.startAction(name: '_ProProsViewPageStore.initSortAggregatedLists');
    try {
      return super.initSortAggregatedLists(context, pageConfig);
    } finally {
      _$_ProProsViewPageStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void commentsSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_ProProsViewPageStoreActionController.startAction(name: '_ProProsViewPageStore.commentsSetSort');
    try {
  ...
  void prosSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_ProProsViewPageStoreActionController.startAction(name: '_ProProsViewPageStore.prosSetSort');
    try {
  ...
  void votesSetSort(BuildContext context, String sortColumnName, int sortColumnIndex, bool asc, Comparator<dynamic> sortCompare, ProStore store) {
    final _$actionInfo = _$_ProProsViewPageStoreActionController.startAction(name: '_ProProsViewPageStore.votesSetSort');
    try {
