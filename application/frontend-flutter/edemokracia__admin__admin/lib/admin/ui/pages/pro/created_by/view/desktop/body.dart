...
Widget getProCreatedByViewDesktopPage(
    BuildContext context, UserStore targetStore, ProStore ownerStore, ProCreatedByViewPageStore pageStore, ProCreatedByViewConfig pageConfig) {
