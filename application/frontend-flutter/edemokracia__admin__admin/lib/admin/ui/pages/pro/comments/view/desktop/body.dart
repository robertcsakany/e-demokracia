...
Widget getProCommentsViewDesktopPage(
    BuildContext context, CommentStore targetStore, ProStore ownerStore, ProCommentsViewPageStore pageStore, ProCommentsViewConfig pageConfig) {
