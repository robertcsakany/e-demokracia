...
Widget getProConsViewTabletPage(BuildContext context, ConStore targetStore, ProStore ownerStore, ProConsViewPageStore pageStore, ProConsViewConfig pageConfig) {
