...
class ProVotesViewPageActions extends PageActions {
  NavigationState navigation;
  final messageHandler = locator<MessageHandler>();

  final SimpleVoteStore targetStore;
  final ProStore ownerStore;
  final ProVotesViewPageStore pageStore;
  final ProVotesViewConfig pageConfig;

  ProVotesViewPageActions(this.navigation, this.targetStore, this.ownerStore, this.pageStore, this.pageConfig);
