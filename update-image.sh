...
docker run --restart=always \
        ...
        -p 80:8181 \
        -e EXTRA_JAVA_OPTS="-Xms1024m -Xmx1024m -Dfile.encoding=UTF-8 -Dsun.jnu.encoding=UTF-8" \
        -e JUDO_PLATFORM_KEYCLOAK_AUTH_SERVER_URL=$AUTH_SERVER \
        -e JUDO_PLATFORM_KEYCLOAK_AUTH_PUBLIC_URL=$AUTH_SERVER \
        ...
        -e JUDO_PLATFORM_KEYCLOAK_DEFAULT_PASSWORD_POLICY=SAME_USERNAME \
